...
# direct methods
.method public synthetic constructor <init>(LMa/x;ZZLandroid/media/MediaFormat;Landroid/media/MediaFormat;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LMa/w;->a:LMa/x;

    iput-boolean p2, p0, LMa/w;->b:Z

    iput-boolean p3, p0, LMa/w;->c:Z

    iput-object p4, p0, LMa/w;->d:Landroid/media/MediaFormat;

    iput-object p5, p0, LMa/w;->e:Landroid/media/MediaFormat;

    iput p6, p0, LMa/w;->f:I
...
.method public final run()V
    ...
    iget-object v1, p0, LMa/w;->a:LMa/x;

    iget-boolean v2, p0, LMa/w;->b:Z

    iget-boolean v3, p0, LMa/w;->c:Z

    iget-object v4, p0, LMa/w;->d:Landroid/media/MediaFormat;

    iget-object v5, p0, LMa/w;->e:Landroid/media/MediaFormat;

    iget p0, p0, LMa/w;->f:I
    ...
    iget-object v8, v1, LMa/x;->b:Ljava/lang/Object;

    monitor-enter v8

    :try_start_0
    iget-boolean v9, v1, LMa/x;->d:Z
    ...
    :cond_0
    :try_start_1
    iget-object v9, v1, LMa/x;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object v6, v1, LMa/x;->c:Lgc/c;

    if-nez v6, :cond_2

    new-instance v6, Lgc/c;

    invoke-direct {v6, v3, v4, v5}, Lgc/c;-><init>(ZLandroid/media/MediaFormat;Landroid/media/MediaFormat;)V

    iput-object v6, v1, LMa/x;->c:Lgc/c;

    :cond_2
    iget-object v3, v1, LMa/x;->c:Lgc/c;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v4, "setOrientationHint(): "

    invoke-static {p0, v4}, LA/O;->f(ILjava/lang/String;)Ljava/lang/String;
    ...
    iput p0, v3, Lgc/c;->d:I

    iget-object p0, v1, LMa/x;->c:Lgc/c;

    invoke-virtual {p0}, Lgc/c;->b()V
    :try_end_3
    ...
    :try_start_4
    iput-boolean p0, v1, LMa/x;->d:Z

    monitor-exit v8
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    iget-object v2, v1, LMa/x;->f:Landroid/media/MediaFormat;

    invoke-virtual {v1, v2}, LMa/x;->g(Landroid/media/MediaFormat;)V

    iget-object v2, v1, LMa/x;->g:Landroid/media/MediaFormat;

    invoke-virtual {v1, v2}, LMa/x;->b(Landroid/media/MediaFormat;)V

    sget-boolean v2, Lu7/b;->i:Z

    sget-object v2, Lu7/b$b;->a:Lu7/b;

    invoke-virtual {v2}, Lu7/b;->t0()Z

    move-result v2

    if-eqz v2, :cond_6

    iget-boolean p0, v1, LMa/x;->d:Z

    iget-object v1, v1, LMa/x;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_c
    invoke-virtual {v1, v0}, LMa/x;->h(Z)V
