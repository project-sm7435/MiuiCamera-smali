...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, LNa/a;->G:Z

    const/4 v0, 0x1

    sput-boolean v0, LNa/a;->H:Z
...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    invoke-direct/range {p0 .. p6}, LNa/c;-><init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, LNa/a;->E:Z

    const/4 p2, 0x0

    iput-object p2, p0, LNa/a;->F:Landroid/media/AudioFormat;

    iget-object p2, p0, LNa/c;->b:Landroid/media/MediaFormat;
    ...
    iput p2, p0, LNa/a;->z:I

    iget-object p3, p0, LNa/c;->b:Landroid/media/MediaFormat;
    ...
    iget-object p4, p0, LNa/c;->b:Landroid/media/MediaFormat;
    ...
    invoke-static {p2, p3}, Lxb/x;->h(II)Z
    ...
    iget-object p3, p0, LNa/a;->F:Landroid/media/AudioFormat;
    ...
    iget-object p2, p0, LNa/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, p2}, LNa/a;->s(Landroid/media/AudioFormat;)V

    iget-object p2, p0, LNa/c;->b:Landroid/media/MediaFormat;

    const-string p3, "max-input-size"

    iget p4, p0, LNa/a;->C:I
    ...
    iget-object p3, p0, LNa/a;->D:Lzb/b;

    iget-object p3, p3, Lzb/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    :cond_3
    :try_start_1
    iget-object v1, p0, LNa/a;->D:Lzb/b;

    if-eqz v1, :cond_4

    invoke-virtual {v1}, Lzb/b;->e()V
    :try_end_1
...
.method public final d()V
    ...
    :cond_2
    iget-object v2, p0, LNa/c;->m:LNa/i;

    invoke-virtual {v2}, LNa/i;->b()V

    iget-boolean v2, p0, LNa/a;->E:Z
    ...
    :cond_3
    iput-boolean v1, p0, LNa/c;->r:Z

    iput-boolean v1, p0, LNa/c;->s:Z

    invoke-virtual {p0}, LNa/c;->p()V

    :try_start_0
    iget-object v2, p0, LNa/a;->D:Lzb/b;

    if-nez v2, :cond_4

    iget-object v2, p0, LNa/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, v2}, LNa/a;->s(Landroid/media/AudioFormat;)V
    ...
    :try_start_1
    iput-boolean v3, p0, LNa/c;->r:Z

    const-string v2, "audio/mp4a-latm"

    iget v4, p0, LNa/a;->z:I

    iget v5, p0, LNa/a;->A:I

    invoke-static {v2, v4, v5}, Landroid/media/MediaFormat;->createAudioFormat(Ljava/lang/String;II)Landroid/media/MediaFormat;

    move-result-object v2

    iput-object v2, p0, LNa/c;->l:Landroid/media/MediaFormat;

    const-string v4, "csd-0"

    iget v5, p0, LNa/a;->z:I

    iget v6, p0, LNa/a;->A:I

    invoke-static {v5, v6}, Lxb/x;->a(II)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setByteBuffer(Ljava/lang/String;Ljava/nio/ByteBuffer;)V

    iget-object v2, p0, LNa/c;->l:Landroid/media/MediaFormat;

    const-string v4, "bitrate"

    iget v5, p0, LNa/a;->y:I
...
.method public final e()V
    ...
    :cond_3
    :try_start_0
    iget-object v0, p0, LNa/a;->D:Lzb/b;
    ...
    iput-object v0, p0, LNa/a;->D:Lzb/b;
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, LNa/c;->f:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, LNa/c;->f:Ljava/util/ArrayList;
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    iget-object v4, v0, LAb/f;->a:Ljava/nio/ByteBuffer;
    ...
    iget p1, p0, LNa/a;->B:I

    div-int p1, v8, p1

    iget-wide v9, v0, LAb/f;->c:J

    iget-boolean p1, p0, LNa/c;->n:Z
...
.method public final s(Landroid/media/AudioFormat;)V
    ...
    iget v4, p0, LNa/a;->y:I

    const/4 v5, 0x1

    move-object v1, p1

    invoke-virtual/range {v0 .. v5}, Lzb/b;->d(Landroid/media/AudioFormat;IIII)V

    iget-object p1, p0, LNa/a;->D:Lzb/b;

    iget-object p1, p1, Lzb/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, LA/S1;-><init>(Ljava/lang/Object;)V

    iput-object v0, p1, Lzb/b;->p:LA/S1;

    :cond_0
    return-void

    :cond_1
    iget-object p0, p0, LNa/a;->D:Lzb/b;

    invoke-virtual {p0}, Lzb/b;->e()V
