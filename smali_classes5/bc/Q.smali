...
# direct methods
.method public static final a(Ljava/util/zip/ZipFile;Ljava/io/File;LN0/u;)V
    .locals 11
    ...
    invoke-direct {v2, v0}, Llf/p;-><init>(Ljava/util/Enumeration;)V

    invoke-static {v2}, LPg/o;->m(Ljava/util/Iterator;)LPg/h;
    ...
    invoke-direct {v1, v0}, Llf/p;-><init>(Ljava/util/Enumeration;)V
    ...
    invoke-static {v7, v10, v9}, LQg/p;->C(Ljava/lang/CharSequence;Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, v8}, LF7/e;->g(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    iget-object v6, p2, LN0/u;->a:Ljava/lang/Object;
    ...
    invoke-static {v8, p0}, LC/t2;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p2, LN0/u;->a:Ljava/lang/Object;
...
.method public static final b(Ljava/util/zip/ZipInputStream;Ljava/io/File;)V
    ...
    invoke-static {v1, v4, v3}, LQg/p;->C(Ljava/lang/CharSequence;Ljava/lang/String;Z)Z
...
.method public static final c(Ljava/util/zip/ZipOutputStream;Ljava/io/File;)V
    ...
    invoke-static {p0, v2}, Lbc/Q;->c(Ljava/util/zip/ZipOutputStream;Ljava/io/File;)V
    ...
    invoke-static {p1, v1}, LC/E;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v0, p0}, LF7/e;->g(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
