...
.method static constructor <clinit>()V
    ...
    const-class v20, Lzf/k;

    const-class v21, Lzf/m;

    const-class v1, Lzf/a;

    const-class v2, Lzf/l;

    const-class v3, Lzf/p;

    const-class v4, Lzf/q;

    const-class v5, Lzf/r;

    const-class v6, Lzf/s;

    const-class v7, Lzf/t;

    const-class v8, Lzf/u;

    const-class v9, Lzf/v;

    const-class v10, Lzf/w;

    const-class v11, Lzf/b;

    const-class v12, Lzf/c;

    const-class v13, Lzf/d;

    const-class v14, Lzf/e;

    const-class v15, Lzf/f;

    const-class v16, Lzf/g;

    const-class v17, Lzf/h;

    const-class v18, Lzf/i;

    const-class v19, Lzf/j;

    const-class v22, Lzf/n;

    const-class v23, Lzf/o;
