...
.method public final c(LPf/q$b;LPf/o;LPf/k;)Z
    ...
    invoke-static {p2, v2, v1}, Lrg/h;->i(LPf/k;Ljava/lang/Class;Z)LPf/k;
    ...
    invoke-static {p3, v2, v4}, Lrg/h;->i(LPf/k;Ljava/lang/Class;Z)LPf/k;
    ...
    invoke-static {v3}, Lrg/h;->l(LPf/k;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-static {v3, v2, v1}, Lrg/h;->i(LPf/k;Ljava/lang/Class;Z)LPf/k;
    ...
    invoke-static {v5, v3}, Lrg/h;->r(LFg/E;LPf/e;)Z
    ...
    invoke-static {v3}, Lrg/h;->t(LPf/b;)LPf/b;
    ...
    invoke-static {v4, v2}, Lrg/h;->r(LFg/E;LPf/e;)Z
    ...
    invoke-interface {v0}, Lzg/g;->b()LFg/E;

    move-result-object v0

    invoke-static {v0, p3}, Lrg/h;->r(LFg/E;LPf/e;)Z

    move-result v2

    if-nez v2, :cond_9

    invoke-static {v0}, LFg/x;->a(LFg/E;)Z
    ...
    :cond_a
    invoke-virtual {p1}, LPf/q$b;->getType()LFg/E;
