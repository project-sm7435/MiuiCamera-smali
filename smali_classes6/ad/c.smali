...
# direct methods
.method public synthetic constructor <init>(Lad/i;ILjava/lang/String;Ljava/io/File;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lad/c;->a:Lad/i;

    iput p2, p0, Lad/c;->b:I

    iput-object p3, p0, Lad/c;->c:Ljava/lang/String;

    iput-object p4, p0, Lad/c;->d:Ljava/io/File;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lad/c;->a:Lad/i;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, v0, Lad/c;->c:Ljava/lang/String;

    iget v3, v0, Lad/c;->b:I

    const/16 v4, 0x64

    if-ne v4, v3, :cond_e

    iget-object v0, v0, Lad/c;->d:Ljava/io/File;
    ...
    :goto_0
    invoke-static {v5}, LA/i3;->a(Ljava/lang/String;)Z
    ...
    iget-object v5, v1, Lad/i;->c:Landroid/content/Context;

    const-string v7, "human.json"

    invoke-static {v5, v7}, LZb/L;->h(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v10, v11, v12, v13}, LU9/a;->j(Ljava/lang/String;J)J
    ...
    invoke-static {v10}, LZb/B;->m(Ljava/io/File;)Ljava/lang/String;

    move-result-object v10

    const-class v11, Lcom/xiaomi/mimoji/common/bean/AvatarBean;

    invoke-static {v11, v5}, LA/i3;->b(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/xiaomi/mimoji/common/bean/AvatarBean;

    invoke-static {v11, v10}, LA/i3;->b(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v5, v0}, LA/i3;->d(Ljava/lang/Object;Ljava/io/File;)V
    ...
    invoke-virtual {v1, v3}, Lad/i;->f(I)V
