...
.method static constructor <clinit>()V
    ...
    sput-object v0, LVb/i;->d:Lhf/n;

    return-void
.end method

.method public static a(Landroid/app/Application;LVb/a;Landroidx/fragment/app/FragmentManager;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V
    .locals 21
    ...
    sget-object v5, LVb/i;->a:Lio/reactivex/disposables/Disposable;
    ...
    sget-object v8, LVb/i;->c:Lhf/n;

    invoke-virtual {v8}, Lhf/n;->getValue()Ljava/lang/Object;
    ...
    invoke-direct {v8, v0, v6}, LWb/a;-><init>(Landroid/app/Application;Z)V

    new-instance v6, LVb/h;

    invoke-direct {v6, v1, v2, v0}, LVb/h;-><init>(LVb/a;Landroid/content/SharedPreferences;Landroid/app/Application;)V

    new-instance v9, LUc/u;

    const/4 v10, 0x1

    invoke-direct {v9, v6, v10}, LUc/u;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v8, v2, v9}, LAa/j;-><init>(Ljava/lang/Object;I)V

    new-instance v2, LB3/d;

    const/4 v9, 0x4

    invoke-direct {v2, v8, v9}, LB3/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0, v5, v3, v4}, LVb/f;-><init>(Landroid/app/Application;Ljava/lang/ref/WeakReference;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V

    new-instance v0, LA/P1;

    const/4 v6, 0x3

    invoke-direct {v0, v2, v6}, LA/P1;-><init>(Ljava/lang/Object;I)V

    new-instance v2, LVb/g;

    invoke-direct {v2, v5, v3, v4}, LVb/g;-><init>(Ljava/lang/ref/WeakReference;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V

    new-instance v3, LBa/g;

    const/4 v4, 0x2

    invoke-direct {v3, v2, v4}, LBa/g;-><init>(Ljava/lang/Object;I)V
    ...
    sput-object v0, LVb/i;->a:Lio/reactivex/disposables/Disposable;
...
.method public static c(Lcom/xiaomi/camera/upgrade/UpgradeBean;Landroidx/fragment/app/FragmentManager;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V
    ...
    sget-object v0, LVb/i;->b:Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;->za()V
    ...
    sput-object p0, LVb/i;->b:Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;
...
.method public static d(Landroid/app/Application;Lcom/xiaomi/camera/upgrade/preference/DrawablePreference;)V
    ...
    invoke-static {p0}, LVb/i;->b(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget v0, LVb/e;->update_new_version:I

    goto :goto_0

    :cond_0
    sget v0, LVb/e;->update_latest_version:I
    ...
    sget p0, LVb/b;->update_find_new_version_text_color:I

    goto :goto_1

    :cond_1
    sget p0, LVb/b;->black_40_transparent_with_dark_mode:I
