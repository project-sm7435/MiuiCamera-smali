...
# static fields
.field public static final e:Lgg/n;

.field public static final f:Lgg/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgg/n;->f:Lgg/n$a;

    new-instance v0, Lgg/n;

    invoke-direct {v0}, Lgg/n;-><init>()V

    sput-object v0, Lgg/n;->e:Lgg/n;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lgg/n;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lgg/n;->c:B

    iput v0, p0, Lgg/n;->d:I

    sget-object v0, Lmg/c;->a:Lmg/o;

    iput-object v0, p0, Lgg/n;->a:Lmg/c;

    return-void
.end method

.method public constructor <init>(Lgg/n$b;)V
    .locals 1
    ...
    iput-object p1, p0, Lgg/n;->a:Lmg/c;
...
.method public constructor <init>(Lmg/d;Lmg/f;)V
    ...
    iput-object v0, p0, Lgg/n;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lgg/n;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lgg/n;->b:Ljava/util/List;

    sget-object v6, Lgg/n$c;->i:Lgg/n$c$a;
    ...
    iget-object p2, p0, Lgg/n;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lgg/n;->a:Lmg/c;
    ...
    iget-object p1, p0, Lgg/n;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lgg/n;->b:Ljava/util/List;
...
.method public final a(Lmg/e;)V
    ...
    invoke-virtual {p0}, Lgg/n;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lgg/n;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lgg/n;->a:Lmg/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lgg/n;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lgg/n;->a:Lmg/c;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lgg/n;->b:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lgg/n$c;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lgg/n;->c:B
...
.method public final newBuilderForType()Lmg/p$a;
    ...
    new-instance p0, Lgg/n$b;

    invoke-direct {p0}, Lgg/n$b;-><init>()V
