...
# static fields
.field public static final e:Lgg/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgg/d;->e:Lgg/d;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lgg/d;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lgg/d;->c:B

    iput v0, p0, Lgg/d;->d:I

    sget-object v0, Lmg/c;->a:Lmg/o;

    iput-object v0, p0, Lgg/d;->a:Lmg/c;

    return-void
.end method

.method public constructor <init>(Lgg/d$b;)V
    .locals 1
    ...
    iput-object p1, p0, Lgg/d;->a:Lmg/c;
...
.method public constructor <init>(Lmg/d;Lmg/f;)V
    ...
    iput-object v0, p0, Lgg/d;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lgg/d;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lgg/d;->b:Ljava/util/List;

    sget-object v6, Lgg/e;->j:Lgg/e$a;
    ...
    iget-object p2, p0, Lgg/d;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lgg/d;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lgg/d;->a:Lmg/c;
    ...
    iget-object p1, p0, Lgg/d;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lgg/d;->b:Ljava/util/List;
...
.method public final a(Lmg/e;)V
    ...
    invoke-virtual {p0}, Lgg/d;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lgg/d;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lgg/d;->a:Lmg/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lgg/d;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lgg/d;->a:Lmg/c;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lgg/d;->b:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lgg/e;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lgg/d;->c:B
...
.method public final newBuilderForType()Lmg/p$a;
    ...
    new-instance p0, Lgg/d$b;

    invoke-direct {p0}, Lgg/d$b;-><init>()V
...
.method public final toBuilder()Lmg/p$a;
    ...
    invoke-direct {v0}, Lgg/d$b;-><init>()V

    invoke-virtual {v0, p0}, Lgg/d$b;->j(Lgg/d;)V
