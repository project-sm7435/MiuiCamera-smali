...
# static fields
.field public static final g:LKh/d$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LKh/d;->g:LKh/d$a;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LKh/d;->a:Z

    iput-boolean v0, p0, LKh/d;->c:Z

    iput v0, p0, LKh/d;->e:I
...
.method public static d(LKh/d;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 1
...
.method public static f(LKh/d;Landroid/view/View;ILmiuix/appcompat/app/AlertDialog$d;LKh/d$b;)V
    .locals 4
    ...
    new-instance v2, LKh/d$g;

    invoke-direct {v2, p0, p3, p4, p1}, LKh/d$g;-><init>(LKh/d;Lmiuix/appcompat/app/AlertDialog$d;LKh/d$b;Landroid/view/View;)V
    ...
    iget-object p1, p0, LKh/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p1, p0, LKh/d;->b:Lmiuix/animation/IFolme;

    :cond_0
    iget-object p0, p0, LKh/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object p2, LKh/d;->g:LKh/d$a;
...
.method public final a(Landroid/view/View;Landroid/view/View;Lmiuix/appcompat/app/h;)V
    ...
    iput-object v5, v4, LKh/d$f;->a:Ljava/lang/ref/WeakReference;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, LKh/d$f;->b:Ljava/lang/ref/WeakReference;

    sget-object p3, LOh/j;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p3}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    move-result p3

    iput p3, v4, LKh/d$f;->c:I
    ...
    new-instance p3, LKh/d$h;

    invoke-direct {p3, p0, p1}, LKh/d$h;-><init>(LKh/d;Landroid/view/View;)V
    ...
    iget-object p3, p0, LKh/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p3, p0, LKh/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object v1, LKh/d;->g:LKh/d$a;
    ...
    invoke-static {p1}, Landroidx/core/view/g;->c(Landroid/view/View;)Landroid/view/WindowInsetsController;
    ...
    invoke-direct {v1, p0, p1, v3, v2}, LKh/g;-><init>(LKh/d;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V

    invoke-static {p3, v0, v1}, LH0/j;->f(Landroid/view/WindowInsetsController;ILKh/g;)V
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, LKh/a;->h(Landroid/view/View;)V
...
.method public final c(Landroid/view/View;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;)V
    ...
    invoke-direct {v1, p0, p1, p2, v0}, LKh/d$b;-><init>(LKh/d;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct/range {v3 .. v8}, LKh/d$c;-><init>(LKh/d;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;LKh/d$b;)V
    ...
    new-instance p0, LKh/d$d;

    invoke-direct {p0, v4, v6, v7, v8}, LKh/d$d;-><init>(LKh/d;ZLmiuix/appcompat/app/AlertDialog$d;LKh/d$b;)V

    invoke-virtual {v5, p0}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    :goto_2
    invoke-static {p2}, LKh/a;->q(Landroid/view/View;)V
