...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v2, v4}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v4

    sget-object v5, Ljava/lang/Character;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v5}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v5

    sget-object v6, Ljava/lang/Double;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v6}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v6

    sget-object v7, Ljava/lang/Float;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v7}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v7

    sget-object v8, Ljava/lang/Integer;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v8}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v8

    sget-object v9, Ljava/lang/Long;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v9}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;

    move-result-object v9

    sget-object v10, Ljava/lang/Short;->TYPE:Ljava/lang/Class;

    invoke-virtual {v2, v10}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LGf/d;
    ...
    invoke-static {v10}, Llf/o;->s([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v4}, Lbc/e;->I(LGf/d;)Ljava/lang/Class;

    move-result-object v5

    invoke-static {v4}, Lbc/e;->J(LGf/d;)Ljava/lang/Class;
    ...
    :cond_0
    invoke-static {v3}, Llf/H;->D(Ljava/util/List;)Ljava/util/Map;
    ...
    const-class v22, Lzf/k;

    const-class v23, Lzf/m;

    const-class v3, Lzf/a;

    const-class v4, Lzf/l;

    const-class v5, Lzf/p;

    const-class v6, Lzf/q;

    const-class v7, Lzf/r;

    const-class v8, Lzf/s;

    const-class v9, Lzf/t;

    const-class v10, Lzf/u;

    const-class v11, Lzf/v;

    const-class v12, Lzf/w;

    const-class v13, Lzf/b;

    const-class v14, Lzf/c;

    const-class v15, Lzf/d;

    const-class v16, Lzf/e;

    const-class v17, Lzf/f;

    const-class v18, Lzf/g;

    const-class v19, Lzf/h;

    const-class v20, Lzf/i;

    const-class v21, Lzf/j;

    const-class v24, Lzf/n;

    const-class v25, Lzf/o;
...
.method public static final b(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v1}, LQg/l;->y(Ljava/lang/String;CC)Ljava/lang/String;
...
.method public static final c(Ljava/lang/reflect/Type;)Ljava/util/List;
    ...
    invoke-static {p0}, Llf/l;->m0([Ljava/lang/Object;)Ljava/util/List;
