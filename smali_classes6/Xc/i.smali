...
.field public final p:Lad/e;

.field public final q:Lad/e$a;
...
# direct methods
.method public constructor <init>(LXc/i$b;)V
    .locals 6
    ...
    iput-object v0, p0, LXc/i;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, LXc/i;->d:Ljava/util/Stack;

    new-instance v2, LS0/e;

    invoke-direct {v2}, LS0/e;-><init>()V

    iput-object v2, p0, LXc/i;->e:LS0/e;

    const/4 v2, 0x0

    iput v2, p0, LXc/i;->u:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, LXc/i;->w:Ljava/util/concurrent/locks/ReentrantLock;

    const v3, 0xac44

    iput v3, p0, LXc/i;->A:I

    const/4 v3, 0x2

    iput v3, p0, LXc/i;->C:I

    const v3, 0x17700

    iput v3, p0, LXc/i;->H:I

    new-instance v3, LXc/i$a;

    invoke-direct {v3, p0}, LXc/i$a;-><init>(LXc/i;)V

    iput-object v3, p0, LXc/i;->h0:LXc/i$a;
    ...
    iget-object v4, p1, LXc/i$b;->a:Ljava/lang/ref/WeakReference;

    iput-object v4, p0, LXc/i;->f:Ljava/lang/ref/WeakReference;

    iget v5, p1, LXc/i$b;->b:I

    iput v5, p0, LXc/i;->i:I

    iget-object v5, p1, LXc/i$b;->c:Lad/e;

    iput-object v5, p0, LXc/i;->p:Lad/e;

    iget-object v5, p1, LXc/i$b;->d:Lad/e$a;

    iput-object v5, p0, LXc/i;->q:Lad/e$a;

    iget-object v5, p1, LXc/i$b;->f:Landroid/os/Handler;

    iput-object v5, p0, LXc/i;->r:Landroid/os/Handler;

    iget-object p1, p1, LXc/i$b;->e:Ljava/util/List;
    ...
    iget-object v0, p1, Lcom/android/camera/ActivityBase;->k0:Lq5/f;

    iput-object v0, p0, LXc/i;->b:Lq5/f;
    ...
    iput-object p1, p0, LXc/i;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;
...
.method public final c()V
    ...
    :cond_0
    iget-object v2, p0, LXc/i;->f:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, p0, LXc/i;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
    ...
    iget-object v4, p0, LXc/i;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, LXc/i;->h0:LXc/i$a;
    ...
    iput-object v0, p0, LXc/i;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendAudioTrack()Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    move-result-object v0

    iput-object v0, p0, LXc/i;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendVideoTrack()Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    move-result-object v0

    iput-object v0, p0, LXc/i;->e0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    iget-object v0, p0, LXc/i;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v2, p0, LXc/i;->l:Ljava/lang/String;

    iget v3, p0, LXc/i;->i:I
    ...
    iget-object v0, p0, LXc/i;->b:Lq5/f;
...
.method public final d(Lcom/xiaomi/milive/data/EffectItem;)V
    ...
    invoke-direct {v2, v3, p0, v0, p1}, LA9/q;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final f(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
    ...
    invoke-virtual {p0, p1}, LXc/i;->i(I)V
...
.method public final h(Ljava/lang/String;)V
    ...
    iget-object v2, p0, LXc/i;->a:Ljava/lang/String;
...
.method public final i(I)V
    ...
    iget v2, p0, LXc/i;->u:I

    invoke-static {v2}, LXc/i;->b(I)Ljava/lang/String;
    ...
    invoke-static {p1}, LXc/i;->b(I)Ljava/lang/String;
    ...
    iput p1, p0, LXc/i;->u:I

    iget-object p1, p0, LXc/i;->p:Lad/e;

    if-eqz p1, :cond_3

    iget p0, p0, LXc/i;->u:I

    iput p0, p1, Lad/e;->h:I
    ...
    :cond_0
    iget-object p0, p1, Lad/e;->f:Landroid/os/Handler;

    new-instance v0, LC/Q2;

    const/16 v1, 0xf

    invoke-direct {v0, p1, v1}, LC/Q2;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, p1, Lad/e;->f:Landroid/os/Handler;

    new-instance v1, LEi/a;

    const/4 v2, 0x5

    invoke-direct {v1, v2, p1, p0}, LEi/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p1, v1}, LC/r1;-><init>(Ljava/lang/Object;I)V
...
.method public final k(Lad/e$a;)V
    .locals 8
    ...
    iget-object v2, p0, LXc/i;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    invoke-direct/range {v1 .. v7}, LXc/g;-><init>(LXc/i;JJLad/e$a;)V

    iput-object v1, v2, LXc/i;->s:LXc/g;
    ...
    iget-object v0, v2, LXc/i;->a:Ljava/lang/String;
...
.method public final l()V
    ...
    iput-boolean v0, p0, LXc/i;->Z:Z

    :cond_0
    iget-object p0, p0, LXc/i;->Y:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
...
.method public final m()V
    ...
    :cond_0
    iget-object v0, p0, LXc/i;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;

    invoke-virtual {v0}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->getCurrentWorkspaceItem()Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    move-result-object v0

    iput-object v0, p0, LXc/i;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    iget-object v0, p0, LXc/i;->l:Ljava/lang/String;

    invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v0

    iget v2, p0, LXc/i;->i:I

    if-nez v0, :cond_1

    iget-object v0, p0, LXc/i;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    iget-object v5, p0, LXc/i;->l:Ljava/lang/String;
    ...
    iget-object p0, p0, LXc/i;->l:Ljava/lang/String;
