...
.field public e:LMe/Z0;

.field public f:LMe/w;


# direct methods
.method public static c()LMe/Z0;
    .locals 2
    ...
    :try_start_0
    iget-object v1, v0, LMe/b1;->e:LMe/Z0;
...
# virtual methods
.method public final declared-synchronized a()LMe/V0;
    .locals 6
    ...
    iget-object v1, p0, LMe/b1;->e:LMe/Z0;

    iget-object v1, v1, LMe/Z0;->a:Lcom/xiaomi/push/service/XMPushService;
    ...
    iput v2, v0, LMe/V0;->i:I

    iget-object v2, v0, LMe/V0;->k:Ljava/util/BitSet;
...
.method public final b(I)LMe/W0;
    .locals 6
    ...
    iget-object v2, p0, LMe/b1;->a:Ljava/lang/String;

    invoke-direct {v1}, LMe/W0;-><init>()V

    iput-object v2, v1, LMe/W0;->a:Ljava/lang/String;

    iput-object v0, v1, LMe/W0;->c:Ljava/util/ArrayList;

    iget-object v2, p0, LMe/b1;->e:LMe/Z0;
    ...
    iput-object v2, v1, LMe/W0;->b:Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {v1, v3}, LMe/W0;->j(LMe/I2;)V
    :try_end_0
    .catch LMe/H2; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object p0, p0, LMe/b1;->f:LMe/w;
    ...
    iget-object p0, p0, LMe/w$a;->a:LMe/V0;
    ...
    invoke-virtual {p0, v3}, LMe/V0;->j(LMe/I2;)V
...
.method public final declared-synchronized d(LMe/V0;)V
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, LMe/b1;->f:LMe/w;
    ...
    iput-object p1, v2, LMe/w$a;->a:LMe/V0;
