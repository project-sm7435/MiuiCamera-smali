...
.method public constructor <init>(JLUg/m;LUg/c;I)V
    ...
    invoke-direct {p0, p1, p2, p3, p5}, LYg/t;-><init>(JLYg/t;I)V
...
.method public final h(ILof/g;)V
    ...
    :cond_1
    iget-object p2, p0, LUg/m;->f:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    instance-of v1, p2, LSg/H0;

    iget-object v2, p0, LUg/m;->e:LUg/c;

    const/4 v3, 0x0

    if-nez v1, :cond_9

    instance-of v1, p2, LUg/y;
    ...
    :cond_3
    sget-object v1, LUg/g;->j:LHc/f;

    if-eq p2, v1, :cond_8

    sget-object v1, LUg/g;->k:LHc/f;
    ...
    :cond_4
    sget-object v1, LUg/g;->g:LHc/f;

    if-eq p2, v1, :cond_2

    sget-object v1, LUg/g;->f:LHc/f;
    ...
    :cond_8
    :goto_2
    invoke-virtual {p0, p1, v3}, LUg/m;->n(ILjava/lang/Object;)V
    ...
    :goto_4
    invoke-virtual {p0, p1, p2, v1}, LUg/m;->k(ILjava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, LUg/m;->m(IZ)V
...
.method public final m(IZ)V
    ...
    invoke-virtual {p2, v2, v3}, LUg/c;->J(J)V
...
.method public final o(ILHc/f;)V
    .locals 0
