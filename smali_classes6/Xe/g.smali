...
.method public constructor <init>()V
    ...
    iput v0, p0, LXe/g;->e:I

    const/4 v1, 0x1

    new-array v2, v1, [I

    iput-object v2, p0, LXe/g;->F:[I

    new-instance v2, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v2, p0, LXe/g;->L:Ljava/util/concurrent/atomic/AtomicLong;

    iput-boolean v1, p0, LXe/g;->O:Z

    const/16 v1, 0x64

    iput v1, p0, LXe/g;->P:I

    iput-boolean v0, p0, LXe/g;->Q:Z
...
.method public b(LMe/g;)V
    ...
    iget-object p1, p0, LXe/g;->H:Ljava/nio/FloatBuffer;
    ...
    iput-object p1, p0, LXe/g;->H:Ljava/nio/FloatBuffer;

    :cond_1
    iget-object p1, p0, LXe/g;->I:Ljava/nio/FloatBuffer;
    ...
    iput-object p1, p0, LXe/g;->I:Ljava/nio/FloatBuffer;
    ...
    iget-object p1, p0, LXe/g;->d:Landroid/content/Context;
    ...
    :goto_1
    iput-object p1, p0, LXe/g;->d:Landroid/content/Context;

    iget-object v0, p0, LXe/g;->D:Ljava/lang/String;

    if-eqz v0, :cond_5

    iget-object v1, p0, LXe/g;->F:[I
    ...
    iget-object v3, p0, LXe/g;->G:LQe/c;

    iget-boolean v3, v3, LQe/c;->k:Z

    iget-boolean v4, p0, LXe/g;->E:Z

    iget v5, p0, LXe/g;->C:I
    ...
    :cond_5
    iget-object p1, p0, LXe/g;->D:Ljava/lang/String;

    if-eqz p1, :cond_6

    iget-object v0, p0, LXe/g;->J:Landroid/graphics/Bitmap;

    if-nez v0, :cond_6

    iget-object v0, p0, LXe/g;->d:Landroid/content/Context;

    iget-object v1, p0, LXe/g;->G:LQe/c;

    iget-boolean v1, v1, LQe/c;->k:Z

    iget-boolean v2, p0, LXe/g;->E:Z
    ...
    iput-object p1, p0, LXe/g;->J:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, LXe/g;->M:LXe/g$a;
...
.method public final c(LKc/j;)V
    ...
    iput-object p1, p0, LXe/g;->G:LQe/c;
...
.method public d()V
    ...
    iget v2, p0, LXe/g;->e:I

    invoke-static {v2, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v0, p0, LXe/g;->e:I

    iget-object v2, p0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;
    ...
    iput-boolean v2, p0, LXe/g;->N:Z

    :cond_1
    iget-object v2, p0, LXe/g;->F:[I

    invoke-static {v2, v1}, Lcom/xiaomi/gl/MIGL;->glDeleteTextures([ILjava/lang/String;)V

    aput v0, v2, v0

    iget-object p0, p0, LXe/g;->L:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public final e(LMe/h;)I
    ...
    iget-object v7, v0, LXe/g;->G:LQe/c;

    const-string v8, "FilterBasicRender"

    if-eqz v7, :cond_1a

    iget-object v7, v7, LQe/c;->c:Ljava/lang/String;
    ...
    iget-object v0, v1, LMe/h;->c:LNe/b;
    ...
    :cond_1
    iget-object v7, v1, LMe/h;->f:Landroid/graphics/Rect;

    invoke-virtual {v7}, Landroid/graphics/Rect;->width()I

    move-result v7

    iput v7, v0, LXe/g;->f:I
    ...
    iget-boolean v8, v0, LXe/g;->O:Z

    const/4 v9, 0x5

    if-eqz v8, :cond_15

    iget-object v8, v0, LXe/g;->M:LXe/g$a;

    iget-object v10, v0, LXe/g;->G:LQe/c;
    ...
    :goto_0
    iget-object v8, v8, LXe/g$a;->a:LXe/g;

    iget-boolean v14, v8, LXe/g;->Q:Z
    ...
    :cond_5
    iget v14, v8, LXe/g;->P:I

    iget-object v8, v8, LXe/g;->G:LQe/c;

    iget v8, v8, LQe/c;->f:I
    ...
    :cond_7
    iget-boolean v11, v10, LQe/c;->d:Z

    if-nez v11, :cond_8

    iget-boolean v11, v10, LQe/c;->g:Z
    ...
    :goto_2
    iget-object v9, v0, LXe/g;->G:LQe/c;

    iget-boolean v10, v9, LQe/c;->l:Z

    if-eqz v10, :cond_e

    iget-boolean v11, v0, LXe/g;->B:Z

    if-ne v11, v10, :cond_f

    :cond_e
    iget-object v9, v9, LQe/c;->c:Ljava/lang/String;

    if-eqz v9, :cond_10

    iget-object v10, v0, LXe/g;->D:Ljava/lang/String;
    ...
    iget-object v10, v9, LQe/c;->c:Ljava/lang/String;

    iput-object v10, v0, LXe/g;->D:Ljava/lang/String;

    iget-boolean v11, v9, LQe/c;->h:Z

    iput-boolean v11, v0, LXe/g;->E:Z

    iget-boolean v13, v9, LQe/c;->l:Z

    iput-boolean v13, v0, LXe/g;->B:Z

    iget-object v13, v0, LXe/g;->d:Landroid/content/Context;

    iget-boolean v9, v9, LQe/c;->k:Z
    ...
    iput-object v9, v0, LXe/g;->J:Landroid/graphics/Bitmap;
    ...
    :goto_3
    iget-object v10, v0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;
    ...
    iput-object v9, v0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;

    invoke-virtual {v9, v8}, Lcom/xiaomi/milab/filtersdk/CandySDK;->a(Ljava/lang/String;)V

    iget-object v9, v0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;

    iget-object v10, v0, LXe/g;->J:Landroid/graphics/Bitmap;

    invoke-virtual {v9, v10}, Lcom/xiaomi/milab/filtersdk/CandySDK;->g(Landroid/graphics/Bitmap;)V

    iput-boolean v4, v0, LXe/g;->N:Z
    ...
    iget-object v2, v0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;
    ...
    iget-object v0, v0, LXe/g;->K:Lcom/xiaomi/milab/filtersdk/CandySDK;
    ...
    iget-object v1, v1, LMe/h;->j:LRe/h;

    iget-object v1, v1, LRe/h;->e:[F
    ...
    iget-object v2, v1, LMe/h;->g:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, LMe/h;->g:Landroid/util/Size;
    ...
    iget v6, v0, LXe/g;->l:I

    invoke-static {v6}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget v6, v0, LXe/g;->m:I
    ...
    invoke-virtual {v6, v2, v3}, LRe/h;->c(FF)V
    ...
    invoke-virtual {v2, v3, v6}, LRe/h;->f(FF)V
    ...
    invoke-virtual {v0, v2, v3}, LXe/g;->g(ILRe/h;)V

    iget-object v2, v0, LXe/g;->F:[I
    ...
    iget v2, v0, LXe/g;->l:I

    invoke-static {v2}, Landroid/opengl/GLES20;->glDisableVertexAttribArray(I)V

    iget v0, v0, LXe/g;->m:I
...
.method public g(ILRe/h;)V
    ...
    iget v0, p0, LXe/g;->l:I

    iget-object v5, p0, LXe/g;->H:Ljava/nio/FloatBuffer;
    ...
    iget v6, p0, LXe/g;->m:I

    iget-object v11, p0, LXe/g;->I:Ljava/nio/FloatBuffer;
    ...
    iget v0, p0, LXe/g;->h:I

    invoke-virtual {p2}, LRe/h;->a()[F
    ...
    iget v0, p0, LXe/g;->i:I

    iget-object v1, p2, LRe/h;->e:[F

    invoke-static {v0, v2, v3, v1, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget-object v0, p0, LXe/g;->G:LQe/c;

    iget-boolean v1, v0, LQe/c;->l:Z

    iget-object v4, p0, LXe/g;->F:[I

    if-eqz v1, :cond_0

    iget-boolean v5, p0, LXe/g;->B:Z

    if-ne v5, v1, :cond_1

    :cond_0
    iget-object v0, v0, LQe/c;->c:Ljava/lang/String;
    ...
    iput-object v1, p0, LXe/g;->D:Ljava/lang/String;

    iget v1, v0, LQe/c;->e:I

    iput v1, p0, LXe/g;->C:I

    iget-boolean v1, v0, LQe/c;->l:Z

    iput-boolean v1, p0, LXe/g;->B:Z

    iget-boolean v0, v0, LQe/c;->h:Z

    iput-boolean v0, p0, LXe/g;->E:Z
    ...
    iget-boolean v5, v1, LQe/c;->k:Z

    iget-boolean v6, p0, LXe/g;->E:Z

    iget-object v7, p0, LXe/g;->D:Ljava/lang/String;

    iget v1, v1, LQe/c;->e:I
    ...
    iget-object p1, p0, LXe/g;->G:LQe/c;

    iget-object p1, p1, LQe/c;->j:[F
    ...
    :cond_5
    iget p1, p0, LXe/g;->P:I

    iget-object v0, p0, LXe/g;->G:LQe/c;

    iget v0, v0, LQe/c;->f:I
    ...
    iget-object p1, p0, LXe/g;->L:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicLong;->getAndIncrement()J

    iget v0, p0, LXe/g;->s:I
    ...
    iget p2, p0, LXe/g;->f:I

    int-to-float p2, p2

    iget p0, p0, LXe/g;->g:I
