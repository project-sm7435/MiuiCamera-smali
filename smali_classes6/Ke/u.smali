...
.method static constructor <clinit>()V
    ...
    new-instance v1, LKe/u$a;

    new-instance v2, LKe/t;
    ...
    sput-object v0, LKe/u;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static a(Ljava/lang/String;Ljava/util/TreeMap;)LKe/q;
    .locals 8
    ...
    iput-object v4, v1, LKe/q;->b:Ljava/util/HashMap;
    ...
    new-instance v2, LKe/u$b;

    invoke-virtual {v4}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object v5

    invoke-direct {v2, v5}, LKe/u$b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-direct {v2, v4}, LKe/u$b;-><init>(Ljava/io/InputStream;)V
    ...
    iput-object v0, v1, LKe/q;->c:Ljava/lang/String;
    ...
    :cond_7
    :try_start_7
    iget-object v2, v1, LKe/q;->b:Ljava/util/HashMap;
    ...
    invoke-static {p1}, LQ9/C;->c(Ljava/io/Closeable;)V

    throw p0
.end method

.method public static b(Landroid/content/Context;)LKe/s;
    .locals 3
...
.method public static c(Landroid/content/Context;Ljava/net/URL;)LKe/u$b;
    .locals 3
    ...
    invoke-static {v0}, LCg/J;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v2, "&key="

    invoke-static {p1, v2, v0}, LA/n2;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    new-instance p1, LKe/u$b;

    invoke-virtual {p0}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p0

    invoke-direct {p1, p0}, LKe/u$b;-><init>(Ljava/io/InputStream;)V
    :try_end_0
...
.method public static d()LKe/v;
    .locals 6

    sget-object v0, LKe/u;->a:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LKe/u$a;
    ...
    invoke-virtual {v1}, LKe/u$a;->run()V
...
.method public static f(Landroid/content/Context;Ljava/net/URL;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, p1}, LKe/u;->c(Landroid/content/Context;Ljava/net/URL;)LKe/u$b;
...
.method public static g(Ljava/lang/String;Ljava/util/HashMap;Ljava/io/File;)V
    ...
    invoke-direct {v2, p0}, LKe/u$b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-static {p2}, LQ9/C;->c(Ljava/io/Closeable;)V
