...
.method public constructor <init>(Ljava/io/BufferedInputStream;)V
    ...
    iput v0, p0, LKe/z;->h:I

    const/16 v0, 0x1000

    new-array v0, v0, [B

    iput-object v0, p0, LKe/z;->a:[B

    const/4 v0, 0x0

    iput v0, p0, LKe/z;->b:I

    iput v0, p0, LKe/z;->d:I

    iput-object p1, p0, LKe/z;->e:Ljava/io/BufferedInputStream;
...
.method public constructor <init>([BII)V
    ...
    iput-object p1, p0, LKe/z;->a:[B

    add-int/2addr p3, p2

    iput p3, p0, LKe/z;->b:I

    iput p2, p0, LKe/z;->d:I
...
.method public final a()B
    ...
    iget v0, p0, LKe/z;->d:I

    iget v1, p0, LKe/z;->b:I

    if-ne v0, v1, :cond_0

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, LKe/z;->g(Z)Z
    ...
    iput v1, p0, LKe/z;->d:I

    iget-object p0, p0, LKe/z;->a:[B
...
.method public final b()I
    ...
    iput v0, p0, LKe/z;->f:I

    return v0

    :cond_0
    invoke-virtual {p0}, LKe/z;->l()I
...
.method public final c()LKe/a;
    ...
    :cond_0
    invoke-virtual {p0, v0}, LKe/z;->h(I)[B
    ...
    invoke-direct {p0, v1}, LKe/a;-><init>([B)V
...
.method public final e(LKe/C0;)V
    .locals 3
    ...
    iget v0, p0, LKe/z;->h:I

    if-gt v1, v0, :cond_1

    iput v1, p0, LKe/z;->h:I

    invoke-virtual {p0}, LKe/z;->i()V

    iget v1, p0, LKe/z;->i:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, LKe/z;->i:I

    invoke-virtual {p1, p0}, LKe/C0;->b(LKe/z;)LCg/k;

    iget p1, p0, LKe/z;->f:I

    if-nez p1, :cond_0

    iget p1, p0, LKe/z;->i:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, LKe/z;->i:I
...
.method public final f(I)Z
    ...
    :cond_2
    invoke-virtual {p0}, LKe/z;->b()I

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p0, v0}, LKe/z;->f(I)Z
    ...
    invoke-virtual {p0, p1}, LKe/z;->k(I)V
...
.method public final g(Z)Z
    ...
    :cond_1
    iput v0, p0, LKe/z;->g:I

    iput v2, p0, LKe/z;->d:I

    iget-object v0, p0, LKe/z;->e:Ljava/io/BufferedInputStream;
    ...
    iget p1, p0, LKe/z;->g:I

    iget v0, p0, LKe/z;->b:I

    add-int/2addr p1, v0

    iget p0, p0, LKe/z;->c:I
...
.method public final h(I)[B
    ...
    iget v3, p0, LKe/z;->h:I

    if-gt v2, v3, :cond_8

    iget v2, p0, LKe/z;->b:I
    ...
    invoke-virtual {p0, v1}, LKe/z;->g(Z)Z

    :goto_0
    sub-int v2, p1, v3

    iget v6, p0, LKe/z;->b:I
    ...
    iput v5, p0, LKe/z;->d:I

    iput v5, p0, LKe/z;->b:I
    ...
    iget-object v10, p0, LKe/z;->e:Ljava/io/BufferedInputStream;
    ...
    iget v11, p0, LKe/z;->g:I

    add-int/2addr v11, v10

    iput v11, p0, LKe/z;->g:I
    ...
    invoke-virtual {p0, v3}, LKe/z;->k(I)V
...
.method public final i()V
    ...
    iget v2, p0, LKe/z;->h:I

    if-le v1, v2, :cond_0

    sub-int/2addr v1, v2

    iput v1, p0, LKe/z;->c:I
