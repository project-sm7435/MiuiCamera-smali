...
.method public static a(Landroid/content/Context;Landroid/content/pm/PackageInfo;)V
    ...
    new-instance v6, Loe/q$b;

    const-string v7, ""

    invoke-direct {v6, v1, v7}, Loe/q$b;-><init>(ZLjava/lang/String;)V
    ...
    invoke-direct {v8, v9, v7}, Loe/q$b;-><init>(ZLjava/lang/String;)V
    ...
    invoke-direct {v6, v11, v9}, Loe/q$b;-><init>(ZLjava/lang/String;)V

    invoke-virtual {v3, v10, v6}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v6, Loe/q$b;

    invoke-direct {v6, v11, v7}, Loe/q$b;-><init>(ZLjava/lang/String;)V
    ...
    invoke-static {v7, v6}, Lcom/xiaomi/mipush/sdk/b;->f(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static/range {p0 .. p0}, Loe/k;->b(Landroid/content/Context;)Loe/k;

    move-result-object v6

    sget-object v9, Loe/j;->b:Loe/j;

    invoke-virtual {v6, v9}, Loe/k;->c(Loe/j;)V

    invoke-static/range {p0 .. p0}, Loe/k;->b(Landroid/content/Context;)Loe/k;

    move-result-object v6

    sget-object v7, Loe/j;->c:Loe/j;

    invoke-virtual {v6, v7}, Loe/k;->c(Loe/j;)V
    ...
    check-cast v11, Loe/q$b;

    invoke-virtual {v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-boolean v12, v7, Landroid/content/pm/ServiceInfo;->enabled:Z

    if-ne v1, v12, :cond_8

    iget-boolean v12, v7, Landroid/content/pm/ServiceInfo;->exported:Z

    iget-boolean v13, v11, Loe/q$b;->a:Z

    if-ne v13, v12, :cond_7

    iget-object v11, v11, Loe/q$b;->b:Ljava/lang/String;
...
.method public static c(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0, v0}, LKe/a3;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-static {v6, v0}, Loe/q;->b(Landroid/content/pm/ActivityInfo;[Ljava/lang/Boolean;)V
    ...
    invoke-static {p0, v5}, LKe/a3;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-virtual {v0, v1}, Loe/k;->c(Loe/j;)V
    ...
    invoke-virtual {p0, v0}, Loe/k;->c(Loe/j;)V

    return-void

    :cond_8
    new-instance p0, Loe/q$a;
