...
# virtual methods
.method public checkTerminated(ZZZLyj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Lyj/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Lyj/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Lyj/c;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lyj/c;)V

    return-void

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lyj/c;)V
...
.method public drainFused(Lyj/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Lyj/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lyj/c;)V
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLyj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v4, v15}, Lyj/c;->onNext(Ljava/lang/Object;)V
