...
.method public checkTerminated(ZZLvj/c;ZJ)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p0, p5, p6}, Lvj/d;->request(J)V
...
.method public drainNormal()V
    ...
    invoke-virtual/range {v0 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLvj/c;ZJ)Z
    ...
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lvj/d;

    invoke-interface {v0, v5, v6}, Lvj/d;->request(J)V
...
.method public subscribe(Lvj/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lvj/c;)V
