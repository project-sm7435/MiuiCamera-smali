...
# direct methods
.method public constructor <init>([Lyj/b;Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lyj/b;
...
.method public subscribeActual(Lyj/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Lyj/b;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;-><init>(Lyj/c;Lio/reactivex/functions/Function;IIZ)V

    invoke-interface {v2, v1}, Lyj/c;->onSubscribe(Lyj/d;)V

    invoke-virtual {v1, v0, v4}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;->subscribe([Lyj/b;I)V
