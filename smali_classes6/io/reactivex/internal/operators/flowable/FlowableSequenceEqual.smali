...
.method public constructor <init>(Lvj/b;Lvj/b;Lio/reactivex/functions/BiPredicate;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lvj/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lvj/b;
...
.method public subscribeActual(Lvj/c;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;-><init>(Lvj/c;ILio/reactivex/functions/BiPredicate;)V

    invoke-interface {p1, v0}, Lvj/c;->onSubscribe(Lvj/d;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Lvj/b;

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Lvj/b;

    invoke-virtual {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;->subscribe(Lvj/b;Lvj/b;)V
