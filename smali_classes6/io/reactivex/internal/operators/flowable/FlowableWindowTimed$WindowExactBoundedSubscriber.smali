...
# direct methods
.method public constructor <init>(Lvj/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lvj/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lvj/d;
    ...
    invoke-interface {v2, v3}, Lvj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lvj/d;

    invoke-interface {v1}, Lvj/d;->cancel()V
    ...
    invoke-interface {v2, v1}, Lvj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;

    invoke-interface {v4, v3}, Lvj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;
    ...
    invoke-interface {v1, v2}, Lvj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;

    invoke-interface {v0, p1}, Lvj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lvj/d;

    invoke-interface {p1}, Lvj/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lvj/c;
    ...
    invoke-interface {p1, v0}, Lvj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lvj/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lvj/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lvj/d;
    ...
    invoke-interface {v0, v1}, Lvj/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0}, Lvj/c;->onError(Ljava/lang/Throwable;)V
