...
# direct methods
.method public constructor <init>(Lyj/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lyj/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lyj/d;
    ...
    invoke-interface {v2, v3}, Lyj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lyj/d;

    invoke-interface {v1}, Lyj/d;->cancel()V
    ...
    invoke-interface {v2, v1}, Lyj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;

    invoke-interface {v4, v3}, Lyj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;
    ...
    invoke-interface {v1, v2}, Lyj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;

    invoke-interface {v0, p1}, Lyj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lyj/d;

    invoke-interface {p1}, Lyj/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lyj/c;
    ...
    invoke-interface {p1, v0}, Lyj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Lyj/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lyj/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Lyj/d;
    ...
    invoke-interface {v0, v1}, Lyj/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0}, Lyj/c;->onError(Ljava/lang/Throwable;)V
