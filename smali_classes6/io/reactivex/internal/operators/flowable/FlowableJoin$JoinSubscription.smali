...
.method public constructor <init>(Lvj/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lvj/c;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Lvj/c;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lvj/c;)V
    ...
    invoke-interface {v3}, Lvj/c;->onComplete()V
    ...
    invoke-interface {v7, v8}, Lvj/b;->subscribe(Lvj/c;)V
    ...
    invoke-interface {v3, v0}, Lvj/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lvj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    invoke-interface {v3, v8}, Lvj/c;->onNext(Ljava/lang/Object;)V
...
.method public errorAll(Lvj/c;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public fail(Ljava/lang/Throwable;Lvj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Lvj/c;)V
