...
# direct methods
.method public constructor <init>(Lyj/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lyj/c;
...
.method public onSubscribe(Lyj/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lyj/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lyj/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lyj/c;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lyj/c;
    ...
    invoke-interface {v3, v15}, Lyj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lyj/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lyj/d;->request(J)V
    ...
    invoke-interface {v3, v13}, Lyj/c;->onError(Ljava/lang/Throwable;)V
