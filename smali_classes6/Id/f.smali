...
.method public constructor <init>(Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    iput-object p1, p0, LId/f;->a:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    iput-object p1, p0, LId/f;->d:Lkf/n;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, LId/f;->e:Ljava/util/HashMap;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, LId/f;->f:Ljava/util/ArrayList;

    new-instance p1, LId/f$a;

    invoke-direct {p1, p0}, LId/f$a;-><init>(LId/f;)V

    iput-object p1, p0, LId/f;->g:LId/f$a;
...
.method public final a(Ljava/util/ArrayList;Ljava/util/HashMap;Ljava/util/ArrayList;)V
    ...
    iput p1, v0, LId/g;->b:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantLock;->unlock()V

    iget-object p1, p0, LId/f;->e:Ljava/util/HashMap;

    invoke-virtual {p1}, Ljava/util/HashMap;->clear()V

    invoke-virtual {p1, p2}, Ljava/util/HashMap;->putAll(Ljava/util/Map;)V

    iget-object p0, p0, LId/f;->f:Ljava/util/ArrayList;
...
.method public final b(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LId/f;->e:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v0, p0, LId/f;->a:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    invoke-direct {v2, v0, v3}, LDa/k;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lzf/a;)V

    iget-object v2, p0, LId/f;->f:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p1, v0}, LId/d;-><init>(Ljava/util/List;I)V

    invoke-static {v1, v2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lzf/a;)V

    invoke-static {v0, p1}, Llf/v;->O(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, v2}, LE9/a;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lzf/a;)V

    invoke-virtual {p0, p1}, LId/f;->c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    iget-object p0, p0, LId/f;->d:Lkf/n;
    ...
    iget-object p1, p0, LId/g;->c:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    iget-object p0, p0, LId/f;->a:Lcom/faceunity/core/avatar/model/Avatar;
...
.method public final d()V
    ...
    iget-object v0, p0, LId/f;->b:LId/i;
    ...
    iput-object v2, v0, LId/i;->c:LId/i$a;

    iget-object v0, v0, LId/i;->b:Lkf/n;

    invoke-virtual {v0}, Lkf/n;->getValue()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LId/i$b;

    iput-boolean v1, v0, LId/i$b;->a:Z

    :cond_0
    iput-object v2, p0, LId/f;->b:LId/i;

    iput-boolean v1, p0, LId/f;->c:Z
...
.method public final e()V
    ...
    iput-boolean v0, p0, LId/f;->c:Z

    new-instance v0, LId/i;

    iget-object v1, p0, LId/f;->a:Lcom/faceunity/core/avatar/model/Avatar;

    invoke-direct {v0, v1}, LId/i;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    iget-object v1, p0, LId/f;->g:LId/f$a;

    const-string v2, "listener"

    invoke-static {v1, v2}, Lkotlin/jvm/internal/k;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v1, v0, LId/i;->c:LId/i$a;

    new-instance v1, Ljava/lang/Thread;

    iget-object v2, v0, LId/i;->b:Lkf/n;

    invoke-virtual {v2}, Lkf/n;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, LId/i$b;

    invoke-direct {v1, v2}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    iput-object v0, p0, LId/f;->b:LId/i;
