...
.method public constructor <init>(Lnd/g;)V
    ...
    iput-object p1, p0, Lnd/g$a;->b:Lnd/g;
...
.method public final OnConvertProgress(I)V
    ...
    iget-object v0, p0, Lnd/g$a;->b:Lnd/g;

    if-eqz p1, :cond_0

    iget-object p0, p0, Lnd/g$d;->a:Lq4/c;

    invoke-interface {p1, p0}, LV3/z0;->De(Lq4/c;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0, v2}, Lnd/g;->k(Z)V
    ...
    iget-wide v5, v0, Lnd/g;->H:J

    invoke-static {v3, v4, v5, v6, p0}, LA/T;->i(JJLjava/lang/StringBuilder;)Ljava/lang/String;
