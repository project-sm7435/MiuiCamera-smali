...
.method public constructor <init>(Landroid/view/View;Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, LWc/c;->t:Landroid/view/View;

    iput-boolean p3, p0, LWc/c;->q:Z

    iput-object p2, p0, LWc/c;->d:Landroid/content/Context;
...
.method public final declared-synchronized a(FII)V
    ...
    iput v0, v1, LWc/c;->r:F

    iput v2, v1, LWc/c;->o:I

    iput v3, v1, LWc/c;->p:I

    iget-object v2, v1, LWc/c;->u:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, LWc/c;->u:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    iget-object v6, v1, LWc/c;->s:Landroid/util/Size;

    invoke-virtual {v6}, Landroid/util/Size;->getWidth()I

    move-result v6

    iget-object v7, v1, LWc/c;->s:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getHeight()I

    move-result v7

    iget v9, v1, LWc/c;->p:I
    ...
    :cond_4
    iput v11, v1, LWc/c;->g:I

    iput v10, v1, LWc/c;->k:I

    iput v12, v1, LWc/c;->j:I
    ...
    :cond_5
    sget-boolean v10, Lu0/e;->n:Z

    if-eqz v10, :cond_6

    iget-object v10, v1, LWc/c;->d:Landroid/content/Context;

    invoke-virtual {v10}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v10

    const v11, 0x7f07152f
    ...
    :cond_8
    iput v2, v1, LWc/c;->g:I

    sget-boolean v2, Lu0/e;->n:Z

    if-eqz v2, :cond_9

    iget-object v2, v1, LWc/c;->d:Landroid/content/Context;
    ...
    iput v0, v1, LWc/c;->k:I

    :goto_7
    iget v0, v1, LWc/c;->f:I

    iget v2, v1, LWc/c;->g:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, LWc/c;->h:I

    iget v0, v1, LWc/c;->j:I

    iget v2, v1, LWc/c;->k:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, LWc/c;->l:I
