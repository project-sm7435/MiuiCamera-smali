...
.method public final a(LKe/C0;)V
    ...
    iget-boolean v0, p1, LKe/C0;->a:Z

    if-eqz v0, :cond_7

    iget-boolean v0, p1, LKe/C0;->b:Z
    ...
    iget-object v0, p1, LKe/T;->a:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p1, LKe/T;->a:Ljava/util/HashMap;
    ...
    :try_start_1
    invoke-virtual {p1}, LKe/T;->j()V

    new-instance v0, Ljava/util/ArrayList;

    iget-object v2, p1, LKe/T;->a:Ljava/util/HashMap;
    ...
    iget-object v4, p1, LKe/T;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v4}, LKe/Q;->a()LKe/P;
    ...
    invoke-virtual {p1, v0}, LKe/T;->e(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v5, v6}, LKe/T;->h(Ljava/lang/String;LKe/P;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/service/XMPushService;->a()LKe/p1;
    ...
    iget-object v4, v1, LKe/q1;->a:Ljava/lang/String;
    ...
    iput-object v4, v1, LKe/q1;->a:Ljava/lang/String;

    :cond_4
    iget-object v1, v1, LKe/q1;->a:Ljava/lang/String;

    invoke-virtual {p1, v1, v3}, LKe/T;->a(Ljava/lang/String;Z)LKe/P;
    ...
    :try_start_2
    invoke-virtual {p1, v2}, LKe/P;->c(Z)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, LKe/p1;->a()Ljava/lang/String;
