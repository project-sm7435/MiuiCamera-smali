...
.field private mService:Lqc/f;


# direct methods
.method private constructor <init>(Lqc/f;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lqc/f;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lqc/b;)V

    return-void
.end method

.method public static synthetic access$002(Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;Lqc/f;)Lqc/f;
    .locals 0
...
.method private checkApiFeatureStatusChanged()Z
    ...
    invoke-static {p0, v0}, Lqc/i;->b(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;
    ...
    invoke-static {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lqc/f;
    ...
    invoke-direct {v2, v1, p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;-><init>(Lqc/f;Landroid/content/Context;)V
...
.method private declared-synchronized getService()Lqc/f;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lqc/f;
    ...
    invoke-static {v0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lqc/f;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lqc/f;
    ...
    invoke-static {v1, v3, v2, v0}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static getSystemService(Landroid/content/Context;)Lqc/f;
    .locals 9

    invoke-static {p0}, Lqc/d;->a(Landroid/content/Context;)Lqc/d;
    ...
    :try_start_0
    iget-object v5, p0, Lqc/d;->b:Lqc/e;

    new-instance v6, Lqc/c;

    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v5, v6}, Lrc/d;->j(Lqc/c;)Lrc/d$a;
    ...
    iget-object v5, p0, Lqc/d;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v3, p0, Lqc/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lqc/d;->d:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance p0, Lqc/f$a$a;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object v4, p0, Lqc/f$a$a;->a:Landroid/os/IBinder;
    ...
    invoke-static {v0, v2, v1, p0}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
# virtual methods
.method public addServiceListener(Lqc/b;)V
    .locals 0
...
.method public confirmChannel(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)I
    ...
    invoke-direct {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getService()Lqc/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Lqc/f;->g0(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)V
    ...
    invoke-interface {v0, p1, p2, p0}, Lqc/f;->T(IILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-interface {v0, p1, p2}, Lqc/f;->O(II)V
    ...
    invoke-static {v1, p2, p0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v1, p0, p2, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createChannel(Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    :try_start_0
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lqc/b;)V
    ...
    invoke-interface/range {v1 .. v6}, Lqc/f;->w(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-interface/range {v1 .. v6}, Lqc/f;->B(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-static {p3, p1, p4, p2}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lqc/b;)V
...
.method public createChannel(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface/range {v1 .. v6}, Lqc/f;->a(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
    ...
    invoke-interface/range {v1 .. v6}, Lqc/f;->F(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
...
.method public destroyChannel(I)I
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lqc/f;->E(I)V
    ...
    invoke-static {v1, v3, p0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, p0, v2, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getApiFeature()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Lqc/f;->h()Ljava/lang/String;
...
.method public getChannelInfoExt(II)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lqc/f;->d0(II)Landroid/os/Bundle;
    ...
    invoke-static {p2, p0, v0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerConnected(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p0, v3}, Lqc/i;->b(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-interface {v0, p1, p2}, Lqc/f;->k(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {v2, p2, p0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, p0, p2, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreateFailed(I)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v1}, Lqc/f;->a0(II)V
    ...
    invoke-static {v0, v2, p0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, p0, v1, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreated(II)V
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lqc/f;->a0(II)V
    ...
    invoke-static {v2, v0, p0, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v0, p2, v1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public registerChannelListener(Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lqc/b;)V
    ...
    invoke-interface {v0, p3, p1, p2, v1}, Lqc/f;->M(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/a;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lqc/b;)V
    ...
    invoke-static {p2, p0, p3, p1}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeServiceListener(Lqc/b;)V
    .locals 0
...
.method public send(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/SendResultCallback;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface {p0, p1, p2, p3, v3}, Lqc/f;->y(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/f;)I
...
.method public unbindService()V
    ...
    invoke-static {v0}, Lqc/d;->a(Landroid/content/Context;)Lqc/d;

    move-result-object v0

    const-string v1, "continuity_connection"

    iget-object v2, v0, Lqc/d;->d:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lqc/d;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    :goto_0
    iget-object v1, v0, Lqc/d;->d:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lqc/d;->b:Lqc/e;

    iput-boolean v3, v0, Lrc/d;->m:Z

    iget-object v1, v0, Lrc/d;->h:Landroid/os/Handler;

    new-instance v3, LC1/c;

    const/16 v4, 0x18

    invoke-direct {v3, v0, v4}, LC1/c;-><init>(Ljava/lang/Object;I)V
...
.method public unregisterChannelListener(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lqc/b;)V
    ...
    invoke-interface {p0, p1}, Lqc/f;->l0(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-static {p0, v4, p1, v3}, Ltc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
