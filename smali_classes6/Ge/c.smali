...
.method public constructor <init>(Landroid/graphics/Bitmap;ILjava/lang/String;FLandroid/graphics/BitmapShader;)V
    ...
    invoke-direct {p0, p3, v0}, LGe/a;-><init>(Ljava/lang/String;I)V

    iput-object p1, p0, LGe/c;->n:Landroid/graphics/Bitmap;

    iput p2, p0, LGe/c;->o:I
    ...
    iput-object p1, p0, LGe/c;->r:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, LGe/c;->s:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, LGe/c;->t:Landroid/graphics/Matrix;
    ...
    :cond_0
    iput-object p1, p0, LGe/c;->u:Landroid/graphics/Paint;
...
.method public final a(LIe/a;Ljava/lang/String;)V
    ...
    iput p2, p0, LGe/c;->v:I

    iget p2, p0, LGe/c;->o:I
    ...
    invoke-virtual {p1, v0, v1, v3}, LIe/a;->F0(FFF)V
    ...
    invoke-virtual {p1, v3, p2}, LIe/a;->G0(FF)V
    ...
    iput-object p2, p0, LGe/c;->s:Landroid/graphics/RectF;
    ...
    :goto_1
    iget-object v8, p0, LGe/c;->u:Landroid/graphics/Paint;

    iget-object p2, p0, LGe/c;->q:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, LGe/c;->t:Landroid/graphics/Matrix;
    ...
    iget-object p2, p0, LGe/c;->s:Landroid/graphics/RectF;
    ...
    iget p2, p0, LGe/a;->i:I

    int-to-float v7, p2

    move-object v3, p1

    invoke-virtual/range {v3 .. v8}, LIe/a;->B0(FFFFLandroid/graphics/Paint;)V
    ...
    iget-object p1, p0, LGe/c;->r:Landroid/graphics/Rect;

    iget-object p2, p0, LGe/c;->s:Landroid/graphics/RectF;

    iget-object v0, p0, LGe/c;->n:Landroid/graphics/Bitmap;

    invoke-virtual {v3, v0, p1, p2, v8}, LIe/a;->z0(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V

    :cond_5
    iget p0, p0, LGe/c;->v:I

    invoke-virtual {v3, p0}, LIe/a;->E0(I)V
...
.method public final f()Landroid/util/Size;
    ...
    iget-object v1, p0, LGe/c;->n:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, LGe/c;->r:Landroid/graphics/Rect;

    iget p0, p0, LGe/c;->o:I
