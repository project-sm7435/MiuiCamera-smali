...
# static fields
.field public static final g:LGh/d$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LGh/d;->g:LGh/d$a;
...
.method public static d(LGh/d;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 1
...
.method public static f(LGh/d;Landroid/view/View;ILmiuix/appcompat/app/AlertDialog$d;LGh/d$b;)V
    .locals 4
    ...
    new-instance v2, LGh/d$g;

    invoke-direct {v2, p0, p3, p4, p1}, LGh/d$g;-><init>(LGh/d;Lmiuix/appcompat/app/AlertDialog$d;LGh/d$b;Landroid/view/View;)V
    ...
    iget-object p1, p0, LGh/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p1, p0, LGh/d;->b:Lmiuix/animation/IFolme;

    :cond_0
    iget-object p0, p0, LGh/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object p2, LGh/d;->g:LGh/d$a;
...
.method public final a(Landroid/view/View;Landroid/view/View;Lmiuix/appcompat/app/h;)V
    ...
    iput-object v5, v4, LGh/d$f;->a:Ljava/lang/ref/WeakReference;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, LGh/d$f;->b:Ljava/lang/ref/WeakReference;

    sget-object p3, LKh/j;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p3}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    move-result p3

    iput p3, v4, LGh/d$f;->c:I
    ...
    new-instance p3, LGh/d$h;

    invoke-direct {p3, p0, p1}, LGh/d$h;-><init>(LGh/d;Landroid/view/View;)V
    ...
    iget-object p3, p0, LGh/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p3, p0, LGh/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object v1, LGh/d;->g:LGh/d$a;
    ...
    invoke-static {p1}, LA/y0;->e(Landroid/view/View;)Landroid/view/WindowInsetsController;
    ...
    invoke-direct {v1, p0, p1, v3, v2}, LGh/f;-><init>(LGh/d;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V

    invoke-static {p3, v0, v1}, LGh/c;->c(Landroid/view/WindowInsetsController;ILGh/f;)V
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, LCg/j0;->i(Landroid/view/View;)V
...
.method public final c(Landroid/view/View;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;)V
    ...
    invoke-direct {v1, p0, p1, p2, v0}, LGh/d$b;-><init>(LGh/d;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct/range {v3 .. v8}, LGh/d$c;-><init>(LGh/d;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;LGh/d$b;)V
    ...
    invoke-direct {v0, p0, p3, p4, v8}, LGh/d$d;-><init>(LGh/d;ZLmiuix/appcompat/app/AlertDialog$d;LGh/d$b;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    :goto_2
    invoke-static {p2}, LCg/j0;->G(Landroid/view/View;)V
