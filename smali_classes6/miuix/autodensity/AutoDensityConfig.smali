...
.method private constructor <init>(Landroid/app/Application;)V
    ...
    iget-object v2, v0, Lph/c;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lph/c;->c:Lph/c$b;

    if-nez v3, :cond_0

    new-instance v3, Lph/c$b;
    ...
    iput-object v4, v3, Lph/c$b;->a:Ljava/util/ArrayList;

    iput-object v3, v0, Lph/c;->c:Lph/c$b;
    ...
    iget-object v3, v3, Lph/c$b;->a:Ljava/util/ArrayList;
    ...
    iget-object p0, v0, Lph/c;->b:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    iget-object p1, v0, Lph/c;->d:Lph/c$a;

    if-nez p1, :cond_1

    new-instance p1, Lph/c$a;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, v0, Lph/c;->d:Lph/c$a;
    ...
    iget-object v0, p1, Lph/c$a;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p1, Lph/c$a;->a:Ljava/util/ArrayList;

    :cond_2
    iget-object p1, p1, Lph/c$a;->a:Ljava/util/ArrayList;
...
.method private changeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {p1, v0, v1}, LEi/a;->c(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
...
.method public static createAutoDensityContextWrapper(Landroid/content/Context;II)Landroid/content/Context;
    ...
    invoke-static {p0, v4}, Lki/b;->b(Landroid/content/Context;Landroid/view/Display;)Z

    move-result v5

    if-nez v5, :cond_1

    invoke-static {p0}, Lki/b;->e(Landroid/content/Context;)Z
...
.method private removeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {p1, p0, v0, v1}, LEi/a;->h(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setForceDeviceScale(F)V
    ...
    invoke-static {v0}, LCg/v;->i(Ljava/lang/String;)V
...
.method public onRegisterDensityCallback(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, LCg/v;->i(Ljava/lang/String;)V
...
.method public prepareInApplication(Landroid/app/Application;)V
    ...
    invoke-static {v1, v2, v3, v4, v5}, LEi/a;->f(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sput-object v1, LCg/v;->c:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lki/b;->b(Landroid/content/Context;Landroid/view/Display;)Z
...
.method public processBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0, v4, v2}, LKh/a;->k(Landroid/content/Context;LKh/n;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v0}, Lmiuix/autodensity/f;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;LKh/n;)V
    ...
    invoke-static {p1, v1, v4, v2}, LKh/a;->k(Landroid/content/Context;LKh/n;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v1}, Lmiuix/autodensity/f;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;LKh/n;)V
