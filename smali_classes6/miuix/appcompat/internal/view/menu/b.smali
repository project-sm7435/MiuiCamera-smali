...
.method public final b()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LIh/e;
...
.method public final f()Z
    ...
    invoke-direct {v0, v2, v1}, LJh/e;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    const v1, 0x800055

    invoke-virtual {v0, v1}, LAi/l;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    iput-object p0, v0, LAi/l;->u:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, LJh/e;->q0:LJh/e$c;

    const/4 v1, 0x0

    iput-boolean v1, v0, LAi/l;->d0:Z

    new-instance v0, LIh/e;

    const/4 v3, 0x1

    invoke-direct {v0, v2, v3}, LIh/e;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LIh/e;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LIh/e;

    invoke-virtual {v4, v0}, LIh/e;->d(Ljava/util/HashMap;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LIh/e;

    invoke-virtual {v0, v2}, LIh/e;->e(Lmiuix/appcompat/internal/view/menu/d;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LIh/e;

    iget-object v0, v0, LJh/e;->j0:LJh/e$d;

    iput-object v2, v0, LJh/e$d;->b:Landroid/widget/ListAdapter;

    iget-object v0, v2, LIh/e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    iput-boolean v0, v2, LJh/e;->s0:Z

    invoke-virtual {v2, v1}, LAi/l;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    invoke-virtual {v0, v1}, LAi/l;->setVerticalOffset(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/b;->h:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    iput v0, v1, LAi/l;->l:I
    ...
    invoke-virtual {v0, v1}, LJh/e;->E(Landroid/view/View;)V
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    iget-boolean p0, p0, LAi/l;->e0:Z
...
.method public final j()V
    ...
    iget-object v0, v0, LIh/e;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, LIh/e;->i:Ljava/util/HashMap;
