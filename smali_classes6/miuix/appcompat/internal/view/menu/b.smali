...
.method public final b()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LEh/e;
...
.method public final f()Z
    ...
    invoke-direct {v0, v2, v1}, LFh/d;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    const v1, 0x800055

    invoke-virtual {v0, v1}, Lwi/j;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    iput-object p0, v0, Lwi/j;->u:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, LFh/d;->q0:LFh/d$c;

    const/4 v1, 0x0

    iput-boolean v1, v0, Lwi/j;->d0:Z

    new-instance v0, LEh/e;

    const/4 v3, 0x1

    invoke-direct {v0, v2, v3}, LEh/e;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LEh/e;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LEh/e;

    invoke-virtual {v4, v0}, LEh/e;->d(Ljava/util/HashMap;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LEh/e;

    invoke-virtual {v0, v2}, LEh/e;->e(Lmiuix/appcompat/internal/view/menu/d;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LEh/e;

    iget-object v0, v0, LFh/d;->j0:LFh/d$d;

    iput-object v2, v0, LFh/d$d;->b:Landroid/widget/ListAdapter;

    iget-object v0, v2, LEh/e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    iput-boolean v0, v2, LFh/d;->s0:Z

    invoke-virtual {v2, v1}, Lwi/j;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    invoke-virtual {v0, v1}, Lwi/j;->setVerticalOffset(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/b;->h:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    iput v0, v1, Lwi/j;->l:I
    ...
    invoke-virtual {v0, v1}, LFh/d;->E(Landroid/view/View;)V
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LFh/d;

    iget-boolean p0, p0, Lwi/j;->e0:Z
...
.method public final j()V
    ...
    iget-object v0, v0, LEh/e;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, LEh/e;->i:Ljava/util/HashMap;
