...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Landroid/view/View;)V
    ...
    sget p3, Luh/a$c;->overflowMenuMaxHeight:I

    invoke-static {p2, p3}, Lfi/d;->j(Landroid/content/Context;I)Landroid/util/TypedValue;
    ...
    invoke-static {p4}, Lfi/h;->c(Landroid/view/View;)Z
...
.method public final e(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LJh/e;

    new-instance v0, LFh/b;

    invoke-direct {v0, p0}, LFh/b;-><init>(Lmiuix/appcompat/internal/view/menu/b;)V

    iput-object v0, p1, LAi/l;->u:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {p1}, LAi/l;->dismiss()V
