...
# virtual methods
.method public final Bb(Landroid/content/res/Configuration;LLi/d;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lmiuix/appcompat/app/q;->E9(Landroid/content/res/Configuration;LLi/d;Z)V

    return-void
.end method

.method public final E9(Landroid/content/res/Configuration;LLi/d;Z)V
    .locals 0
    ...
    invoke-interface {p0, p1, p2, p3}, LKi/a;->E9(Landroid/content/res/Configuration;LLi/d;Z)V
...
.method public final Z5(I)V
    ...
    invoke-interface {v2}, Lmiuix/appcompat/app/t;->a9()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2}, LMh/c;->gf()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2, p1}, LMh/a;->Z5(I)V
...
.method public final j8()Landroid/content/Context;
    .locals 3
...
.method public final kb()Lmiuix/appcompat/internal/app/widget/ActionBarImpl;
    .locals 2
...
.method public final l(Landroid/content/res/Configuration;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/d;->t:LMh/b;

    invoke-virtual {v0, v2}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LMh/b;)V
    ...
    invoke-virtual {p0, p1}, LMi/b;->b(Landroid/content/res/Configuration;)V
...
.method public final n(IZI)Landroid/animation/Animator;
    ...
    sget p1, Luh/a$a;->miuix_appcompat_fragment_transition_activity_open_enter:I
    ...
    invoke-direct {p1, p0, p2, p2}, LBh/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    return-object p1

    :cond_0
    sget p1, Luh/a$a;->miuix_appcompat_fragment_transition_activity_open_exit:I
    ...
    invoke-direct {p1, p0, p2, v0}, LBh/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    return-object p1

    :cond_1
    sget p1, Luh/a$a;->miuix_appcompat_fragment_transition_activity_close_enter:I

    if-ne p3, p1, :cond_2

    new-instance p1, LBh/a;

    invoke-direct {p1, p0, v0, p2}, LBh/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V

    return-object p1

    :cond_2
    sget p1, Luh/a$a;->miuix_appcompat_fragment_transition_activity_close_exit:I

    if-ne p3, p1, :cond_3

    new-instance p1, LBh/a;

    invoke-direct {p1, p0, v0, v0}, LBh/a;-><init>(Landroidx/fragment/app/Fragment;ZZ)V
...
.method public final o(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/q;->j8()Landroid/content/Context;
    ...
    sget v2, Luh/a$m;->Window_responsiveEnabled:I
    ...
    :cond_0
    sget v2, Luh/a$m;->Window_windowActionBar:I
    ...
    :cond_1
    sget v2, Luh/a$m;->Window_windowActionBarOverlay:I
    ...
    iget-object v5, p0, Lmiuix/appcompat/app/d;->t:LMh/b;

    if-eqz v5, :cond_4

    iput-boolean v2, v5, LMh/b;->a:Z
    ...
    :cond_7
    sget v2, Luh/a$m;->Window_windowExtraPaddingApplyToContentEnable:I
    ...
    :cond_9
    sget v2, Luh/a$m;->Window_windowTranslucentStatus:I
    ...
    sget v8, Luh/a$j;->miuix_appcompat_screen_action_bar:I
    ...
    invoke-virtual {p2, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(LMh/a;)V
    ...
    invoke-static {v2, v9}, Lfi/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v2, Luh/a$d;->abc_split_action_bar_is_narrow:I
    ...
    sget v2, Luh/a$m;->Window_windowSplitActionBar:I
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/d;->t:LMh/b;

    invoke-virtual {p2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LMh/b;)V
    ...
    sget p1, Luh/a$m;->Window_hyperSplitMenuEnabled:I
    ...
    :cond_15
    sget p1, Luh/a$m;->Window_endActionMenuEnabled:I
    ...
    sget p1, Luh/a$m;->Window_hyperActionMenuEnabled:I
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/t;->a9()Z
    ...
    iget-object p2, p0, Lmiuix/appcompat/app/d;->t:LMh/b;
    ...
    invoke-virtual {p0, p1, p2, p3, p3}, Lmiuix/appcompat/app/q;->q(Landroid/content/Context;LMh/b;II)Z
...
.method public final q(Landroid/content/Context;LMh/b;II)Z
    .locals 11
