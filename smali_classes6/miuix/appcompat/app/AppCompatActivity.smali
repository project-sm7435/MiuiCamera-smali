...
.method public final N9()V
    ...
    invoke-interface {p0}, Lwh/d;->N9()V
...
.method public final P4()V
    ...
    invoke-interface {p0}, Lwh/d;->P4()V
...
.method public bindViewWithContentInset(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lfi/h$b;-><init>(IIII)V

    iput-object v0, p0, Lmiuix/appcompat/app/d;->p:Lfi/h$b;
...
.method public final dj()Landroid/view/View;
    ...
    invoke-virtual {p0}, Lxh/a;->b()Landroid/view/View;
...
.method public finish()V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/j;->e0:Lxh/a;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lxh/a;->a()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1}, LMi/b;->c()V

    :cond_0
    iget-object p0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LOh/n;

    iget-boolean v1, p0, LOh/n;->a:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, LOh/n;->b:Z
    ...
    :cond_1
    sget-object v1, LOh/a;->a:Landroid/graphics/Point;
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LOh/n;

    const/4 v2, 0x0

    invoke-static {p0, v1, p1, v2}, LOh/a;->k(Landroid/content/Context;LOh/n;Landroid/content/res/Configuration;Z)V
    ...
    iput-object v1, v0, Lmiuix/appcompat/app/j;->m0:LC/M1;
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/j;->m0:LC/M1;
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/d;->t:LMh/b;

    invoke-virtual {p0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LMh/b;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, LOh/a;->i(Landroid/content/Context;)V
    ...
    sget-boolean v2, LDh/e;->a:Z

    const/4 v3, 0x1

    if-nez v2, :cond_0

    sput-boolean v3, LDh/e;->a:Z
    ...
    invoke-direct {v5, v2}, LDh/d;-><init>(Landroid/content/Context;)V
    ...
    :cond_0
    sget v2, Luh/a$c;->windowExtraPaddingHorizontal:I

    const/4 v4, 0x0

    invoke-static {v2, v1, v4}, Lfi/d;->i(ILandroid/content/Context;I)I
    ...
    :cond_1
    sget v2, Luh/a$c;->windowExtraPaddingHorizontalEnable:I
    ...
    :cond_2
    sget v4, Luh/a$c;->windowExtraPaddingHorizontalInitEnable:I

    iget-boolean v5, v0, Lmiuix/appcompat/app/d;->w:Z

    invoke-static {v1, v4, v5}, Lfi/d;->d(Landroid/content/Context;IZ)Z
    ...
    :cond_3
    sget v5, Luh/a$c;->windowExtraPaddingApplyToContentEnable:I

    iget-boolean v6, v0, Lmiuix/appcompat/app/d;->x:Z

    invoke-static {v1, v5, v6}, Lfi/d;->d(Landroid/content/Context;IZ)Z
    ...
    invoke-static {p0, p1, v0, v3}, LOh/a;->k(Landroid/content/Context;LOh/n;Landroid/content/res/Configuration;Z)V

    iput-object p1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LOh/n;

    invoke-static {p0}, LOh/k;->n(Landroid/content/Context;)Z
...
.method public onDestroy()V
    ...
    iget-object v0, v0, Lmiuix/appcompat/app/j;->m0:LC/M1;
    ...
    :cond_2
    invoke-static {p0}, LOh/a;->j(Landroid/content/Context;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LOh/n;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/j;->e0:Lxh/a;
...
.method public final onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E(Landroid/view/ActionMode$Callback;)LEh/b;
...
.method public final pf()V
    ...
    invoke-interface {p0}, Lwh/d;->pf()V
...
.method public final startActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    sget v1, Luh/a$h;->content_mask_vs:I
    ...
    :cond_0
    sget v1, Luh/a$h;->content_mask:I
