...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p1, p2}, Lwh/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lwh/a;

    const/4 p0, 0x1

    iput-boolean p0, v0, Lwh/a;->d:Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lwh/a;
    ...
    sget v4, Luh/a$h;->contentPanel:I
...
.method public final onFinishInflate()V
    ...
    sget v0, Luh/a$h;->contentPanel:I
...
.method public final onMeasure(II)V
    ...
    iget-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lwh/a;

    iget-object v3, v0, Lwh/a;->h:Landroid/util/TypedValue;

    iget-object v4, v0, Lwh/a;->f:Landroid/util/TypedValue;

    iget-object v5, v0, Lwh/a;->k:Landroid/util/TypedValue;

    iget-object v6, v0, Lwh/a;->l:Landroid/util/TypedValue;

    const/4 v2, 0x0

    move v1, p2

    invoke-virtual/range {v0 .. v6}, Lwh/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    ...
    :cond_0
    iget-object v3, v0, Lwh/a;->e:Landroid/util/TypedValue;

    iget-object v4, v0, Lwh/a;->g:Landroid/util/TypedValue;

    iget-object v5, v0, Lwh/a;->i:Landroid/util/TypedValue;

    iget-object v6, v0, Lwh/a;->j:Landroid/util/TypedValue;
