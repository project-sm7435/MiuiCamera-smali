...
# direct methods
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;LHd/g;LHd/f;Lkotlin/jvm/internal/x;)V
    .locals 0

    iput-object p1, p0, Lne/d;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iput-object p2, p0, Lne/d;->a:LHd/g;

    iput-object p3, p0, Lne/d;->b:LHd/f;

    iput-object p4, p0, Lne/d;->c:Lkotlin/jvm/internal/x;
...
.method public final convert(ILcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Ljava/lang/Object;I)V
    ...
    iget-object p1, p0, Lne/d;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->i:Ljava/util/HashMap;

    iget-object v1, p3, LHd/e;->g:Ljava/lang/String;
    ...
    iget-object v5, p0, Lne/d;->a:LHd/g;

    iget-wide v6, v5, LHd/g;->b:D
    ...
    iget-object v3, p3, LHd/e;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p3, LHd/e;->c:Ljava/lang/String;
    ...
    iput-boolean v4, v5, LHd/g;->d:Z

    goto :goto_2

    :cond_2
    iget-boolean v2, v5, LHd/g;->d:Z
    ...
    :goto_2
    sget-object v4, LMd/b;->n:Ljava/util/HashMap;

    iget-object v5, p0, Lne/d;->b:LHd/f;
    ...
    :cond_4
    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lke/m;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v0, Lke/m;->i:LJd/d;
    ...
    :cond_6
    :goto_3
    invoke-virtual {p1, p2, v0}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Gd(Lcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;LHd/b;)V
    ...
    iget-object p2, v5, LHd/f;->d:LHd/h;

    iget-object v0, p2, LHd/h;->b:LHd/e;

    invoke-virtual {p3, v0}, LHd/e;->equals(Ljava/lang/Object;)Z

    move-result p3

    iget-object p0, p0, Lne/d;->c:Lkotlin/jvm/internal/x;
    ...
    iget-object p2, p2, LHd/h;->b:LHd/e;
...
.method public final onItemClickListener(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-static {p1}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Ec(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V

    iget-boolean v0, p2, LHd/e;->f:Z

    if-eqz v0, :cond_13

    iget-object v0, p0, Lne/d;->c:Lkotlin/jvm/internal/x;
    ...
    iget-object p1, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lke/m;

    iget-object p0, p0, Lne/d;->b:LHd/f;

    iget-object p0, p0, LHd/f;->a:Ljava/lang/String;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance p3, Lke/e;

    invoke-direct {p3, p0, p2}, Lke/e;-><init>(Ljava/lang/String;LHd/e;)V

    const-string v0, "KIT_EditorViewModel"

    invoke-static {v0, p3}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lwf/a;)V

    iget-object p3, p1, Lke/m;->v:Ljava/util/HashMap;

    iget-object v2, p2, LHd/e;->g:Ljava/lang/String;

    invoke-virtual {p3, p0, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p3, LFd/a;->g:LFd/a$a;

    invoke-virtual {p3, p0}, LFd/a$a;->contains(Ljava/lang/Object;)Z
    ...
    iget-object p3, p1, Lke/m;->i:LJd/d;

    invoke-static {p3}, Lkotlin/jvm/internal/k;->c(Ljava/lang/Object;)V

    iget-object p3, p3, LJd/d;->b:Ljava/util/HashMap;
    ...
    sget-object p3, LHd/b;->a:LHd/b;

    :cond_6
    sget-object v3, LHd/b;->b:LHd/b;
    ...
    :cond_7
    iget-object p3, p1, Lke/m;->c:LMd/a;

    if-eqz p3, :cond_e

    iget-object v2, p3, LMd/a;->a:LMd/b;

    invoke-virtual {v2, p0}, LMd/b;->i(Ljava/lang/String;)LHd/f;
    ...
    iget-object v3, v3, LHd/f;->c:LHd/g;

    iget-object v3, v3, LHd/g;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v5}, LMd/b;->i(Ljava/lang/String;)LHd/f;
    ...
    :cond_a
    iget-object v6, v6, LHd/f;->d:LHd/h;

    iget-object v6, v6, LHd/h;->b:LHd/e;
    ...
    :cond_b
    iget-object v6, p3, LMd/a;->c:Ljava/lang/String;

    invoke-virtual {v2, v5, v6}, LMd/b;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p1, p0, p2}, Lke/f;-><init>(Lke/m;Ljava/lang/String;LHd/e;)V

    new-instance p2, LGd/a;

    const/4 v2, 0x3

    invoke-direct {p2, p0, v2}, LGd/a;-><init>(Ljava/lang/Object;I)V

    invoke-static {v0, p2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lwf/a;)V

    iget-object p2, p1, Lke/m;->k:Lhf/n;
    ...
    invoke-direct {v0, p1, p3, p0, v1}, Lke/g;-><init>(Lke/m;Ljava/util/ArrayList;Ljava/lang/String;Lke/f;)V
    ...
    iget-object v1, p1, Lke/m;->n:Lcom/faceunity/core/avatar/model/Scene;

    if-eqz v1, :cond_11

    invoke-virtual {p3, v1, p0, p2}, LMd/a;->c(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;LHd/e;)V

    iget-object p2, p1, Lke/m;->t:LGd/g;

    if-eqz p2, :cond_10

    invoke-virtual {p2, p0}, LGd/g;->b(Ljava/lang/String;)V

    :cond_10
    iget-object p1, p1, Lke/m;->u:LHd/d;
    ...
    invoke-direct {p2, p1, p0}, Lke/a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v0, p2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lwf/a;)V

    sget-object p0, LFd/a;->h:LFd/a$b;

    invoke-virtual {p0, p1}, LFd/a$b;->contains(Ljava/lang/Object;)Z
