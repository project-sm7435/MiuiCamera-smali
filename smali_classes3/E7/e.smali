...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    new-instance p1, LCg/l0;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, LCg/l0;-><init>(Ljava/lang/Object;I)V

    invoke-static {p1}, LCg/z;->E(Lwf/a;)Lhf/n;

    move-result-object p1

    iput-object p1, p0, LE7/e;->c:Lhf/n;

    sget-object p1, LB7/b;->c:LQ7/a;

    iput-object p1, p0, LE7/e;->d:LQ7/a;
...
# virtual methods
.method public final a(Ljava/lang/String;ZZ)LB7/i;
    .locals 5
    ...
    invoke-direct {p2, p0, p1, v0, v1}, LE7/c;-><init>(LE7/e;Ljava/lang/String;ZLlf/e;)V

    sget-object v0, Llf/i;->a:Llf/i;

    invoke-static {v0, p2}, LPg/f;->b(Llf/h;Lwf/p;)Ljava/lang/Object;
    ...
    :try_start_1
    invoke-virtual {p0, p1}, LE7/e;->b(Ljava/lang/String;)Ljava/util/Collection;
    ...
    invoke-direct {p2, p0, p1, v3, v1}, LE7/c;-><init>(LE7/e;Ljava/lang/String;ZLlf/e;)V
    ...
    invoke-direct {v0, p0, p1, v3}, LE7/b;-><init>(LE7/e;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-static {p2}, Lhf/k;->a(Ljava/lang/Object;)Ljava/lang/Throwable;

    move-result-object v0

    if-eqz v0, :cond_5

    instance-of v2, v0, LK7/d;
    ...
    :cond_2
    iget-object v2, p0, LE7/e;->d:LQ7/a;

    if-eqz v2, :cond_3

    const-string v4, "[CloudConfig]request failed"

    invoke-interface {v2, v4, v3, v0}, LQ7/a;->a(Ljava/lang/String;ILjava/lang/Throwable;)V

    :cond_3
    iget-object v0, p0, LE7/e;->c:Lhf/n;
    ...
    invoke-direct {v2, p0, p1, p3}, LE7/d;-><init>(LE7/e;Ljava/lang/String;Z)V

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v0}, LR7/b;->a()Z

    move-result p0

    if-eqz p0, :cond_4

    invoke-virtual {v2}, LE7/d;->invoke()Ljava/lang/Object;

    goto :goto_2

    :cond_4
    iget-object p0, v0, LR7/b;->b:Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-virtual {p0, v2}, Ljava/util/concurrent/CopyOnWriteArraySet;->add(Ljava/lang/Object;)Z

    :cond_5
    :goto_2
    instance-of p0, p2, Lhf/k$a;
    ...
    invoke-direct {v0, v1, v2, p3}, LE7/g;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p1, p0}, LE7/h;-><init>(Ljava/lang/String;Ljava/util/List;)V

    new-instance p0, LB7/i;

    invoke-direct {p0, p2}, LB7/i;-><init>(Ljava/lang/Object;)V
...
.method public final b(Ljava/lang/String;)Ljava/util/Collection;
    ...
    :try_start_0
    iget-object v1, v0, LF7/b;->d:Lhf/n;
    ...
    sget-object v2, LI7/a;->c:LH7/a;

    if-nez v2, :cond_0

    iget-object v1, v1, LI7/a;->b:Lhf/n;
    ...
    :cond_0
    :goto_0
    sget-object v1, LI7/a;->c:LH7/a;

    if-nez v1, :cond_1

    sput-object v2, LI7/a;->c:LH7/a;
    ...
    sget-object p1, LI7/a;->c:LH7/a;

    invoke-static {p1}, Lkotlin/jvm/internal/k;->c(Ljava/lang/Object;)V

    invoke-interface {p1}, LH7/a;->b()Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p1}, LH7/a;->a(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, LE7/e;->c(Ljava/util/List;)Ljava/util/Collection;
    ...
    :goto_3
    iget-object p1, v0, LF7/b;->b:LQ7/a;
    ...
    invoke-interface {p1, v1, v0, p0}, LQ7/a;->a(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method public final c(Ljava/util/List;)Ljava/util/Collection;
    ...
    iget-object v4, p0, LE7/e;->d:LQ7/a;
    ...
    :try_start_0
    iget-object v5, v2, LG7/a;->d:Ljava/lang/String;

    invoke-static {v5}, LT7/a;->a(Ljava/lang/String;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;

    move-result-object v5

    iget-object v6, v2, LG7/a;->c:Ljava/lang/String;
    ...
    invoke-direct {v2, v5}, LB7/i;-><init>(Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v4, v5, v3, v2}, LQ7/a;->a(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    new-instance v4, LB7/i$a;

    invoke-direct {v4, v3}, LB7/i$a;-><init>(Ljava/lang/Throwable;)V

    invoke-direct {v2, v4}, LB7/i;-><init>(Ljava/lang/Object;)V
    ...
    :cond_1
    iget-object p1, p0, LE7/e;->b:Ljava/lang/String;
    ...
    :try_start_1
    iget-object v7, p0, LE7/e;->a:Landroid/content/Context;
    ...
    iget-object v5, v6, LB7/i;->a:Ljava/lang/Object;
    ...
    invoke-static {v7, p1, v5}, LC7/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-interface {v4, v6, v3, v5}, LQ7/a;->a(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, LB7/i;->a()Z

    move-result v1

    if-eqz v1, :cond_6

    iget-object v0, v0, LB7/i;->a:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v0, v3}, LE7/f;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
