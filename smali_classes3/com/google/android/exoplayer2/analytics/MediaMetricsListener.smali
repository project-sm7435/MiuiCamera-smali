...
.method public static create(Landroid/content/Context;)Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;
    ...
    invoke-static {v0}, Landroidx/appsearch/platformstorage/i;->g(Ljava/lang/Object;)Landroid/media/metrics/MediaMetricsManager;
    ...
    invoke-static {v0}, Landroidx/appfunctions/n;->g(Landroid/media/metrics/MediaMetricsManager;)Landroid/media/metrics/PlaybackSession;
...
.method private finishCurrentSession()V
    ...
    invoke-static {v0, v2}, Landroidx/appsearch/platformstorage/l;->i(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->droppedFrames:I

    invoke-static {v0, v2}, Landroidx/appfunctions/a;->k(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->playedFrames:I

    invoke-static {v0, v2}, Landroidx/appfunctions/b;->l(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    :goto_0
    invoke-static {v2, v5, v6}, Landroidx/appfunctions/c;->j(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_1
    invoke-static {v2, v5, v6}, Landroidx/appsearch/platformstorage/q;->h(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_2
    invoke-static {v2, v0}, Landroidx/appfunctions/q;->i(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v2}, Landroidx/appsearch/platformstorage/converter/d;->h(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics;

    move-result-object v2

    invoke-static {v0, v2}, Landroidx/appsearch/platformstorage/s;->i(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackMetrics;)V
...
.method private maybeReportNetworkChange(J)V
    ...
    invoke-static {}, Landroidx/appsearch/platformstorage/converter/d;->g()Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object v2

    invoke-static {v2, v0}, Landroidx/appfunctions/b;->d(Landroid/media/metrics/NetworkEvent$Builder;I)Landroid/media/metrics/NetworkEvent$Builder;
    ...
    invoke-static {v0, p1, p2}, Landroidx/appfunctions/c;->d(Landroid/media/metrics/NetworkEvent$Builder;J)Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/appfunctions/d;->e(Landroid/media/metrics/NetworkEvent$Builder;)Landroid/media/metrics/NetworkEvent;

    move-result-object p0

    invoke-static {v1, p0}, Landroidx/appfunctions/f;->k(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/NetworkEvent;)V
...
.method private maybeReportPlaybackError(J)V
    ...
    invoke-static {}, Landroidx/appsearch/platformstorage/q;->e()Landroid/media/metrics/PlaybackErrorEvent$Builder;
    ...
    invoke-static {v3, p1, p2}, Landroidx/appsearch/platformstorage/t;->d(Landroid/media/metrics/PlaybackErrorEvent$Builder;J)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener$ErrorInfo;->errorCode:I

    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/l;->c(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener$ErrorInfo;->subErrorCode:I

    invoke-static {p1, p2}, Landroidx/appfunctions/a;->e(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1, v0}, Landroidx/appfunctions/b;->e(Landroid/media/metrics/PlaybackErrorEvent$Builder;Ljava/lang/Exception;)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1}, Landroidx/appfunctions/c;->e(Landroid/media/metrics/PlaybackErrorEvent$Builder;)Landroid/media/metrics/PlaybackErrorEvent;

    move-result-object p1

    invoke-static {v2, p1}, Landroidx/appfunctions/d;->j(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackErrorEvent;)V
...
.method private maybeReportPlaybackStateChange(Lcom/google/android/exoplayer2/Player;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$Events;J)V
    ...
    invoke-static {}, Landroidx/appfunctions/o;->f()Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p2

    iget v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->currentPlaybackState:I

    invoke-static {p2, v0}, Landroidx/appfunctions/p;->h(Landroid/media/metrics/PlaybackStateEvent$Builder;I)Landroid/media/metrics/PlaybackStateEvent$Builder;
    ...
    invoke-static {p2, p3, p4}, Landroidx/appfunctions/e;->f(Landroid/media/metrics/PlaybackStateEvent$Builder;J)Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/appfunctions/p;->i(Landroid/media/metrics/PlaybackStateEvent$Builder;)Landroid/media/metrics/PlaybackStateEvent;

    move-result-object p0

    invoke-static {p1, p0}, Landroidx/appfunctions/e;->j(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackStateEvent;)V
...
.method private maybeUpdateMetricsBuilderValues(Lcom/google/android/exoplayer2/Player;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$Events;)V
    ...
    invoke-static {v0}, Landroidx/appfunctions/p;->g(Ljava/lang/Object;)Landroid/media/metrics/PlaybackMetrics$Builder;
    ...
    invoke-static {v0, p1}, Landroidx/appsearch/platformstorage/t;->h(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private maybeUpdateTimelineMetadata(Lcom/google/android/exoplayer2/Timeline;Lcom/google/android/exoplayer2/source/MediaSource$MediaPeriodId;)V
    ...
    invoke-static {v0, p1}, Landroidx/appsearch/platformstorage/u;->f(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/appfunctions/j;->j(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_1
    invoke-static {v0, p1}, Landroidx/appfunctions/k;->h(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private reportTrackChangeEvent(IJLcom/google/android/exoplayer2/Format;I)V
    ...
    invoke-static {p1}, Landroidx/appfunctions/q;->e(I)Landroid/media/metrics/TrackChangeEvent$Builder;
    ...
    invoke-static {p1, p2, p3}, Landroidx/appfunctions/f;->g(Landroid/media/metrics/TrackChangeEvent$Builder;J)Landroid/media/metrics/TrackChangeEvent$Builder;

    move-result-object p1

    if-eqz p4, :cond_9

    invoke-static {p1}, Landroidx/appfunctions/n;->m(Landroid/media/metrics/TrackChangeEvent$Builder;)V

    invoke-static {p5}, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->getTrackChangeReason(I)I

    move-result p2

    invoke-static {p1, p2}, Landroidx/appfunctions/o;->l(Landroid/media/metrics/TrackChangeEvent$Builder;I)V

    iget-object p2, p4, Lcom/google/android/exoplayer2/Format;->containerMimeType:Ljava/lang/String;

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/q;->i(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/appfunctions/q;->j(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/converter/d;->k(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/s;->j(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/t;->i(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/l;->j(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/appfunctions/g;->j(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p3}, Landroidx/appfunctions/h;->l(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/appsearch/platformstorage/u;->g(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/appfunctions/j;->k(Landroid/media/metrics/TrackChangeEvent$Builder;F)V

    goto :goto_0

    :cond_9
    invoke-static {p1}, Landroidx/appfunctions/k;->i(Landroid/media/metrics/TrackChangeEvent$Builder;)V
    ...
    invoke-static {p1}, Landroidx/appfunctions/l;->e(Landroid/media/metrics/TrackChangeEvent$Builder;)Landroid/media/metrics/TrackChangeEvent;

    move-result-object p1

    invoke-static {p0, p1}, Landroidx/appsearch/platformstorage/i;->l(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/TrackChangeEvent;)V
...
.method public getLogSessionId()Landroid/media/metrics/LogSessionId;
    ...
    invoke-static {p0}, Landroidx/appfunctions/l;->d(Landroid/media/metrics/PlaybackSession;)Landroid/media/metrics/LogSessionId;
...
.method public onSessionActive(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Ljava/lang/String;)V
    ...
    invoke-static {}, Landroidx/appsearch/platformstorage/s;->c()Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/appfunctions/g;->b(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/appfunctions/h;->e(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;
