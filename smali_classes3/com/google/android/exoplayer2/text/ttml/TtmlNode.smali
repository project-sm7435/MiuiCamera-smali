...
.method public getCues(JLjava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setBitmap(Landroid/graphics/Bitmap;)Lcom/google/android/exoplayer2/text/Cue$Builder;

    move-result-object p3

    iget v0, p2, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->position:F
    ...
    invoke-virtual {p3, p4}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setPositionAnchor(I)Lcom/google/android/exoplayer2/text/Cue$Builder;

    move-result-object p3

    iget v0, p2, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->line:F

    invoke-virtual {p3, v0, p4}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setLine(FI)Lcom/google/android/exoplayer2/text/Cue$Builder;

    move-result-object p3

    iget p4, p2, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->lineAnchor:I

    invoke-virtual {p3, p4}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setLineAnchor(I)Lcom/google/android/exoplayer2/text/Cue$Builder;

    move-result-object p3

    iget p4, p2, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->width:F

    invoke-virtual {p3, p4}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setSize(F)Lcom/google/android/exoplayer2/text/Cue$Builder;

    move-result-object p3

    iget p4, p2, Lcom/google/android/exoplayer2/text/ttml/TtmlRegion;->height:F

    invoke-virtual {p3, p4}, Lcom/google/android/exoplayer2/text/Cue$Builder;->setBitmapHeight(F)Lcom/google/android/exoplayer2/text/Cue$Builder;
