...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lf0/B;->j:[Ljava/lang/String;
    ...
    sput-object v0, Lf0/B;->k:[Ljava/lang/String;
...
.method public final c(ILjava/lang/String;)V
    ...
    iput-object p1, p0, Lf0/B;->h:Ljava/lang/String;
...
.method public final d(Ljava/lang/Object;)V
    ...
    check-cast v3, Lf0/r0$a;

    iget v4, v3, Lcom/android/camera/data/data/x;->a:I

    iput v4, v0, Lcom/android/camera/data/data/c;->mCurrentMode:I

    iget-object v4, v3, Lcom/android/camera/data/data/x;->c:LZ5/c;

    iput-object v4, v0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/c;

    invoke-virtual {v4}, LZ5/c;->G()Ljava/util/HashMap;

    move-result-object v4

    iget-object v5, v0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/c;
    ...
    :cond_0
    invoke-virtual {v5}, LZ5/c;->G()Ljava/util/HashMap;
    ...
    invoke-virtual {v6, v10}, LU9/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lf0/X;

    iget-object v6, v6, Lf0/X;->a:Lx9/a;
    ...
    :cond_1
    iget v6, v6, Lx9/a;->g:F

    :goto_1
    iput v6, v0, Lf0/B;->d:F

    goto :goto_2

    :cond_2
    invoke-static {v5}, LZ5/d;->w2(LZ5/c;)Z

    move-result v7

    if-eqz v7, :cond_3

    invoke-static {v5}, LZ5/d;->l(LZ5/c;)F
    ...
    :cond_4
    iget v5, v5, Lx9/a;->g:F

    :goto_3
    iput v5, v0, Lf0/B;->d:F
    ...
    :cond_7
    iget-object v11, v5, LZ5/c;->e6:Ljava/util/HashMap;
    ...
    invoke-virtual {v5, v14}, LZ5/c;->B0(Ljava/lang/String;)Z
    ...
    iget-object v15, v5, LZ5/c;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    new-instance v2, Lb0/a1;

    aget v9, v11, v7

    invoke-direct {v2, v9, v8}, Lb0/a1;-><init>(FLjava/util/ArrayList;)V
    ...
    :goto_d
    iput-object v11, v5, LZ5/c;->e6:Ljava/util/HashMap;
    ...
    :goto_e
    iget-object v1, v5, LZ5/c;->e6:Ljava/util/HashMap;
    ...
    iget-object v2, v0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/c;
    ...
    invoke-virtual {v0, v1, v3}, Lf0/B;->m(II)V
    ...
    invoke-virtual {v1}, Lᙊᙆᙄᘇᙄᙀᘇᙍᙌᙟᙀᙊᙌᘇᙊᙆᙄᙄᙆᙇᘇᙪᙆᙄᙄᙆᙇ;->X()Ljava/lang/String;
    ...
    invoke-static {v1}, Lb0/a1;->a(F)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Lf0/B;->c:Ljava/lang/String;

    iput-object v5, v0, Lf0/B;->b:[Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/c;
    ...
    iget-object v2, v2, Lb0/a1;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lᙊᙆᙄᘇᙄᙀᘇᙍᙌᙟᙀᙊᙌᘇᙊᙆᙄᙄᙆᙇᘇᙪᙆᙄᙄᙆᙇ;->B()Ljava/lang/String;
    ...
    invoke-static {v2}, Lb0/a1;->a(F)Ljava/lang/String;

    move-result-object v2

    :goto_10
    iput-object v2, v0, Lf0/B;->c:Ljava/lang/String;
    ...
    iget-object v1, v1, Lb0/a1;->b:[Ljava/lang/String;
    ...
    :goto_11
    iput-object v1, v0, Lf0/B;->b:[Ljava/lang/String;
    ...
    invoke-virtual {v3, v7}, Lb0/p0;->getKey(I)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v3, v7}, Lb0/p0;->m(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_18

    iput v2, v0, Lf0/B;->d:F
    ...
    invoke-virtual {v2, v10}, LU9/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lf0/X;

    iget v3, v0, Lf0/B;->d:F
    ...
    invoke-virtual {v2, v3, v7}, Lf0/X;->q(FZ)F
    ...
    iget-object v1, v1, Lb0/a1;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lᙊᙆᙄᘇᙄᙀᘇᙍᙌᙟᙀᙊᙌᘇᙊᙆᙄᙄᙆᙇᘇᙪᙆᙄᙄᙆᙇ;->B()Ljava/lang/String;
    ...
    :cond_28
    invoke-virtual {v1}, LZ5/c;->o()Lx9/a;

    move-result-object v6

    :goto_18
    iget-object v1, v6, Lx9/a;->h:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lx9/b;->h:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v3}, Lb0/A0;-><init>(I)V
...
.method public final i()I
    ...
    invoke-virtual {p0, v0}, Lf0/B;->getComponentValue(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/data/data/c;->mParentDataItem:LU9/a;
...
.method public final l(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v1}, LU9/a;->o(ILjava/lang/String;)LU9/a;
...
.method public final m(II)V
    ...
    iget-object v1, p0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/c;
    ...
    iget-object v0, v0, Lx9/a;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, p1}, Lb0/p0;->getKey(I)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v5, p1}, Lb0/p0;->m(Ljava/lang/String;)Z

    move-result p1

    if-nez p1, :cond_2

    iget v4, p0, Lf0/B;->d:F
    ...
    iget v7, v6, Lx9/b;->a:F

    iget v6, v6, Lx9/b;->b:F
    ...
    invoke-virtual {v6, v3}, LU9/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lf0/X;

    invoke-virtual {v6, v4}, Lf0/X;->p(F)F
    ...
    iget-object v0, p1, Lx9/b;->i:Ljava/util/HashMap;

    iput-object v0, p0, Lf0/B;->a:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lf0/B;->a:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lf0/B;->c:Ljava/lang/String;
    ...
    :goto_4
    iget-object p1, p1, Lx9/b;->h:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lf0/B;->b:[Ljava/lang/String;
    ...
    invoke-static {p1, v2}, LYb/f;->c(Ljava/lang/String;Z)Z
    ...
    invoke-static {p2, v0, v1, v3}, LA/N;->e(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
