...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LI9/d;->a:Lhf/n;
    ...
    iput-object v0, p0, LI9/d;->b:Lhf/n;
    ...
    iput-object v0, p0, LI9/d;->c:Lhf/n;
    ...
    iput-object v0, p0, LI9/d;->f:Lhf/n;
...
.method public final a(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, LI9/d;->f:Lhf/n;
    ...
    :cond_2
    const-string/jumbo p0, "null cannot be cast to non-null type com.xiaomi.camera.cloudconfig.mivi.data.entity.MiviAppWhiteList"
    ...
    invoke-static {p1}, Lif/E;->M(Ljava/util/Map;)Ljava/util/LinkedHashMap;
...
.method public final b()Ljava/util/Map;
    ...
    iget-object v0, p0, LI9/d;->c:Lhf/n;
    ...
    iget-object v0, v0, LJ9/c;->a:Landroid/app/Application;
    ...
    const-string/jumbo v4, "\ubcf2\ubcf3\ubcf4\ubce3\ubcf1\ubcc9\ubcfb\ubcff\ubce0\ubcff\ubcc9\ubcff\ubcf8\ubcf0\ubcf9\ubcb8\ubcfc\ubce5\ubcf9\ubcf8"
    ...
    :goto_1
    const-string/jumbo v3, "pref_last_request_time_mivi"

    invoke-static {v3}, LG9/b;->b(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget-object v4, p0, LI9/d;->b:Lhf/n;
    ...
    invoke-static {v0}, LB7/b;->b(Ljava/lang/String;)V

    :cond_2
    iget-object v0, p0, LI9/d;->e:Ljava/util/LinkedHashMap;
    ...
    iget-object p0, p0, LI9/d;->e:Ljava/util/LinkedHashMap;

    goto/16 :goto_5

    :cond_3
    iget-object v0, p0, LI9/d;->d:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, p0, LI9/d;->c:Lhf/n;
    ...
    invoke-virtual {v2}, LJ9/c;->a()Ljava/util/Map;
    ...
    :cond_4
    const-string/jumbo v2, "pref_last_request_time_mivi"
    ...
    invoke-virtual {v3, v4, v5, v2}, LU9/a;->p(JLjava/lang/String;)LU9/a;

    invoke-virtual {v3}, LU9/a;->b()V

    iget-object v2, p0, LI9/d;->b:Lhf/n;
    ...
    invoke-static {}, LJ9/b;->a()Ljava/util/Map;

    move-result-object v2

    :goto_2
    iget-object v3, p0, LI9/d;->a:Lhf/n;
    ...
    invoke-virtual {v3}, LJ9/f;->a()Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4Entity;
    ...
    invoke-static {v1, v4, v5}, LG9/b;->c(Ljava/util/LinkedHashMap;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_6
    invoke-static {v2}, Lif/E;->M(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_9
    :goto_4
    iput-object v1, p0, LI9/d;->e:Ljava/util/LinkedHashMap;
    :try_end_0
