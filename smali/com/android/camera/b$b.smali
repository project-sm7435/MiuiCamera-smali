...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, Li6/d;->equals(Ljava/lang/Object;)Z
...
.method public final a(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lcom/android/camera/b$b;->b:LQ9/r;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, LQ9/r;->k()Z
    ...
    iget-object v3, p0, Lcom/android/camera/b$b;->b:LQ9/r;
    ...
    iget-object p1, p0, Lcom/android/camera/b$b;->b:LQ9/r;

    iget-object v0, p1, LQ9/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, LQ9/r;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, LQ9/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, Li6/c;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v4, v3, LQ9/r;->j:Ljava/lang/Object;
    ...
    :try_start_10
    iget-object v5, v3, LQ9/r;->e:Landroid/util/SparseArray;
    ...
    iget-object v0, v3, LQ9/r;->j:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/camera/b$b;->b:LQ9/r;
    ...
    :try_start_16
    iget-object v3, v3, LQ9/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_17
    invoke-static {v3}, Li6/c;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->f()LQ9/r;

    move-result-object v1

    iget-object v3, v1, LQ9/r;->j:Ljava/lang/Object;
    ...
    :try_start_21
    iget-object p2, v1, LQ9/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/android/camera/b$b;->b:LQ9/r;
    ...
    iput-object v1, p0, Lcom/android/camera/b$b;->b:LQ9/r;

    invoke-virtual {v1, p1}, LQ9/r;->n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->c()LQ9/r;
    ...
    iget-object v5, p0, LQ9/r;->j:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-object v6, p0, LQ9/r;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, LQ9/l;->n()Z

    move-result v7

    if-nez v7, :cond_3

    invoke-virtual {v6}, LQ9/l;->x()Z

    move-result v7

    if-eqz v7, :cond_3

    iget-object p1, p0, LQ9/r;->b:LQ9/l;

    if-eq p1, v6, :cond_2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, LQ9/l;->w()V
    ...
    :cond_1
    :goto_0
    iput-object v6, p0, LQ9/r;->b:LQ9/l;
    ...
    :cond_3
    iget-object v4, p0, LQ9/r;->b:LQ9/l;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, LQ9/l;->w()V
    ...
    iget-object v6, p0, LQ9/r;->E:LQ9/r$e;

    invoke-direct {v4, v6, p1}, LQ9/g;-><init>(LQ9/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v4, v6, p1}, LQ9/b;-><init>(LQ9/r$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v6, p0, LQ9/r;->a:I

    if-lez v6, :cond_7

    iput v6, v4, LQ9/l;->a:I

    :cond_7
    iput v6, v4, LQ9/l;->e:I

    invoke-virtual {v4}, LQ9/b;->J()V

    invoke-virtual {v4, p1}, LQ9/l;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v6

    iget-object v7, p0, LQ9/r;->A:LQ9/r$a;
    ...
    invoke-virtual {p0, v3}, LQ9/c;->i(I)V
...
.method public final f()LQ9/r;
    ...
    invoke-direct {v0, v1}, LQ9/r;-><init>(Lcom/android/camera/b$a;)V
...
.method public final k()Z
    ...
    iget-object v2, p0, LQ9/r;->b:LQ9/l;

    iget-object v3, p0, LQ9/r;->m:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, LQ9/r;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, LQ9/o;->P:Ljava/lang/Object;

    if-ne v7, v2, :cond_1

    iget-boolean v7, v6, LQ9/o;->z:Z

    if-nez v7, :cond_2

    iget v6, v6, LQ9/o;->Q:I
    ...
    iget-object p0, p0, LQ9/r;->b:LQ9/l;

    if-eqz p0, :cond_4

    invoke-virtual {p0, v5}, LQ9/l;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    iget-object p0, p0, LQ9/r;->o:LQ9/r$g;
    ...
    invoke-virtual {p0, p1, p2}, LQ9/n;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    iget-object p0, p0, LQ9/r$g;->a:LQ9/r;

    iget-object p0, p0, LQ9/r;->B:LQ9/r$b;

    const/4 v2, 0x1

    invoke-direct {v1, p2, p3, p0, v2}, LQ9/t;-><init>(JLQ9/r$b;Z)V
    ...
    iget-object p0, p1, LQ9/n;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, LQ9/n;->b:LQ9/n$a;
    ...
    iget-object p2, p1, LQ9/n;->b:LQ9/n$a;
    ...
    invoke-virtual {p1, v1}, LQ9/n;->h(LQ9/t;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(LQ9/o;)V
    .locals 17

    move-object/from16 v0, p1

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/b$b;->c()LQ9/r;
    ...
    iget-object v1, v1, LQ9/r;->o:LQ9/r$g;

    iget-object v3, v1, LQ9/r$g;->a:LQ9/r;
    ...
    invoke-virtual {v4, v5, v6}, LQ9/c;->f(II)I

    move-result v4

    iput v4, v3, LQ9/r;->z:I

    iget-wide v11, v0, LQ9/o;->e:J

    iget-object v3, v0, LQ9/o;->L:Lw9/d;
    ...
    iget-boolean v4, v0, LQ9/o;->G:Z

    const/4 v15, 0x1

    if-nez v4, :cond_2

    iget-object v4, v1, LQ9/r$g;->a:LQ9/r;

    invoke-static {v4, v11, v12, v0}, LQ9/r;->f(LQ9/r;JLQ9/o;)V

    iget-object v4, v0, LQ9/o;->x0:Lcom/android/camera/module/Camera2Module$d;
    ...
    :cond_0
    iget v4, v0, LQ9/o;->A:I

    const/4 v7, 0x4

    if-eq v4, v7, :cond_1

    iput-boolean v15, v0, LQ9/o;->z:Z

    :cond_1
    iget-object v4, v1, LQ9/r$g;->a:LQ9/r;

    iget-object v4, v4, LQ9/r;->b:LQ9/l;

    iput-object v4, v0, LQ9/o;->P:Ljava/lang/Object;
    ...
    :goto_0
    iget v10, v0, LQ9/o;->B:I

    iget-boolean v14, v0, LQ9/o;->G:Z

    new-instance v6, Lw9/b;

    iget v8, v0, LQ9/o;->A:I

    iget-object v13, v0, LQ9/o;->a0:Ljava/lang/String;
    ...
    invoke-direct/range {v7 .. v15}, Lw9/b;-><init>(IIIJLjava/lang/String;ZLQ9/l;)V

    iget v4, v0, LQ9/o;->k0:I

    iput v4, v6, Lw9/b;->x:I

    iget-object v4, v1, LQ9/r$g;->a:LQ9/r;

    iget-object v4, v4, LQ9/r;->B:LQ9/r$b;

    iput-object v4, v6, Lw9/b;->q:LQ9/r$b;

    iget-boolean v4, v0, LQ9/o;->J:Z

    iput-boolean v4, v6, Lw9/b;->l:Z

    iput-object v3, v6, Lw9/b;->o:Lw9/d;

    iget-object v3, v0, LQ9/o;->i0:Lw9/a;

    iput-object v3, v6, Lw9/b;->v:Lw9/a;

    iget-boolean v3, v0, LQ9/o;->O:Z

    iput-boolean v3, v6, Lw9/b;->m:Z
    ...
    invoke-static {v3, v15}, LA/Q;->f(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-boolean v15, v6, Lw9/b;->s:Z

    :cond_5
    sget-object v3, LQ9/n$e;->a:LQ9/n;

    iget-object v3, v3, LQ9/n;->b:LQ9/n$a;
    ...
    invoke-direct {v2, v4, v1, v6, v0}, LA/G;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
