...
# static fields
.field public static final f:LA/T3$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, LA/T3$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, LA/T3;->f:LA/T3$a;
...
.method public final a(Ljava/io/IOException;)V
    ...
    invoke-virtual {p0}, LA/T3;->b()Landroid/os/MemoryFile;
    ...
    :try_start_0
    iput-object p1, p0, LA/T3;->a:Landroid/os/MemoryFile;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    monitor-exit p0

    iput v0, p0, LA/T3;->b:I

    iput v0, p0, LA/T3;->c:I

    iput v0, p0, LA/T3;->d:I

    iput-object p1, p0, LA/T3;->e:Landroid/net/Uri;
...
.method public final declared-synchronized b()Landroid/os/MemoryFile;
    ...
    :try_start_0
    iget-object v0, p0, LA/T3;->a:Landroid/os/MemoryFile;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :try_start_2
    iput-object v0, p0, LA/T3;->a:Landroid/os/MemoryFile;
    :try_end_2
    ...
    iput p2, p0, LA/T3;->c:I

    iput v2, p0, LA/T3;->d:I
    ...
    :goto_1
    :try_start_a
    invoke-virtual {p0, p1}, LA/T3;->a(Ljava/io/IOException;)V
    :try_end_a
