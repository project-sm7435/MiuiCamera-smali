...
# instance fields
.field public a:LC/E3;

.field public b:LC/H3$b;
...
.field public g:LC/H3$a;

.field public h:LC/H3$d;
...
.method public final c()V
    ...
    iget-object v3, p0, LC/H3;->c:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v1, p0, LC/H3;->b:LC/H3$b;
    ...
    iget-object v0, p0, LC/H3;->b:LC/H3$b;

    invoke-virtual {v0}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->d()V

    :cond_1
    new-instance v0, LC/H3$b;

    iget-object v5, p0, LC/H3;->a:LC/E3;
    ...
    invoke-direct/range {v0 .. v5}, LC/H3$b;-><init>(ZZLjava/lang/ref/WeakReference;LC/H3;LC/E3;)V
    ...
    iput-object v0, v4, LC/H3;->b:LC/H3$b;
...
.method public final e(Landroid/net/Uri;J)V
    ...
    iget-object v0, p0, LC/H3;->k:Landroid/net/Uri;
    ...
    :cond_1
    iput-object v0, p0, LC/H3;->k:Landroid/net/Uri;
    ...
    iget-object p0, p0, LC/H3;->k:Landroid/net/Uri;
...
.method public final f()V
    ...
    iget-object v0, p0, LC/H3;->c:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object v2, p0, LC/H3;->a:LC/E3;

    if-eqz v2, :cond_1

    iget-boolean v2, v2, LC/E3;->c:Z

    if-nez v2, :cond_1

    new-instance v2, LC/H3$c;

    invoke-direct {v2, v0}, LC/H3$c;-><init>(Ljava/lang/ref/WeakReference;)V
...
.method public final g(LC/E3;ZZZ)V
    .locals 0

    iput-object p1, p0, LC/H3;->a:LC/E3;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p3, p4}, LC/H3;->h(ZZ)V
    ...
    iput-object p1, p0, LC/H3;->k:Landroid/net/Uri;
...
.method public final h(ZZ)V
    ...
    invoke-direct/range {v1 .. v6}, LC/G3;-><init>(LC/H3;Lcom/android/camera/ActivityBase;ZIZ)V
