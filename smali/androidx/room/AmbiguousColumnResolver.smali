...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onHashMatch",
        "rabinKarpSearch",
        "(Ljava/util/List;[Ljava/lang/String;Lwf/q;)V",
        "T",
        "",
        "current",
        "depth",
        ...
        "block",
        "dfs",
        "(Ljava/util/List;Ljava/util/List;ILwf/l;)V",
        "Match",
        "ResultColumn",
        "Solution",
        "room-common"
...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILwf/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lif/s;->g0(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILwf/l;)V

    invoke-static {p2}, Lif/r;->z(Ljava/util/List;)Ljava/lang/Object;
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILwf/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILwf/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lwf/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lwf/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v6}, Lif/r;->x(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, LKe/l;->e(Ljf/g;)Ljf/g;
    ...
    iget-object v10, v2, Ljf/g;->a:Ljf/c;

    invoke-virtual {v10, v8}, Ljf/c;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v10}, Ljf/b;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, LCg/J;->h(Ljf/b;)Ljf/b;
    ...
    invoke-direct {v9, v0, v7, v10}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lwf/q;)V
    ...
    invoke-virtual {v0, v3}, Ljf/b;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v15, Ljf/b$b;

    invoke-virtual {v15}, Ljf/b$b;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Ljf/b$b;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, Ljf/b;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, LCg/J;->h(Ljf/b;)Ljf/b;

    move-result-object v3

    invoke-virtual {v3}, Ljf/b;->isEmpty()Z
    ...
    invoke-static/range {v10 .. v16}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILwf/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v4 .. v10}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILwf/l;ILjava/lang/Object;)V
