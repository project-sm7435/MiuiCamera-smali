...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v3}, Ljf/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v4}, Ljf/b;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v1, Ljf/b$b;

    invoke-virtual {v1}, Ljf/b$b;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Ljf/b$b;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v4}, LNg/l;->Z(Ljava/lang/String;Ljava/lang/String;Z)Z
