...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v5}, LA3/j2;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    new-instance v10, Ljf/c;

    invoke-direct {v10}, Ljf/c;-><init>()V
    ...
    invoke-virtual {v10, v11, v5}, Ljf/c;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-virtual {v10}, Ljf/c;->d()Ljf/c;
    ...
    invoke-static {v2, v1}, LA3/j2;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Ljf/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lif/s;->a0(Ljava/util/AbstractList;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v6, v7}, Ljf/g;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_4
    invoke-static {v6}, LKe/l;->e(Ljf/g;)Ljf/g;
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v6}, LA3/j2;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v6

    :cond_3
    :try_start_1
    invoke-virtual {v5, v7}, Ljf/g;->add(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v5}, LKe/l;->e(Ljf/g;)Ljf/g;
