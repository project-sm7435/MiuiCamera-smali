...
.method public final build(Ljava/util/List;)Landroidx/room/AmbiguousColumnResolver$Solution;
    ...
    invoke-virtual {v3}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LCf/d;
    ...
    invoke-virtual {v5}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LCf/d;

    move-result-object v5

    iget v5, v5, LCf/b;->a:I
    ...
    invoke-virtual {v6}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LCf/d;
    ...
    invoke-direct {v0, v3, v5, v4}, LCf/b;-><init>(III)V
    ...
    invoke-virtual {v5}, Lif/A;->nextInt()I
    ...
    invoke-virtual {v8}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LCf/d;

    move-result-object v8

    iget v9, v8, LCf/b;->a:I

    if-gt v9, v5, :cond_8

    iget v8, v8, LCf/b;->b:I
