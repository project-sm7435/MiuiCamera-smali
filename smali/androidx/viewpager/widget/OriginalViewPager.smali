...
.method private completeScroll(Z)V
    ...
    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;

    iget-boolean v4, v1, Lnh/f;->l:Z

    if-nez v4, :cond_2

    iput-boolean v2, v1, Lnh/f;->l:Z
    ...
    iget-object v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;

    iget-wide v6, v5, Lnh/f;->c:D

    double-to-int v6, v6

    iget-wide v7, v5, Lnh/f;->d:D
...
.method private determineTargetPage(IFII)I
    ...
    invoke-static {p3, p0}, LA3/A2;->c(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method private performDrag(F)Z
    ...
    invoke-static {v6, v5}, LA3/A2;->c(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method private recomputeScrollPosition(IIII)V
    ...
    iput-wide p0, v1, Lnh/f;->f:D

    iput-boolean v0, v1, Lnh/f;->l:Z
...
.method public computeScroll()V
    ...
    iget-object v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;

    iget-wide v4, v3, Lnh/f;->c:D

    double-to-int v4, v4

    iget-wide v5, v3, Lnh/f;->d:D
...
.method public fakeDragBy(F)V
    ...
    invoke-static {v5, v4}, LA3/A2;->c(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public initViewPager()V
    ...
    iput-boolean v0, v2, Lnh/f;->l:Z

    iput-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;
...
.method public onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;

    if-eqz v0, :cond_0

    iget-boolean v1, v0, Lnh/f;->l:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, v0, Lnh/f;->l:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, v6, Landroidx/viewpager/widget/OriginalViewPager;->mScroller:Lnh/f;

    invoke-virtual {v0}, Lnh/f;->a()Z
    ...
    iget-wide v1, v0, Lnh/f;->f:D

    double-to-int v1, v1

    iget-wide v2, v0, Lnh/f;->c:D
...
.method public populate(I)V
    ...
    invoke-static {v3, v4, v5, v6, v7}, LA/o2;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
...
.method public smoothScrollTo(III)V
    ...
    :cond_1
    iget-wide v3, v0, Lnh/f;->g:D

    goto :goto_0

    :goto_1
    iput-boolean v2, v0, Lnh/f;->l:Z
    ...
    iput-boolean v1, v5, Lnh/f;->l:Z

    iput-boolean v1, v5, Lnh/f;->m:Z

    float-to-double v6, v3

    iput-wide v6, v5, Lnh/f;->g:D

    float-to-double v6, p1

    iput-wide v6, v5, Lnh/f;->f:D

    float-to-double v6, v0

    iput-wide v6, v5, Lnh/f;->i:D

    double-to-int v1, v6

    int-to-double v6, v1

    iput-wide v6, v5, Lnh/f;->d:D

    float-to-double v6, p2

    iput-wide v6, v5, Lnh/f;->h:D

    float-to-double v6, p3

    iput-wide v6, v5, Lnh/f;->j:D
    ...
    invoke-direct {p3}, Lnh/e;-><init>()V

    iput-object p3, v5, Lnh/f;->e:Lnh/e;
    ...
    :cond_5
    iput v2, v5, Lnh/f;->k:I

    invoke-static {}, Landroid/view/animation/AnimationUtils;->currentAnimationTimeMillis()J

    move-result-wide p1

    iput-wide p1, v5, Lnh/f;->a:J
