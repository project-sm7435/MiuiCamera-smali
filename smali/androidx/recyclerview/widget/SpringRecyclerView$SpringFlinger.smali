...
.method public notifyHorizontalEdgeReached(I)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lqi/d;
    ...
    iget-object v1, v0, Lqi/d;->b:Lqi/b;

    iget p0, v1, Lqi/d$a;->h:I

    if-nez p0, :cond_1

    iget-object p0, v1, Lqi/b;->r:Lqi/b$b;

    if-eqz p0, :cond_0

    invoke-virtual {v1}, Lqi/b;->h()V

    :cond_0
    iget-wide p0, v1, Lqi/d$a;->d:D
    ...
    invoke-virtual/range {v1 .. v6}, Lqi/b;->j(IIIII)V
...
.method public notifyVerticalEdgeReached(I)V
    ...
    iget-object v1, v0, Lqi/d;->c:Lqi/b;
...
.method public springBack(II)V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lqi/d;
