...
.method private static final toByteArrayInternalV1$writeArray(Ljava/io/DataOutputStream;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LDf/d;
...
.method private static final toByteArrayInternalV1$writeEntry(Ljava/io/DataOutputStream;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p2}, Lkotlin/jvm/internal/B;->b(Ljava/lang/Class;)LDf/d;

    move-result-object p2

    invoke-interface {p2}, LDf/d;->getSimpleName()Ljava/lang/String;
...
.method public final fromByteArray([B)Landroidx/work/Data;
    ...
    :cond_1
    :try_start_2
    invoke-static {p1, v3}, LA3/j2;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_2
