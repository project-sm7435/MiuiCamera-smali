...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(LPg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V",
        "",
        "TAG",
        "Ljava/lang/String;",
        "",
...
.method public static final maybeLaunchUnfinishedWorkListener(LPg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
    .locals 7
    ...
    invoke-interface {p2}, Landroidx/work/impl/model/WorkSpecDao;->hasUnfinishedWorkFlow()LSg/e;
    ...
    invoke-direct {p3, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$1;-><init>(Llf/e;)V

    new-instance v2, LSg/l;

    invoke-direct {v2, p2, p3}, LSg/l;-><init>(LSg/e;Lwf/r;)V

    sget-object v5, LRg/a;->b:LRg/a;

    instance-of p2, v2, LTg/m;
    ...
    invoke-static {v2, v0, v4, v5, p2}, LTg/m$a;->a(LTg/m;LPg/A;ILRg/a;I)LSg/e;
    ...
    invoke-direct/range {v1 .. v6}, LTg/i;-><init>(LSg/e;LPg/A;ILRg/a;I)V

    :goto_0
    invoke-static {p2}, LCg/z;->q(LSg/e;)LSg/e;

    move-result-object p2

    new-instance p3, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;

    invoke-direct {p3, p1, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;-><init>(Landroid/content/Context;Llf/e;)V

    new-instance p1, LSg/o;

    invoke-direct {p1, p2, p3}, LSg/o;-><init>(LSg/e;Lwf/p;)V

    new-instance p2, LSg/h;

    invoke-direct {p2, p1, v0}, LSg/h;-><init>(LSg/o;Llf/e;)V

    const/4 p1, 0x3

    invoke-static {p0, v0, v0, p2, p1}, LPg/f;->a(LPg/D;Llf/f;LPg/F;Lwf/p;I)LPg/F0;
