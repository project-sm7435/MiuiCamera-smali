...
.field private final mWorkManagerScope:LPg/D;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;Landroidx/work/impl/constraints/trackers/Trackers;)V
    ...
    invoke-static {p3}, Landroidx/work/impl/WorkManagerImplExtKt;->createWorkManagerScope(Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)LPg/D;

    move-result-object p6

    iput-object p6, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LPg/D;
    ...
    invoke-static {p6, p0, p2, p4}, Landroidx/work/impl/UnfinishedWorkListenerKt;->maybeLaunchUnfinishedWorkListener(LPg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
...
.method public static synthetic a(Landroidx/work/impl/WorkManagerImpl;)Lhf/A;
    .locals 0

    invoke-direct {p0}, Landroidx/work/impl/WorkManagerImpl;->lambda$rescheduleEligibleWork$0()Lhf/A;
...
.method private synthetic lambda$rescheduleEligibleWork$0()Lhf/A;
    .locals 2
...
.method public getLastCancelAllTimeMillis()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-static {p0, v0, v1}, Landroidx/work/ListenableFutureKt;->executeAsync(Ljava/util/concurrent/Executor;Ljava/lang/String;Lwf/a;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public getWorkInfoByIdFlow(Ljava/util/UUID;)LSg/e;
    .locals 0
    .param p1    # Ljava/util/UUID;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)LSg/e;
...
.method public getWorkInfosByTagFlow(Ljava/lang/String;)LSg/e;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;LPg/A;Ljava/lang/String;)LSg/e;
...
.method public getWorkInfosFlow(Landroidx/work/WorkQuery;)LSg/e;
    .locals 1
    .param p1    # Landroidx/work/WorkQuery;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/RawWorkInfoDaoKt;->getWorkInfoPojosFlow(Landroidx/work/impl/model/RawWorkInfoDao;LPg/A;Landroidx/sqlite/db/SupportSQLiteQuery;)LSg/e;
...
.method public getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)LSg/e;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;LPg/A;Ljava/lang/String;)LSg/e;
...
.method public getWorkManagerScope()LPg/D;
    .locals 0
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    iget-object p0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LPg/D;
...
.method public rescheduleEligibleWork()V
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/g;-><init>(Ljava/lang/Object;I)V

    const-string p0, "ReschedulingWork"

    invoke-static {v0, p0, v1}, Landroidx/work/TracerKt;->traced(Landroidx/work/Tracer;Ljava/lang/String;Lwf/a;)Ljava/lang/Object;
