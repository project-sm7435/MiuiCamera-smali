...
.field private final mWorkManagerScope:LSg/D;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;Landroidx/work/impl/constraints/trackers/Trackers;)V
    ...
    invoke-static {p3}, Landroidx/work/impl/WorkManagerImplExtKt;->createWorkManagerScope(Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)LSg/D;

    move-result-object p6

    iput-object p6, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LSg/D;
    ...
    invoke-static {p6, p0, p2, p4}, Landroidx/work/impl/UnfinishedWorkListenerKt;->maybeLaunchUnfinishedWorkListener(LSg/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
...
.method public getLastCancelAllTimeMillis()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, v0, v2}, Landroidx/work/impl/g;-><init>(Ljava/lang/Object;I)V
...
.method public getWorkInfoByIdFlow(Ljava/util/UUID;)LVg/f;
    .locals 0
    .param p1    # Ljava/util/UUID;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)LVg/f;
...
.method public getWorkInfosByTagFlow(Ljava/lang/String;)LVg/f;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;LSg/A;Ljava/lang/String;)LVg/f;
...
.method public getWorkInfosFlow(Landroidx/work/WorkQuery;)LVg/f;
    .locals 1
    .param p1    # Landroidx/work/WorkQuery;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/RawWorkInfoDaoKt;->getWorkInfoPojosFlow(Landroidx/work/impl/model/RawWorkInfoDao;LSg/A;Landroidx/sqlite/db/SupportSQLiteQuery;)LVg/f;
...
.method public getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)LVg/f;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;LSg/A;Ljava/lang/String;)LVg/f;
...
.method public getWorkManagerScope()LSg/D;
    .locals 0
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    iget-object p0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:LSg/D;
