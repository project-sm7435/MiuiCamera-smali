...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)LSg/e;",
        "LPg/A;",
        "dispatcher",
        "",
        "name",
        ...
        "(Landroidx/work/impl/model/WorkSpecDao;LPg/A;Ljava/lang/String;)LSg/e;",
        "tag",
...
# direct methods
.method public static final dedup(LSg/e;LPg/A;)LSg/e;
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroidx/work/impl/model/WorkSpecDaoKt$dedup$$inlined$map$1;-><init>(LSg/e;)V

    invoke-static {v0}, LCg/z;->q(LSg/e;)LSg/e;

    move-result-object p0

    invoke-static {p0, p1}, LCg/z;->v(LSg/e;LPg/A;)LSg/e;
...
.method public static final getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)LSg/e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p1}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoFlowDataForIds(Ljava/util/List;)LSg/e;

    move-result-object p0

    new-instance p1, Landroidx/work/impl/model/WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1;

    invoke-direct {p1, p0}, Landroidx/work/impl/model/WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1;-><init>(LSg/e;)V

    invoke-static {p1}, LCg/z;->q(LSg/e;)LSg/e;
...
.method public static final getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;LPg/A;Ljava/lang/String;)LSg/e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p2}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoFlowForName(Ljava/lang/String;)LSg/e;
...
.method public static final getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;LPg/A;Ljava/lang/String;)LSg/e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, p2}, Landroidx/work/impl/model/WorkSpecDao;->getWorkStatusPojoFlowForTag(Ljava/lang/String;)LSg/e;
