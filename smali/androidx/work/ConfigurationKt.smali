...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Llf/h;",
        "asExecutor",
        "(Llf/h;)Ljava/util/concurrent/Executor;",
        "",
...
# direct methods
.method public static final synthetic access$asExecutor(Llf/h;)Ljava/util/concurrent/Executor;
    .locals 0

    invoke-static {p0}, Landroidx/work/ConfigurationKt;->asExecutor(Llf/h;)Ljava/util/concurrent/Executor;
...
.method private static final asExecutor(Llf/h;)Ljava/util/concurrent/Executor;
    .locals 2
    ...
    instance-of v1, p0, LPg/f0;

    if-eqz v1, :cond_2

    move-object v0, p0

    check-cast v0, LPg/f0;

    :cond_2
    if-eqz v0, :cond_3

    invoke-virtual {v0}, LPg/f0;->g()Ljava/util/concurrent/Executor;
    ...
    invoke-direct {v0, p0}, LPg/T;-><init>(LPg/A;)V
