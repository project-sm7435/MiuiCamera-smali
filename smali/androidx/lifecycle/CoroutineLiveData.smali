...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroidx/lifecycle/LiveData;Llf/e;)Ljava/lang/Object;",
        "emitSource",
...
# direct methods
.method public constructor <init>(Llf/h;JLwf/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, LPg/r0;-><init>(LPg/o0;)V
    ...
    invoke-virtual {v0, p1}, Llf/a;->plus(Llf/h;)Llf/h;

    move-result-object p1

    invoke-interface {p1, v1}, Llf/h;->plus(Llf/h;)Llf/h;

    move-result-object p1

    invoke-static {p1}, LPg/E;->a(Llf/h;)LUg/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lwf/p;JLPg/D;Lwf/a;)V
...
.method public synthetic constructor <init>(Llf/h;JLwf/p;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(Llf/h;JLwf/p;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_release(Llf/e;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Llf/e;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(Llf/e;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_release(Landroidx/lifecycle/LiveData;Llf/e;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Llf/e;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_release(Llf/e;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;Llf/e;)Ljava/lang/Object;
