...
# instance fields
.field private final _currentStateFlow:LSg/p;
...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    sget-object p2, LTg/p;->a:LGf/d;

    :cond_0
    invoke-direct {p1, p2}, LSg/t;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LSg/p;
...
.method private final sync()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LSg/p;

    invoke-virtual {p0}, Landroidx/lifecycle/LifecycleRegistry;->getCurrentState()Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-interface {v0, p0}, LSg/p;->setValue(Ljava/lang/Object;)V
...
.method public getCurrentStateFlow()LSg/s;
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LSg/p;

    new-instance v0, LSg/q;

    invoke-direct {v0, p0}, LSg/q;-><init>(LSg/p;)V
