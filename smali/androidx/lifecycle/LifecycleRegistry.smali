...
# instance fields
.field private final _currentStateFlow:LVg/r;
...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    sget-object p2, LWg/r;->a:LHc/f;

    :cond_0
    invoke-direct {p1, p2}, LVg/v;-><init>(Ljava/lang/Object;)V

    .line 9
    iput-object p1, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LVg/r;
...
.method private final sync()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LVg/r;

    invoke-virtual {p0}, Landroidx/lifecycle/LifecycleRegistry;->getCurrentState()Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-interface {v0, p0}, LVg/r;->setValue(Ljava/lang/Object;)V
...
.method public getCurrentStateFlow()LVg/u;
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:LVg/r;

    new-instance v0, LVg/s;

    invoke-direct {v0, p0}, LVg/s;-><init>(LVg/r;)V
