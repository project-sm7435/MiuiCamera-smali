...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LK3/c;->a:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, LK3/c;->b:Landroid/util/SparseArray;
...
.method public final a(I)V
    ...
    iget-object v0, p0, LK3/c;->b:Landroid/util/SparseArray;

    invoke-virtual {v0, p1}, Landroid/util/SparseArray;->remove(I)V

    iget-object v0, p0, LK3/c;->a:Landroid/util/SparseArray;
    ...
    iget-object v2, v1, Lye/d;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :try_start_1
    invoke-virtual {v1, v0, v2, v3}, Lye/d;->b(Lte/a;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    invoke-virtual {v1, v2, v3}, Lye/d;->d(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v1, Lye/d;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v1}, Lye/d;->h()V

    iget-object p0, p0, LK3/c;->a:Landroid/util/SparseArray;
...
.method public final cancelDownloadSync(I)Z
    ...
    invoke-virtual {p0, p1}, LK3/c;->a(I)V
...
.method public final startDownload(ILjava/util/List;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    ...
    iget-object v1, p0, LK3/c;->b:Landroid/util/SparseArray;
    ...
    invoke-direct {v1, v2, v3, p2}, Lte/a$a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const/16 p2, 0x96

    iput p2, v1, Lte/a$a;->h:I

    iput-boolean v0, v1, Lte/a$a;->j:Z
    ...
    invoke-direct {v0, p0, p3, p1}, LK3/c$a;-><init>(LK3/c;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;I)V

    invoke-virtual {p2, v0}, Lte/a;->i(LEe/a;)V
