...
.method private initView()V
    ...
    invoke-virtual {v5, v6}, LU9/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v5

    new-instance v6, Lcom/android/camera/data/data/j;

    invoke-direct {v6, v3, v1}, Lcom/android/camera/data/data/j;-><init>(II)V
    ...
    invoke-virtual {v4}, Lᙊᙆᙄᘇᙄᙀᘇᙍᙌᙟᙀᙊᙌᘇᙊᙆᙄᙄᙆᙇᘇᙪᙆᙄᙄᙆᙇ;->Q1()Z
    ...
    invoke-interface {v5}, Lc4/k;->f0()I
...
.method private lambda$initListener$4(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-direct {p2, v0, p0}, LPb/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private lambda$initListener$5(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-virtual {p1, v0, p2}, LU9/a;->m(Ljava/lang/String;Z)LU9/a;
...
.method private static trackSelectMiShotRole(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, p0}, LPb/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
