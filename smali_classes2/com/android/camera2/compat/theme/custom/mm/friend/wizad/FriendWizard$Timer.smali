...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;->TIMER_TYPE_CANCEL_DISCOVERY:Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;
    ...
    const-string v2, "TIMER_TYPE_CANCEL_CONNECTION"
    ...
    sput-object v1, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;->TIMER_TYPE_CANCEL_CONNECTION:Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;
    ...
    const-string v3, "TIMER_TYPE_RESET_STATE"

    const/4 v4, 0x2

    invoke-direct/range {v2 .. v7}, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;-><init>(Ljava/lang/String;IIJ)V

    sput-object v2, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;->TIMER_TYPE_RESET_STATE:Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;
    ...
    const-string v4, "TIMER_TYPE_RESET_CONNECTION"

    const/4 v5, 0x3

    invoke-direct/range {v3 .. v8}, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;-><init>(Ljava/lang/String;IIJ)V

    sput-object v3, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;->TIMER_TYPE_RESET_CONNECTION:Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;

    new-instance v4, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;

    const v7, 0xff05

    const-wide/16 v8, 0x1388

    const-string v5, "TIMER_TYPE_CONNECT_ACK"

    const/4 v6, 0x4

    invoke-direct/range {v4 .. v9}, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;-><init>(Ljava/lang/String;IIJ)V

    sput-object v4, Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;->TIMER_TYPE_CONNECT_ACK:Lcom/android/camera2/compat/theme/custom/mm/friend/wizad/FriendWizard$Timer;
