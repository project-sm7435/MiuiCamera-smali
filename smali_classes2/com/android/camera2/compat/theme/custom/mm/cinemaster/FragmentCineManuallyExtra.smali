...
.method private initPortraitCineExtraListLayout(Landroid/view/View;)V
    ...
    invoke-direct {v2, p0, v3}, LC/l;-><init>(Ljava/lang/Object;I)V
...
.method private initRecyclerView(Lcom/android/camera/data/data/c;)V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/adapter/CineExtraRecyclerViewAdapter;-><init>(Lcom/android/camera/fragment/BaseFragment;Lcom/android/camera/data/data/c;ILk2/o;II)V
...
.method private initScaleView(Lcom/android/camera/data/data/c;)V
    ...
    :sswitch_1
    new-instance v5, Lcom/android/camera/fragment/manually/adapter/g;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/android/camera/fragment/manually/adapter/g;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;I)V
    ...
    iget p1, v9, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-direct {v1, p0, v7, p1, v9}, Lcom/android/camera/fragment/manually/adapter/a;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;)V
    ...
    new-instance v6, Lcom/android/camera/fragment/manually/adapter/g;
    ...
    iget v9, v10, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    const/4 v11, 0x1

    invoke-direct/range {v6 .. v11}, Lcom/android/camera/fragment/manually/adapter/g;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;I)V
    ...
    iget-object v3, v9, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;->apertureStopPointValueListener:Lcom/android/camera2/compat/theme/custom/mm/ApertureStopPointValueListener;

    invoke-static {}, Lu0/b;->U()Z

    move-result v4

    invoke-direct {v1, p0, p1, v3, v4}, Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalCineMasterSliderApertureDrawAdapter;-><init>(Landroid/content/Context;ILcom/android/camera2/compat/theme/custom/mm/ApertureStopPointValueListener;Z)V

    :goto_0
    iget-object p0, v9, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;->mScaleView:Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalScaleZoomView;
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalScaleZoomView;->setDrawAdapter(Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;)V
    ...
    invoke-virtual {p0, p1, v2, v3}, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView;->setVerType(Landroid/content/Context;ZZ)Z

    iget-object p0, v9, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;->mScaleView:Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalScaleZoomView;

    invoke-virtual {v9}, Lcom/android/camera/fragment/BaseFragment;->isRightLandScape()Z

    move-result p1

    if-nez p1, :cond_3

    invoke-virtual {v9}, Lcom/android/camera/fragment/BaseFragment;->isFlipRotate()Z
    ...
    :goto_2
    invoke-virtual {p0, p1, v2}, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView;->setRotate(IZ)V
    ...
    iget p0, v9, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-virtual {v7, p0}, Lcom/android/camera/data/data/c;->getComponentValue(I)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v1, p0}, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mapValueToAngle(Ljava/lang/String;)F

    move-result p0

    iget-object p1, v9, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;->mScaleView:Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalScaleZoomView;

    invoke-virtual {p1, p0}, Lcom/android/camera2/compat/theme/custom/mm/zoom/HorizontalScaleZoomView;->setSelection(F)V

    :cond_4
    invoke-direct {v9, v7}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;->updateExtraScale(Lcom/android/camera/data/data/c;)V
...
.method public static bridge synthetic pf(Lcom/android/camera2/compat/theme/custom/mm/cinemaster/FragmentCineManuallyExtra;Ljava/lang/String;)V
    .locals 0
...
.method private setAnimation()V
    ...
    invoke-static {v2, v1, v5, v6}, LC/R1;->j(Ljava/lang/String;Lmiuix/animation/property/ViewProperty;D)Lmiuix/animation/controller/AnimState;
    ...
    invoke-static {v4, v3, v5, v6}, LC/R1;->j(Ljava/lang/String;Lmiuix/animation/property/ViewProperty;D)Lmiuix/animation/controller/AnimState;
...
.method public initPadOrFlodingCineExtraListLayout(Landroid/view/View;)V
    ...
    invoke-static {v3, v1, v4}, LQ9/d;->d(III)I
...
.method public onHiddenChanged(Z)V
    ...
    invoke-direct {v1, p1, v2}, LC3/c;-><init>(ZI)V
...
.method public onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-interface {v0, p4, p2, p3}, LX3/v0;->if(Ld0/l0;Ljava/lang/String;Ljava/lang/String;)V
    ...
    check-cast p4, Ld0/E0;

    iget p6, p0, Lcom/android/camera/fragment/BaseFragment;->mCurrentMode:I

    invoke-virtual {p4, p6}, Ld0/E0;->n(I)V

    invoke-interface {v0, p4, p2, p3}, LX3/v0;->w8(Ld0/E0;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p6, LZc/h;

    const/16 v0, 0x15

    invoke-direct {p6, v0}, LZc/h;-><init>(I)V
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f140c6f -> :sswitch_8
        0x7f140cd9 -> :sswitch_7
        0x7f140d7a -> :sswitch_6
        0x7f140da3 -> :sswitch_5
        0x7f140e86 -> :sswitch_4
