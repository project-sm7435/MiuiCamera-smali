...
.method public initValue(Z)V
    ...
    invoke-virtual {v2}, Lw7/b;->c()Ljava/util/List;

    move-result-object v2

    iput-object v2, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointEquivalentFocalLengthZooms:Ljava/util/List;
    ...
    iput v2, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mZoomRatioMin:F
    ...
    invoke-static {v2, v4, v3}, LC/G;->e(Ljava/lang/StringBuilder;Ljava/lang/String;F)Ljava/lang/String;
    ...
    const-string v5, "HorizontalNonSATSliderDrawAdapter"
    ...
    invoke-static {v2}, Lcom/android/camera/data/data/i;->A0(I)Z

    move-result v2

    sget-object v4, Lac/g;->b:[Ljava/lang/Float;

    invoke-static {v3, v2, v4}, Lcom/android/camera/data/data/i;->S(ZZ[Ljava/lang/Float;)Ljava/util/ArrayList;
    ...
    invoke-direct {v6, p0, p1}, LN0/A;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v2, v6}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v2

    invoke-static {v2}, Landroidx/appsearch/platformstorage/converter/D;->c(Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    iput-object v4, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mIndexs:Ljava/util/List;

    new-instance v2, Ljava/lang/StringBuilder;

    const-string v4, "mIndexs = "
    ...
    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mUnitRatios:Ljava/util/List;
    ...
    iput v2, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mScaleLineUnitOneEnd:I
    ...
    new-instance v0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;

    invoke-direct {v0, p0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;-><init>(Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setZoomIndex(I)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setZoomRatio(F)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setShowFocalLens(Z)V
...
.method public mapValueToAngle(Ljava/lang/String;)F
    ...
    invoke-static {p1, v0, v0, v5}, LQ9/d;->c(FFFF)F
