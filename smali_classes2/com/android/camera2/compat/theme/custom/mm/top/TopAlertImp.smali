...
.method public static synthetic G(LV3/B;LV3/h1;)V
    .locals 0
...
.method public static synthetic O(Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;Lcom/android/camera/fragment/top/FragmentTopAlert;)V
    .locals 0
...
.method public static synthetic U(Lcom/android/camera/fragment/top/FragmentTopAlert;)Z
    .locals 0
...
.method private reInitAlertAction(Z)V
    ...
    invoke-interface {p0}, LV3/B;->xi()V

    invoke-interface {p0}, LV3/B;->K7()V

    invoke-interface {p0}, LV3/B;->f2()V

    invoke-interface {p0}, LV3/B;->dg()V

    invoke-interface {p0}, LV3/B;->f6()V

    invoke-interface {p0, v1}, LV3/B;->Uh(Z)V

    invoke-interface {p0}, LV3/B;->Cc()V

    invoke-interface {p0}, LV3/B;->K0()V

    new-array p1, v0, [Z

    invoke-interface {p0, p1}, LV3/B;->Rd([Z)V

    invoke-interface {p0}, LV3/B;->y8()V

    invoke-interface {p0}, LV3/B;->I9()V

    invoke-interface {p0}, LV3/B;->r3()V
    ...
    invoke-virtual {p1}, Lf0/Z;->H()Z

    move-result p1

    invoke-interface {p0, p1}, LV3/B;->v4(Z)V

    invoke-interface {p0}, LV3/B;->Qh()V

    invoke-interface {p0}, LV3/B;->Pa()V

    invoke-interface {p0}, LV3/B;->tb()V

    invoke-interface {p0}, LV3/B;->x5()V

    invoke-interface {p0}, LV3/B;->ud()V

    invoke-interface {p0}, LV3/B;->W7()V

    invoke-interface {p0}, LV3/B;->P0()V

    invoke-interface {p0}, LV3/B;->F8()V
...
.method public bridge synthetic getVideoTag()LV3/e0;
    ...
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->getVideoTag()Lcom/android/camera/ui/G0;
