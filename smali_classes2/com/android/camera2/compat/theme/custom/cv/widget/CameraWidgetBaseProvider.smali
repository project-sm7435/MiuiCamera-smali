...
.method public static synthetic a(Lcom/android/camera2/compat/theme/custom/cv/widget/CameraWidgetBaseProvider;[ILandroid/content/Context;Landroid/appwidget/AppWidgetManager;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera2/compat/theme/custom/cv/widget/CameraWidgetBaseProvider;->lambda$refreshAppWidgets$0([ILandroid/content/Context;Landroid/appwidget/AppWidgetManager;)V

    return-void
.end method

.method private synthetic lambda$refreshAppWidgets$0([ILandroid/content/Context;Landroid/appwidget/AppWidgetManager;)V
    .locals 8
    ...
    invoke-virtual {p0, p2, v4}, Lcom/android/camera2/compat/theme/custom/cv/widget/CameraWidgetBaseProvider;->setWidgetIntent(Landroid/content/Context;Landroid/widget/RemoteViews;)V

    invoke-virtual {p3, v3, v4}, Landroid/appwidget/AppWidgetManager;->updateAppWidget(ILandroid/widget/RemoteViews;)V
...
.method private refreshAppWidgets(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/widget/a;-><init>(Lcom/android/camera2/compat/theme/custom/cv/widget/CameraWidgetBaseProvider;[ILandroid/content/Context;Landroid/appwidget/AppWidgetManager;)V
