...
.method public constructor <init>(Ljava/lang/String;IIIIIII)V
    ...
    iput-object v1, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mGifHardEncoder:Lcom/faceunity/pta_helper/gif/GifHardEncoder;

    .line 8
    iput p2, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mGifWidth:I

    iput p3, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mGifHeight:I

    iput-object p1, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mGifPath:Ljava/lang/String;

    sget-object v9, Lcom/faceunity/pta_helper/gif/EncodingType;->ENCODING_TYPE_SIMPLE_FAST:Lcom/faceunity/pta_helper/gif/EncodingType;
    ...
    invoke-virtual/range {v1 .. v10}, Lcom/faceunity/pta_helper/gif/GifHardEncoder;->init(IIIIIILjava/lang/String;Lcom/faceunity/pta_helper/gif/EncodingType;I)V
    ...
    iput-object p1, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->isCancel:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 11
    new-instance p1, Landroid/os/HandlerThread;

    sget-object p2, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->TAG:Ljava/lang/String;

    invoke-direct {p1, p2}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mThread:Landroid/os/HandlerThread;

    .line 12
    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    .line 13
    new-instance p1, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper$GifHardHandler;

    iget-object p2, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mThread:Landroid/os/HandlerThread;

    invoke-virtual {p2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p2

    invoke-direct {p1, p0, p2}, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper$GifHardHandler;-><init>(Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/faceunity/pta_helper/gif/GifHardEncoderWrapper;->mHandler:Landroid/os/Handler;
