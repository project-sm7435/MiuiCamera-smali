...
.method public synthetic constructor <init>(LC3/V1;Landroid/content/Context;Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, LC3/R1;->a:LC3/V1;

    iput-object p2, p0, LC3/R1;->b:Landroid/content/Context;

    iput-object p3, p0, LC3/R1;->c:Ljava/lang/String;

    iput-object p4, p0, LC3/R1;->d:Ljava/lang/Runnable;
...
.method public final run()V
    ...
    iget-object v0, p0, LC3/R1;->a:LC3/V1;
    ...
    iget-object p0, p0, LC3/R1;->b:Landroid/content/Context;

    invoke-static {p0, v1, v4}, LC/I3;->c(Landroid/content/Context;IZ)V

    iput-object v3, v0, LC3/V1;->l:Lmiuix/appcompat/app/AlertDialog;

    return-void

    :cond_0
    iget-object v1, v0, LC3/V1;->l:Lmiuix/appcompat/app/AlertDialog;
    ...
    :goto_0
    invoke-static {v1, v4}, LC/G;->n(Ljava/lang/String;Z)V
    ...
    iget-object v3, p0, LC3/R1;->c:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, LC3/V1;->T(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_3

    iget-object p0, p0, LC3/R1;->d:Ljava/lang/Runnable;
