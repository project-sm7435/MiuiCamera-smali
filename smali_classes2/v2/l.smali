...
.method public constructor <init>(Lcom/android/camera/ActivityBase;Landroid/view/Display;)V
    ...
    invoke-virtual {p0}, Lv2/l;->a()Ljava/lang/String;
    ...
    iput-boolean p1, p0, Lv2/l;->n:Z

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, Lv2/l;->p:F
    ...
    iput-object p1, p0, Lv2/l;->e:Lo/j;

    new-instance v0, Lo/j;

    invoke-direct {v0}, Lo/j;-><init>()V

    iput-object v0, p0, Lv2/l;->i:Lo/j;
...
.method public final b()V
    ...
    iget-object v1, p0, Lv2/l;->a:Ljava/lang/String;

    const-string v2, "hideArrowAnimator"

    invoke-static {v1, v2, v0}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lv2/l;->m:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Lv2/l;->m:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Lv2/l$b;-><init>(Lv2/l;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    :cond_0
    iget-object p0, p0, Lv2/l;->m:Landroid/animation/ValueAnimator;
...
.method public final c(Landroid/view/MotionEvent;)Z
    ...
    iget-object p0, p0, Lv2/l;->j:Landroid/widget/LinearLayout;
...
.method public final d()V
    ...
    :cond_0
    iget-object v0, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iput-object v1, p0, Lv2/l;->t:Landroid/animation/ValueAnimator;

    const-wide/16 v2, 0xc8

    invoke-virtual {v1, v2, v3}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v1, p0, Lv2/l;->t:Landroid/animation/ValueAnimator;

    new-instance v2, Lv2/l$c;

    invoke-direct {v2, p0, v0}, Lv2/l$c;-><init>(Lv2/l;I)V

    invoke-virtual {v1, v2}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v0, p0, Lv2/l;->t:Landroid/animation/ValueAnimator;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Lv2/l;->q:Lcom/android/camera/fragment/presentation/LinearGradientSlideView;

    iget-object v2, p0, Lv2/l;->j:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {p0, p1}, Lv2/l;->c(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-boolean v4, p0, Lv2/l;->l:Z
    ...
    :cond_6
    iget v2, p0, Lv2/l;->o:I

    sub-int v2, v0, v2

    iget-object v4, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v3, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v5, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v5, p0, Lv2/l;->k:Landroid/widget/TextView;

    invoke-virtual {v5}, Landroid/view/View;->getRight()I

    move-result v5

    iget v6, p0, Lv2/l;->s:I

    add-int/2addr v5, v6

    if-lt v4, v5, :cond_8

    iget-object p1, p0, Lv2/l;->k:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/view/View;->getRight()I

    move-result p1

    iget v2, p0, Lv2/l;->s:I

    add-int/2addr p1, v2

    iget-object v2, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    :cond_8
    iget-object v1, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v6, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v7, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iput-boolean v3, p0, Lv2/l;->n:Z

    invoke-virtual {p0, v2}, Lv2/l;->f(I)V
    ...
    iget-object v2, p0, Lv2/l;->k:Landroid/widget/TextView;

    invoke-virtual {v2}, Landroid/view/View;->getRight()I

    move-result v2

    iget v3, p0, Lv2/l;->s:I
    ...
    :cond_b
    invoke-virtual {p0}, Lv2/l;->d()V

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Lv2/l;->f(I)V
...
.method public e()V
    ...
    iget-object p0, p0, Lv2/l;->e:Lo/j;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lv2/l;->f:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lv2/l;->d:Landroid/widget/FrameLayout;

    new-instance v1, LM1/c;

    const/4 v3, 0x6

    invoke-direct {v1, v3}, LM1/c;-><init>(I)V
    ...
    iput-object v0, p0, Lv2/l;->b:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lv2/l;->c:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v1, p0, Lv2/l;->e:Lo/j;
    ...
    iput-object v0, p0, Lv2/l;->k:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lv2/l;->j:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lv2/l;->h:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v3, p0, Lv2/l;->i:Lo/j;
    ...
    iput-object v0, p0, Lv2/l;->q:Lcom/android/camera/fragment/presentation/LinearGradientSlideView;
    ...
    iput v0, p0, Lv2/l;->s:I

    new-instance v0, Lv2/l$a;

    invoke-direct {v0, p0}, Lv2/l$a;-><init>(Lv2/l;)V

    iget-object v1, v1, Lo/j;->c:LA/d;
    ...
    iget-object v0, p0, Lv2/l;->b:Landroid/widget/TextView;

    const v2, 0x7f14072b

    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setText(I)V

    iget-object v0, p0, Lv2/l;->f:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Lv2/l;->j:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0, v3, v2}, LC/c3;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v1, v1, LH0/g;->b:I

    int-to-float v1, v1

    invoke-virtual {v0, v1}, Landroid/view/View;->setRotation(F)V

    iget-object v0, p0, Lv2/l;->k:Landroid/widget/TextView;
