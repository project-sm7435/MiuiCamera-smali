...
.method public constructor <init>(LZ5/O0;)V
    ...
    iput-object p1, p0, LZ5/O0$b;->a:LZ5/O0;
...
.method public final onDataReady(J)V
    ...
    iget-object v0, p0, LZ5/O0$b;->a:LZ5/O0;
    ...
    invoke-static {v0, p1, p2}, LZ5/O0;->x(LZ5/O0;J)V

    iget-object p1, p0, LZ5/O0$b;->a:LZ5/O0;
    ...
    iget-object p2, p2, LZ5/e0;->V:Ljava/util/concurrent/ConcurrentLinkedDeque;

    iget-object v0, p1, LZ5/O0;->B:LQ9/o;

    iget-wide v0, v0, LQ9/o;->e:J

    invoke-virtual {p1, p2, v0, v1}, LZ5/O0;->H(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V

    iget-object p1, p0, LZ5/O0$b;->a:LZ5/O0;

    iget-object p2, p1, LZ5/n0;->b:LZ5/e0;

    iget-object p2, p2, LZ5/e0;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v0, v0, LZ5/e0;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;
...
.method public final onImageReceived(LQ9/o;[BLjava/lang/String;)V
    ...
    iput-wide v1, v0, LZ5/O0;->I:J

    iget-object v0, p0, LZ5/O0$b;->a:LZ5/O0;

    iget-object v1, v0, LZ5/n0;->a:Ljava/lang/String;

    iget-wide v2, v0, LZ5/O0;->I:J
    ...
    iget-object v1, v1, LZ5/n0;->r:Lw9/a;

    new-instance v2, LZ5/P0;

    invoke-direct {v2, p0, p2, p3}, LZ5/P0;-><init>(LZ5/O0$b;[BLjava/lang/String;)V

    new-instance p2, LJ9/d;

    const/4 p3, 0x6

    invoke-direct {p2, p0, p3}, LJ9/d;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2, p2, v0}, Lw9/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V

    goto :goto_1

    :cond_2
    invoke-static {v0, p2, p3}, LZ5/O0;->w(LZ5/O0;[BLjava/lang/String;)V

    :goto_1
    iget-object p2, p0, LZ5/O0$b;->a:LZ5/O0;

    iget p3, p2, LZ5/O0;->L:I

    const/4 v0, 0x1

    add-int/2addr p3, v0

    iput p3, p2, LZ5/O0;->L:I
    ...
    :goto_2
    iget-object p1, p2, LZ5/n0;->b:LZ5/e0;

    iget-object p2, p1, LZ5/e0;->D:LZ5/L0;

    iget-object p2, p2, LZ5/L0;->a:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LZ5/L0;->e:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LZ5/L0;->d:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LZ5/L0;->p:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LZ5/L0;->l:Landroid/media/ImageReader;
    ...
    :cond_8
    iget-object p1, p1, LZ5/e0;->D:LZ5/L0;

    iget-object p2, p1, LZ5/L0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_9
    iget-object p1, p1, LZ5/L0;->j:Ljava/util/concurrent/ConcurrentHashMap;
