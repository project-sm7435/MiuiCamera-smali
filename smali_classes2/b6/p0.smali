...
.method public constructor <init>(Lb6/X;ILandroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, Lb6/p0;->C:Z

    iput p2, p0, Lb6/p0;->F:I

    sget-object p1, Lx9/d;->b:Lx9/d;

    iput-object p1, p0, Lb6/p0;->H:Lx9/d;

    iput-object p3, p0, Lb6/p0;->I:Landroid/view/Surface;

    return-void
.end method

.method public static w(Lb6/p0;ZI)V
    .locals 5
...
.method public final m()V
    ...
    iget v0, p0, Lb6/p0;->G:I

    iget v1, p0, Lb6/p0;->F:I
    ...
    iget-object v3, v2, Lb6/X;->E:Lb6/c;
    ...
    invoke-virtual {v2}, Lb6/X;->i0()V

    :cond_2
    :try_start_0
    new-instance v0, Lb6/o0;

    invoke-direct {v0, p0}, Lb6/o0;-><init>(Lb6/p0;)V

    invoke-virtual {p0}, Lb6/p0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lb6/p0;->I:Landroid/view/Surface;
    ...
    iget-object v11, p0, Lb6/g0;->c:Landroid/os/Handler;
    ...
    iget v10, p0, Lb6/p0;->G:I

    add-int/2addr v10, v6

    iput v10, p0, Lb6/p0;->G:I

    iput v9, p0, Lb6/p0;->D:I

    if-ne v10, v1, :cond_5

    iput v9, p0, Lb6/p0;->E:I
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_1
    invoke-virtual {v4}, Lb6/D0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v11}, Lb6/D0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v6}, Lb6/D0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v2, v10}, Lb6/D0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v9}, Lb6/D0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v10, v5, v2}, Lb6/l0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    iput-boolean v9, v2, Lb6/G;->z1:Z

    :cond_9
    invoke-static {v7, v1, p0, v2}, Lb6/J;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Lb6/G;)V
    ...
    invoke-virtual {v4, v1, v5, v6, v2}, Lcom/android/camera2/compat/MiCameraCompatBaseImpl;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/m;)V
    ...
    invoke-static {v1, p0, v9}, Lb6/J;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V

    invoke-static {v1, p0, v9}, Lb6/J;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Lb6/c;Z)V
