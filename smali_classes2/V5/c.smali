...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, LV5/c;->a:LV5/d;

    iget-boolean v0, p0, LV5/d;->s:Z
    ...
    :goto_1
    iget-object v5, p0, LV5/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean p1, p0, LV5/d;->t:Z

    if-nez p1, :cond_7

    iput-boolean v1, p0, LV5/d;->t:Z

    return-void

    :cond_5
    iget-object p1, p0, LV5/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, LV5/d;->r:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LV5/d$d;

    if-eqz v0, :cond_6

    invoke-interface {v0}, LV5/d$d;->onWideSelfCompleted()V

    :cond_6
    iput v1, p0, LV5/d;->d:I
