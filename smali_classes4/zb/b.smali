...
.method public constructor <init>()V
    ...
    iput-object v2, v1, Lzb/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-object v1, p0, Lzb/b;->i:Lzb/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lzb/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Lzb/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Lzb/b;->l:Z

    iput v0, p0, Lzb/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lzb/b;->q:J

    return-void
.end method

.method public static a(Lzb/b;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p2, p1, v0}, LA/T;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide p1, p0, Lzb/b;->q:J

    :cond_0
    return-void
.end method

.method public static b(Lzb/b;)V
    .locals 5
    ...
    iget-object v3, p0, Lzb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Lzb/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lzb/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Lzb/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lzb/b;->l:Z
    ...
    iget-object v5, p0, Lzb/b;->a:Landroid/media/AudioRecord;
    ...
    :goto_3
    iget-object v0, p0, Lzb/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, Lzb/d;-><init>(Lzb/b;)V

    iput-object v0, p0, Lzb/b;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, Lzb/c;-><init>(Lzb/b;)V
...
.method public final d(Landroid/media/AudioFormat;IIII)V
    ...
    iput-object p1, p0, Lzb/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, Lzb/b;->g:I

    iput p3, p0, Lzb/b;->f:I

    iput p4, p0, Lzb/b;->h:I

    iput p5, p0, Lzb/b;->n:I
    ...
    iput-object p4, p3, Lyb/a;->c:Ljava/nio/ByteBuffer;

    const-wide/16 v0, -0x1

    iput-wide v0, p3, Lyb/a;->d:J

    const-wide/16 v0, 0x0

    iput-wide v0, p3, Lyb/a;->e:J

    iput-boolean p5, p3, Lyb/a;->f:Z

    iput p1, p3, Lyb/a;->a:I

    iput-object p4, p3, Lyb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p3, Lyb/a;->c:Ljava/nio/ByteBuffer;

    iput-object p3, p0, Lzb/b;->m:Lyb/a;

    new-instance p1, Lzb/b$a;

    invoke-direct {p1, p0}, Lzb/b$a;-><init>(Lzb/b;)V

    iput-object p1, p3, Lyb/a;->g:Lzb/b$a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, Lzb/b;->l:Z
    ...
    invoke-static {p2, p1, p3}, LK2/e;->c(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, Lzb/b;->l:Z
    ...
    iget-object p2, p0, Lzb/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Lzb/b;->a:Landroid/media/AudioRecord;
    :try_end_0
...
.method public final e()V
    ...
    iput-boolean v2, p0, Lzb/b;->c:Z

    iget-object v0, p0, Lzb/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lzb/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Lzb/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Lzb/b;->i:Lzb/a;

    invoke-virtual {v3}, Lzb/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lzb/b;->m:Lyb/a;

    if-eqz v0, :cond_3

    iput-object v1, v0, Lyb/a;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lyb/a;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lyb/a;->g:Lzb/b$a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Lyb/a;->d:J
    ...
    :cond_3
    iput-object v1, p0, Lzb/b;->m:Lyb/a;

    iput-object v1, p0, Lzb/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Lzb/b;->l:Z
...
.method public final f()V
    ...
    iput-boolean v1, p0, Lzb/b;->c:Z

    iget-object v1, p0, Lzb/b;->i:Lzb/a;

    invoke-virtual {v1}, Lzb/a;->a()V

    iget-object v1, p0, Lzb/b;->b:Ljava/lang/Thread;
    ...
    :cond_0
    iget-object p0, p0, Lzb/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    :try_start_1
    iget-object v3, p0, Lzb/b;->m:Lyb/a;

    iget-object v4, v3, Lyb/a;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Lyb/a;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Lyb/a;->c:Ljava/nio/ByteBuffer;
