...
# direct methods
.method public constructor <init>(Lxb/i;Landroid/os/Looper;)V
    .locals 0
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, Lxb/g;->a:Lxb/i;
    ...
    :pswitch_0
    :try_start_0
    iget-object p1, p0, Lxb/i;->W:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iget-object v0, p1, LAb/f;->a:Ljava/nio/ByteBuffer;

    iget-object p1, p1, LAb/f;->d:Landroid/media/MediaCodec$BufferInfo;

    invoke-virtual {p0, v0, p1}, Lxb/i;->x(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :pswitch_1
    :try_start_1
    iget-object p1, p0, Lxb/i;->V:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    invoke-virtual {p0, v0, p1}, Lxb/i;->z(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :pswitch_2
    iget-object p0, p0, Lxb/i;->Z:Ljava/util/concurrent/CountDownLatch;
