...
.method public final C(Lw9/h;)V
    ...
    invoke-static {v0, v1}, LA/U;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-boolean v1, v1, Lw9/b$a;->i:Z
    ...
    iget-object v5, v4, Lw9/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, LQ9/l;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, Lw9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, Lw9/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, LQ9/B;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, Lw9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_2
    iget v8, p1, Lw9/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, LQ9/B;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, Lw9/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, LQ9/l;->j:LQ9/r$e;

    invoke-static {v4, v5}, LQ9/b;->E(Landroid/media/Image;LQ9/r$e;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, LA/O;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {p1, p0}, LQ9/z;-><init>(LQ9/B;)V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, LQ9/b;->w:Landroid/media/ImageReader;

    new-instance v2, LQ9/w;

    invoke-direct {v2, p0, p1}, LQ9/w;-><init>(LQ9/B;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v2, p0}, LQ9/x;-><init>(LQ9/B;)V
    ...
    invoke-direct {v1, p0}, LQ9/y;-><init>(LQ9/B;)V
