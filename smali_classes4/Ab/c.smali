...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, LAb/c;->a:Ljava/lang/String;
    ...
    iput-wide v1, p0, LAb/c;->g:J

    iput-wide v1, p0, LAb/c;->h:J

    iput-boolean v0, p0, LAb/c;->i:Z

    iput-boolean v0, p0, LAb/c;->j:Z

    new-instance v3, Ljava/lang/Object;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, p0, LAb/c;->k:Ljava/lang/Object;

    iput-wide v1, p0, LAb/c;->m:J

    iput-wide v1, p0, LAb/c;->n:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, LAb/c;->o:J

    iput-wide v1, p0, LAb/c;->p:J

    iput-wide v1, p0, LAb/c;->q:J
    ...
    iput-object v1, p0, LAb/c;->u:Ljava/lang/Integer;

    iput v0, p0, LAb/c;->v:I
...
.method public static a(LAb/c;Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 2
    ...
    iget-object p1, p0, LAb/c;->a:Ljava/lang/String;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p3, p0, LAb/c;->b:Ljava/lang/String;
    ...
    :try_start_1
    iput-boolean p2, p0, LAb/c;->j:Z

    iget-object p2, p0, LAb/c;->k:Ljava/lang/Object;
    ...
    iput-wide v0, p0, LAb/c;->h:J

    invoke-virtual {p0, p1, p2, p3}, LAb/c;->e(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    :try_end_2
    ...
    :goto_0
    iget-object p2, p0, LAb/c;->a:Ljava/lang/String;
    ...
    iget-object p0, p0, LAb/c;->r:LAb/c$b;

    if-eqz p0, :cond_1

    invoke-interface {p0}, LAb/c$b;->c()V
...
.method public final b()Z
    ...
    iget-object v3, p0, LAb/c;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3, v2}, LH0/f;->g(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final f(Landroid/media/MediaFormat;I)V
    ...
    iput-object p1, p0, LAb/c;->d:Landroid/media/MediaFormat;
    ...
    :goto_0
    iget-object v4, p0, LAb/c;->d:Landroid/media/MediaFormat;
    ...
    :cond_3
    iget-object v4, p0, LAb/c;->u:Ljava/lang/Integer;
    ...
    iget-object v6, p0, LAb/c;->b:Ljava/lang/String;

    const-string v7, "CodecThread"

    invoke-static {v5, v6, v7}, LA/p2;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-direct {v4, v5, v2}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;I)V

    iput-object v4, p0, LAb/c;->s:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v4, p0, LAb/c;->s:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, LAb/c;->t:Landroid/os/Handler;

    iget-object v2, p0, LAb/c;->d:Landroid/media/MediaFormat;
    ...
    iget-object v5, p0, LAb/c;->a:Ljava/lang/String;

    invoke-static {v5, v2, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, p1}, LAb/c;->c(Landroid/media/MediaFormat;)Landroid/media/MediaCodec;

    move-result-object v2

    iput-object v2, p0, LAb/c;->c:Landroid/media/MediaCodec;

    const-string v2, " createMediaCodec X "

    invoke-static {v6, v2}, LA/d0;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v4, p0, LAb/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v2, p0, LAb/c;->c:Landroid/media/MediaCodec;

    new-instance v4, LAb/b;

    invoke-direct {v4, p0}, LAb/b;-><init>(LAb/c;)V

    iget-object v7, p0, LAb/c;->t:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, LAb/c;->g()Landroid/view/Surface;

    iget-object p1, p0, LAb/c;->r:LAb/c$b;

    if-eqz p1, :cond_5

    iget-object p0, p0, LAb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {p0}, Landroid/media/MediaCodec;->getOutputFormat()Landroid/media/MediaFormat;

    move-result-object p0

    invoke-interface {p1, p0}, LAb/c$b;->f(Landroid/media/MediaFormat;)V

    :cond_5
    const-string p0, " init End >> "

    invoke-static {v6, p0}, LA/d0;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final h()Z
    ...
    iget-object p0, p0, LAb/c;->d:Landroid/media/MediaFormat;
...
.method public final i(JJLjava/util/function/IntFunction;)V
    ...
    iget-object v1, p0, LAb/c;->b:Ljava/lang/String;
    ...
    iget-object v5, p0, LAb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v5, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-wide p1, p0, LAb/c;->m:J

    const-wide/16 p1, 0x0

    iput-wide p1, p0, LAb/c;->q:J

    iput-object p5, p0, LAb/c;->l:Ljava/util/function/IntFunction;
    ...
    iget-object p1, p0, LAb/c;->t:Landroid/os/Handler;
...
.method public j()V
    ...
    iget-object v0, p0, LAb/c;->a:Ljava/lang/String;
    ...
    iget-object v4, p0, LAb/c;->b:Ljava/lang/String;
    ...
    iput-object v1, p0, LAb/c;->c:Landroid/media/MediaCodec;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, LAb/c;->m:J

    iput-wide v3, p0, LAb/c;->g:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, LAb/c;->o:J

    iget-object v1, p0, LAb/c;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, LAb/c;->b:Ljava/lang/String;
...
.method public k(J)V
    ...
    iput-wide p1, p0, LAb/c;->n:J

    iget-wide v5, p0, LAb/c;->m:J

    sub-long v5, p1, v5

    iput-wide v5, p0, LAb/c;->q:J

    iget-wide v7, p0, LAb/c;->p:J

    add-long/2addr v7, v5

    iput-wide v7, p0, LAb/c;->p:J
    ...
    iget-object p1, p0, LAb/c;->c:Landroid/media/MediaCodec;
...
.method public m(JJ)V
    ...
    :cond_0
    iget-object v0, p0, LAb/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v6, p0, LAb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v6, v5}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object v5, p0, LAb/c;->k:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-boolean v6, p0, LAb/c;->i:Z

    if-nez v6, :cond_6

    iget-boolean v6, p0, LAb/c;->j:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v6, p0, LAb/c;->a:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v8, p0, LAb/c;->b:Ljava/lang/String;
    ...
    iget-object v6, p0, LAb/c;->k:Ljava/lang/Object;

    invoke-virtual {v6, v8, v9}, Ljava/lang/Object;->wait(J)V

    invoke-virtual {p0}, LAb/c;->b()Z
    ...
    :goto_1
    :try_start_2
    iget-object v7, p0, LAb/c;->a:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v9, p0, LAb/c;->b:Ljava/lang/String;
...
.method public final n()V
    ...
    iget-object v1, p0, LAb/c;->e:Landroid/view/Surface;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, LAb/c;->j:Z
    ...
    :goto_1
    :try_start_2
    iget-object v3, p0, LAb/c;->a:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v5, p0, LAb/c;->b:Ljava/lang/String;
    ...
    :cond_2
    :goto_2
    iget-object v1, p0, LAb/c;->r:LAb/c$b;

    if-eqz v1, :cond_3

    invoke-interface {v1, p0}, LAb/c$b;->d(LAb/c;)V

    :cond_3
    const/4 v1, 0x1

    iput-boolean v1, p0, LAb/c;->i:Z
