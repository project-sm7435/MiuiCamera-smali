.class public final Lcom/xiaomi/camera/agent/data/$OperationResultFactory;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/xiaomi/camera/agent/data/$OperationResultFactory",
        "Landroidx/appfunctions/internal/AppFunctionSerializableFactory;",
        "Lcom/xiaomi/camera/agent/data/OperationResult;",
        "<init>",
        "()V",
...
# virtual methods
.method public fromAppFunctionData(Landroidx/appfunctions/AppFunctionData;)Lcom/xiaomi/camera/agent/data/OperationResult;
    .locals 2
    ...
    .line 2
    const-string v0, "com.xiaomi.camera.agent.data.OperationResult"

    invoke-virtual {p0, p1, v0}, Lcom/xiaomi/camera/agent/data/$OperationResultFactory;->getAppFunctionDataWithSpec(Landroidx/appfunctions/AppFunctionData;Ljava/lang/String;)Landroidx/appfunctions/AppFunctionData;
...
.method public bridge synthetic fromAppFunctionData(Landroidx/appfunctions/AppFunctionData;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/xiaomi/camera/agent/data/$OperationResultFactory;->fromAppFunctionData(Landroidx/appfunctions/AppFunctionData;)Lcom/xiaomi/camera/agent/data/OperationResult;
...
.method public toAppFunctionData(Lcom/xiaomi/camera/agent/data/OperationResult;)Landroidx/appfunctions/AppFunctionData;
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/camera/agent/data/$OperationResultFactory;->getAppFunctionDataBuilder(Ljava/lang/String;)Landroidx/appfunctions/AppFunctionData$Builder;

    move-result-object p0

    .line 3
    invoke-virtual {p1}, Lcom/xiaomi/camera/agent/data/OperationResult;->getSuccess()Z
    ...
    .line 5
    invoke-virtual {p1}, Lcom/xiaomi/camera/agent/data/OperationResult;->getMessage()Ljava/lang/String;
...
.method public bridge synthetic toAppFunctionData(Ljava/lang/Object;)Landroidx/appfunctions/AppFunctionData;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/camera/agent/data/$OperationResultFactory;->toAppFunctionData(Lcom/xiaomi/camera/agent/data/OperationResult;)Landroidx/appfunctions/AppFunctionData;
