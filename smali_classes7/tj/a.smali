...
# direct methods
.method public static a(Loj/a;Ltj/b;)Ljava/util/LinkedList;
    .locals 10
    ...
    invoke-static {p0}, Lqj/g;->b(Loj/a;)Ljava/util/ArrayList;
    ...
    check-cast v1, Lqj/g$a;

    iget-object v3, v1, Lqj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    iget-wide v3, v1, Lqj/g$a;->a:J

    invoke-virtual {p0, v3, v4}, Loj/a;->a(J)V

    iget-object v0, v1, Lqj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v3, v0, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v0, v3

    invoke-static {p0, v0}, Loj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    sget-object v4, Lqj/b;->b:Lqj/b;

    invoke-static {v0, v3, v4}, Lqj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Lqj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    check-cast v7, Lqj/g$a;

    iget-object v8, v7, Lqj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    check-cast v6, Lqj/g$a;

    iget-wide v7, v6, Lqj/g$a;->a:J

    invoke-virtual {p0, v7, v8}, Loj/a;->a(J)V

    iget-object v7, v6, Lqj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v7, v7, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v7, v7

    invoke-static {p0, v7}, Loj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;

    move-result-object v7

    new-instance v8, Lnj/e;

    invoke-direct {v8, v6, v7}, Lnj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sget-object v8, Lqj/b;->b:Lqj/b;

    invoke-static {v7, v6, v8}, Lqj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Lqj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    invoke-direct {v8, v7, v6}, Lnj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v6, v6, Lnj/e;->b:Ljava/lang/Object;
    ...
    iget-object v5, p1, Lnj/e;->a:Ljava/lang/Object;

    check-cast v5, Ljava/nio/ByteBuffer;

    iget-object p1, p1, Lnj/e;->b:Ljava/lang/Object;

    check-cast p1, Lorg/jcodec/containers/mp4/boxes/Box;

    invoke-static {v5, p1}, Ltj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_7
    invoke-interface {p1, v3}, Ltj/b;->a(Lorg/jcodec/containers/mp4/boxes/MovieBox;)V

    :cond_8
    invoke-static {v0, v3}, Ltj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    invoke-direct {p0, v1, v0}, Lnj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
