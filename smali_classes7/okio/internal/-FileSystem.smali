...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lokio/FileSystem;Lokio/Path;Z)LMg/h;",
        "LMg/j;",
        "fileSystem",
        "Lif/h;",
        "stack",
        "postorder",
        "collectRecursively",
        "(LMg/j;Lokio/FileSystem;Lif/h;Lokio/Path;ZZLlf/e;)Ljava/lang/Object;",
        "symlinkTarget",
...
# direct methods
.method public static final collectRecursively(LMg/j;Lokio/FileSystem;Lif/h;Lokio/Path;ZZLlf/e;)Ljava/lang/Object;
    .locals 16
    ...
    invoke-direct {v5, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Llf/e;)V
    ...
    invoke-static {v3}, Lhf/l;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5}, LMg/j;->b(Ljava/lang/Object;Lnf/a;)V
    ...
    invoke-virtual {v7, v13}, Lif/h;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, LA/O;->h(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v7, v13}, Lif/h;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->collectRecursively(LMg/j;Lokio/FileSystem;Lif/h;Lokio/Path;ZZLlf/e;)Ljava/lang/Object;
    ...
    :cond_b
    invoke-virtual {v7}, Lif/h;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v1, v5}, LMg/j;->b(Ljava/lang/Object;Lnf/a;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    invoke-static {p0, p1}, Ldc/f;->b(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lif/h;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Llf/e;)V

    new-instance p1, LMg/i;

    invoke-direct {p1}, LMg/j;-><init>()V

    invoke-static {p1, p1, v0}, LCg/v;->e(Llf/e;Llf/e;Lwf/p;)Llf/e;

    move-result-object v0

    iput-object v0, p1, LMg/i;->d:Llf/e;

    :goto_0
    invoke-virtual {p1}, LMg/i;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, LMg/i;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)LMg/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLlf/e;)V
...
.method public static final commonMetadata(Lokio/FileSystem;Lokio/Path;)Lokio/FileMetadata;
    ...
    invoke-static {p1, v0}, LA/O;->h(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
