...
.method private newDrawing()V
    ...
    sget-object v0, LDj/b;->v:Lorg/apache/xmlbeans/SchemaType;
    ...
    sget-object v0, LEj/f;->I:Lorg/apache/xmlbeans/SchemaType;

    invoke-interface {p0}, LDj/b;->h()V

    invoke-interface {p0}, LDj/b;->o()LDj/a;
...
.method public findCommentShape(II)LEj/d;
    .locals 1
    ...
    instance-of v0, p1, LEj/d;

    if-eqz v0, :cond_0

    check-cast p1, LEj/d;

    invoke-interface {p1}, LEj/d;->c()I
    ...
    :cond_1
    invoke-interface {p1}, LEj/d;->g()LCj/a;
...
.method public newCommentShape()LEj/d;
    .locals 4
    ...
    sget-object v1, LEj/d;->F:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {v0, v1}, LEj/d;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0}, LEj/d;->setType(Ljava/lang/String;)V

    invoke-interface {v0}, LEj/d;->l()V

    invoke-interface {v0}, LEj/d;->b()V

    sget-object p0, LDj/c;->z:Lorg/apache/xmlbeans/SchemaType;

    invoke-interface {v0}, LEj/d;->e()V

    invoke-interface {v0}, LEj/d;->addNewFill()LEj/a;
...
.method public read(Ljava/io/InputStream;)V
    ...
    sget-object v7, LDj/b;->v:Lorg/apache/xmlbeans/SchemaType;
    ...
    sget-object v6, LEj/e;->G:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {v2}, LEj/e;->getId()Ljava/lang/String;
    ...
    sget-object v6, LEj/d;->F:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {v2}, LEj/d;->getId()Ljava/lang/String;
...
.method public removeCommentShape(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Lorg/apache/poi/xssf/usermodel/XSSFVMLDrawing;->findCommentShape(II)LEj/d;
