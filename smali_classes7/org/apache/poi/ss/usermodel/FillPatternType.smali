...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v0, v2}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "SOLID_FOREGROUND"

    const/4 v3, 0x1

    invoke-direct {v2, v0, v3}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "FINE_DOTS"

    const/4 v4, 0x2

    invoke-direct {v3, v0, v4}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "ALT_BARS"

    const/4 v5, 0x3

    invoke-direct {v4, v0, v5}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "SPARSE_DOTS"

    const/4 v6, 0x4

    invoke-direct {v5, v0, v6}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THICK_HORZ_BANDS"

    const/4 v7, 0x5

    invoke-direct {v6, v0, v7}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THICK_VERT_BANDS"

    const/4 v8, 0x6

    invoke-direct {v7, v0, v8}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THICK_BACKWARD_DIAG"

    const/4 v9, 0x7

    invoke-direct {v8, v0, v9}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THICK_FORWARD_DIAG"

    const/16 v10, 0x8

    invoke-direct {v9, v0, v10}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "BIG_SPOTS"

    const/16 v11, 0x9

    invoke-direct {v10, v0, v11}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v11, v0, v12}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THIN_HORZ_BANDS"

    const/16 v13, 0xb

    invoke-direct {v12, v0, v13}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THIN_VERT_BANDS"

    const/16 v14, 0xc

    invoke-direct {v13, v0, v14}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THIN_BACKWARD_DIAG"

    const/16 v15, 0xd

    invoke-direct {v14, v0, v15}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v0, "THIN_FORWARD_DIAG"

    move-object/from16 v16, v1

    const/16 v1, 0xe

    invoke-direct {v15, v0, v1}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V

    sput-object v15, Lorg/apache/poi/ss/usermodel/FillPatternType;->THIN_FORWARD_DIAG:Lorg/apache/poi/ss/usermodel/FillPatternType;
    ...
    invoke-direct {v1, v2, v0}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/apache/poi/ss/usermodel/FillPatternType;->DIAMONDS:Lorg/apache/poi/ss/usermodel/FillPatternType;
    ...
    invoke-direct {v0, v2, v1}, Lorg/apache/poi/ss/usermodel/FillPatternType;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lorg/apache/poi/ss/usermodel/FillPatternType;->LESS_DOTS:Lorg/apache/poi/ss/usermodel/FillPatternType;

    new-instance v1, Lorg/apache/poi/ss/usermodel/FillPatternType;

    const-string v2, "LEAST_DOTS"
    ...
    sput-object v1, Lorg/apache/poi/ss/usermodel/FillPatternType;->LEAST_DOTS:Lorg/apache/poi/ss/usermodel/FillPatternType;
    ...
    filled-new-array/range {v1 .. v19}, [Lorg/apache/poi/ss/usermodel/FillPatternType;
