...
.method private initParagraphProperties()V
    ...
    new-instance v3, Lorg/apache/poi/hdf/model/hdftypes/PapxNode;

    invoke-direct {v3, v15, v8, v2}, Lorg/apache/poi/hdf/model/hdftypes/PapxNode;-><init>(II[B)V

    invoke-interface {v1, v3}, Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;->paragraph(Lorg/apache/poi/hdf/model/hdftypes/PapxNode;)V
    ...
    new-instance v4, Lorg/apache/poi/hdf/model/hdftypes/ChpxNode;

    invoke-direct {v4, v1, v2, v3}, Lorg/apache/poi/hdf/model/hdftypes/ChpxNode;-><init>(II[B)V

    invoke-interface {v15, v4}, Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;->characterRun(Lorg/apache/poi/hdf/model/hdftypes/ChpxNode;)V
    ...
    .line 45
    iget-object v4, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_mainDocument:[B

    mul-int/lit16 v9, v1, 0x200

    const/4 v15, 0x0

    invoke-static {v4, v9, v3, v15, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 46
    new-instance v4, Lorg/apache/poi/hdf/model/hdftypes/CHPFormattedDiskPage;

    invoke-direct {v4, v3}, Lorg/apache/poi/hdf/model/hdftypes/CHPFormattedDiskPage;-><init>([B)V

    .line 47
    invoke-virtual {v4}, Lorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;->size()I
...
.method private initParagraphProperties(ILorg/apache/poi/hdf/model/hdftypes/PlexOfCps;ILorg/apache/poi/hdf/model/hdftypes/PlexOfCps;II)V
    ...
    .line 2
    iget-object v3, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_parParsingState:Lorg/apache/poi/hdf/model/util/ParsingState;

    invoke-virtual {v3}, Lorg/apache/poi/hdf/model/util/ParsingState;->getCurrentPageIndex()I

    move-result v3

    .line 3
    iget-object v4, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_parParsingState:Lorg/apache/poi/hdf/model/util/ParsingState;

    invoke-virtual {v4}, Lorg/apache/poi/hdf/model/util/ParsingState;->getFkp()Lorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;

    move-result-object v4

    .line 4
    iget-object v5, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_parParsingState:Lorg/apache/poi/hdf/model/util/ParsingState;

    invoke-virtual {v5}, Lorg/apache/poi/hdf/model/util/ParsingState;->getCurrentPropIndex()I
    ...
    .line 6
    invoke-virtual {v4, v5}, Lorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;->getStart(I)I

    move-result v7

    .line 7
    invoke-virtual {v4, v5}, Lorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;->getEnd(I)I

    move-result v8

    .line 8
    invoke-virtual {v4, v5}, Lorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;->getGrpprl(I)[B

    move-result-object v9

    .line 9
    iget-object v10, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_listener:Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;

    new-instance v11, Lorg/apache/poi/hdf/model/hdftypes/PapxNode;
    ...
    invoke-direct {v11, v12, v13, v9}, Lorg/apache/poi/hdf/model/hdftypes/PapxNode;-><init>(II[B)V

    invoke-interface {v10, v11}, Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;->paragraph(Lorg/apache/poi/hdf/model/hdftypes/PapxNode;)V
    ...
    invoke-direct {p0, v10, v11, v7, v9}, Lorg/apache/poi/hdf/model/HDFObjectFactory;->initCharacterProperties(ILorg/apache/poi/hdf/model/hdftypes/PlexOfCps;II)V
    ...
    .line 11
    :cond_0
    iget-object p0, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_parParsingState:Lorg/apache/poi/hdf/model/util/ParsingState;

    invoke-virtual {p0, v3, v4, v5}, Lorg/apache/poi/hdf/model/util/ParsingState;->setState(ILorg/apache/poi/hdf/model/hdftypes/FormattedDiskPage;I)V
    ...
    .line 12
    iget-object v4, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_tableBuffer:[B

    add-int/lit8 v3, v3, 0x1

    move-object/from16 v5, p2

    invoke-virtual {v5, v3}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->getStructOffset(I)I
    ...
    .line 14
    iget-object v8, p0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_mainDocument:[B

    mul-int/2addr v4, v6

    const/4 v9, 0x0

    invoke-static {v8, v4, v7, v9, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 15
    new-instance v4, Lorg/apache/poi/hdf/model/hdftypes/PAPFormattedDiskPage;

    invoke-direct {v4, v7}, Lorg/apache/poi/hdf/model/hdftypes/PAPFormattedDiskPage;-><init>([B)V
...
.method private initSectionProperties()V
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getCcpText()I

    move-result v1

    iget-object v2, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v2}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getCcpFtn()I

    iget-object v2, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v2}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getFcMin()I

    move-result v7

    iget-object v2, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v2}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getFcPlcfsed()I

    move-result v8

    iget-object v2, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v2}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getLcbPlcfsed()I

    move-result v2

    iget-object v3, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getFcPlcfbtePapx()I

    move-result v3

    iget-object v4, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v4}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getLcbPlcfbtePapx()I

    move-result v4

    iget-object v5, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v5}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getFcPlcfbteChpx()I

    move-result v5

    iget-object v6, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_fib:Lorg/apache/poi/hdf/model/hdftypes/FileInformationBlock;

    invoke-virtual {v6}, Lorg/apache/poi/hdf/model/hdftypes/definitions/FIBAbstractType;->getLcbPlcfbteChpx()I

    move-result v6

    new-instance v9, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;

    const/4 v10, 0x4

    invoke-direct {v9, v6, v10}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;-><init>(II)V

    new-instance v6, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;

    invoke-direct {v6, v4, v10}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;-><init>(II)V

    invoke-direct {v0, v3, v6, v5, v9}, Lorg/apache/poi/hdf/model/HDFObjectFactory;->initParsingStates(ILorg/apache/poi/hdf/model/hdftypes/PlexOfCps;ILorg/apache/poi/hdf/model/hdftypes/PlexOfCps;)V

    new-instance v10, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;

    const/16 v4, 0xc

    invoke-direct {v10, v2, v4}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;-><init>(II)V

    invoke-virtual {v10}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->length()I
    ...
    invoke-virtual {v10, v14}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->getIntOffset(I)I
    ...
    invoke-virtual {v10, v15}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->getIntOffset(I)I
    ...
    iget-object v4, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_tableBuffer:[B

    invoke-virtual {v10, v14}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->getStructOffset(I)I
    ...
    invoke-static {v4, v13}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I

    move-result v4

    iget-object v13, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_mainDocument:[B

    invoke-static {v13, v4}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    invoke-static {v4, v5, v3, v6, v13}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    new-instance v4, Lorg/apache/poi/hdf/model/hdftypes/SepxNode;

    invoke-direct {v4, v15, v1, v2, v3}, Lorg/apache/poi/hdf/model/hdftypes/SepxNode;-><init>(III[B)V

    iget-object v3, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_listener:Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;

    invoke-interface {v3, v4}, Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;->bodySection(Lorg/apache/poi/hdf/model/hdftypes/SepxNode;)V
    ...
    iget-object v6, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_tableBuffer:[B

    add-int/lit8 v9, v14, 0x1

    invoke-virtual {v10, v9}, Lorg/apache/poi/hdf/model/hdftypes/PlexOfCps;->getIntOffset(I)I

    move-result v13

    add-int/2addr v13, v8

    invoke-static {v6, v13}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I

    move-result v6

    add-int/2addr v6, v7

    iget-object v13, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_tableBuffer:[B
    ...
    invoke-static {v13, v14}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I

    move-result v13

    iget-object v14, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_mainDocument:[B

    invoke-static {v14, v13}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    invoke-static {v1, v13, v15, v7, v14}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    new-instance v1, Lorg/apache/poi/hdf/model/hdftypes/SepxNode;

    invoke-direct {v1, v9, v5, v6, v15}, Lorg/apache/poi/hdf/model/hdftypes/SepxNode;-><init>(III[B)V

    iget-object v13, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_listener:Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;

    invoke-interface {v13, v1}, Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;->hdrSection(Lorg/apache/poi/hdf/model/hdftypes/SepxNode;)V
    ...
    :cond_2
    iget-object v0, v0, Lorg/apache/poi/hdf/model/HDFObjectFactory;->_listener:Lorg/apache/poi/hdf/event/HDFLowLevelParsingListener;
