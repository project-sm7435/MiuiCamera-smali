...
.method private computeOutlines(Ljava/awt/Graphics2D;)Ljava/util/Collection;
    ...
    :goto_4
    new-instance v12, Ljava/awt/geom/Rectangle2D$Double;
    ...
    new-instance v6, Lorg/apache/poi/xslf/model/geom/Context;

    new-instance v7, Lorg/apache/poi/xslf/usermodel/RenderableShape$6;

    invoke-direct {v7, v0}, Lorg/apache/poi/xslf/usermodel/RenderableShape$6;-><init>(Lorg/apache/poi/xslf/usermodel/RenderableShape;)V

    invoke-direct {v6, v2, v12, v7}, Lorg/apache/poi/xslf/model/geom/Context;-><init>(Lorg/apache/poi/xslf/model/geom/CustomGeometry;Ljava/awt/geom/Rectangle2D;Lorg/apache/poi/xslf/model/geom/IAdjustableShape;)V

    invoke-virtual {v5, v6}, Lorg/apache/poi/xslf/model/geom/Path;->getPath(Lorg/apache/poi/xslf/model/geom/Context;)Ljava/awt/geom/GeneralPath;
...
.method private createTexturePaint(Lorg/openxmlformats/schemas/drawingml/x2006/main/CTBlipFillProperties;Ljava/awt/Graphics2D;Lorg/apache/poi/openxml4j/opc/PackagePart;)Ljava/awt/Paint;
    ...
    sget-object v0, Lorg/apache/poi/xslf/usermodel/XSLFRenderingHint;->IMAGE_RENDERER:Lorg/apache/poi/xslf/usermodel/XSLFRenderingHint;

    invoke-virtual {p2, v0}, Ljava/awt/Graphics2D;->getRenderingHint(Ljava/awt/RenderingHints$Key;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/apache/poi/xslf/usermodel/XSLFImageRenderer;
    ...
    new-instance v0, Lorg/apache/poi/xslf/usermodel/XSLFImageRenderer;

    invoke-direct {v0}, Lorg/apache/poi/xslf/usermodel/XSLFImageRenderer;-><init>()V
    ...
    invoke-virtual {v0, p1}, Lorg/apache/poi/xslf/usermodel/XSLFImageRenderer;->readImage(Lorg/apache/poi/openxml4j/opc/PackagePart;)Ljava/awt/image/BufferedImage;
    ...
    invoke-direct {p0, p1, v2}, Ljava/awt/TexturePaint;-><init>(Ljava/awt/image/BufferedImage;Ljava/awt/geom/Rectangle2D;)V
    :try_end_0
...
.method public applyStroke(Ljava/awt/Graphics2D;)Ljava/awt/Stroke;
    ...
    invoke-virtual {p1, v1}, Ljava/awt/Graphics2D;->setStroke(Ljava/awt/Stroke;)V
