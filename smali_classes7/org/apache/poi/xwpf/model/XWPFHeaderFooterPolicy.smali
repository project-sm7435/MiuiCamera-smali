...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, LEj/c;->D:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, LEj/c;->j()LEj/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, LEj/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, LEj/e;->f()V

    invoke-interface {p0}, LEj/e;->a()V

    invoke-interface {p0}, LEj/e;->m()V

    invoke-interface {p0}, LEj/e;->n()V

    invoke-interface {p0}, LEj/e;->d()LEj/b;
