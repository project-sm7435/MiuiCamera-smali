...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, LHj/c;->D:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, LHj/c;->k()LHj/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, LHj/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, LHj/e;->f()V

    invoke-interface {p0}, LHj/e;->a()V

    invoke-interface {p0}, LHj/e;->m()V

    invoke-interface {p0}, LHj/e;->n()V

    invoke-interface {p0}, LHj/e;->d()LHj/b;
