...
.method public getOutline(Lorg/apache/poi/hslf/model/Shape;)Ljava/awt/Shape;
    ...
    new-instance v2, Ljava/awt/geom/Arc2D$Float;
    ...
    invoke-virtual {v0, v2, v11}, Ljava/awt/geom/GeneralPath;->append(Ljava/awt/Shape;Z)V

    int-to-float v2, p0

    const v12, 0x4628c000    # 10800.0f

    invoke-virtual {v0, v12, v2}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V

    sub-int v2, p1, p0

    int-to-float v2, v2

    invoke-virtual {v0, v12, v2}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
    ...
    invoke-virtual {v0, v3, v11}, Ljava/awt/geom/GeneralPath;->append(Ljava/awt/Shape;Z)V

    int-to-float v5, p1

    const v2, 0x46a8c000    # 21600.0f

    invoke-virtual {v0, v2, v5}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V
    ...
    invoke-virtual {v0, v12, p1}, Ljava/awt/geom/GeneralPath;->moveTo(FF)V

    rsub-int p0, p0, 0x5460

    int-to-float p0, p0

    invoke-virtual {v0, v12, p0}, Ljava/awt/geom/GeneralPath;->lineTo(FF)V
