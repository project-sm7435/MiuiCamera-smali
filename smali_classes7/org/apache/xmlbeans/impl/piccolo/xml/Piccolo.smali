...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->yytable:[S
    ...
    sput-object v0, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->yycheck:[S
    ...
    const-string v1, "DTD_START"

    const/16 v2, 0x10b

    aput-object v1, v0, v2

    const-string v1, "DTD_START_SKIPEXTERNAL"
    ...
    const-string v1, "ENTITY_DECL_START"

    const/16 v2, 0x116

    aput-object v1, v0, v2

    const-string v1, "ATTLIST_START"

    const/16 v2, 0x117

    aput-object v1, v0, v2

    const-string v1, "NOTATION_START"

    const/16 v2, 0x118

    aput-object v1, v0, v2

    const-string v1, "RBRACKET_END"

    const/16 v2, 0x119

    aput-object v1, v0, v2

    const-string v1, "DOUBLE_RBRACKET_END"
    ...
    sput-object v0, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->yyname:[Ljava/lang/String;

    const-string v124, "content : content WHITESPACE"

    const-string v125, "content : content CDATA"

    const-string v3, "$accept : document"

    const-string v4, "document : xml_decl dtd body epilog"

    const-string v5, "document : xml_decl body epilog"

    const-string v6, "xml_decl : XML_DOC_DECL"

    const-string v7, "xml_decl : XML_DOC_OR_TEXT_DECL"

    const-string v8, "xml_decl :"

    const-string v9, "xml_text_decl : XML_TEXT_DECL"

    const-string v10, "xml_text_decl : XML_DOC_OR_TEXT_DECL"

    const-string v11, "body : EMPTY_TAG"

    const-string v12, "body : OPEN_TAG content CLOSE_TAG"

    const-string v13, "body : misc body"

    const-string v14, "epilog : misc epilog"

    const-string v15, "epilog :"

    const-string v16, "misc : WHITESPACE"

    const-string v17, "misc : PI"

    const-string v18, "misc : COMMENT"

    const-string v19, "ws : WHITESPACE"

    const-string v20, "ws : ws WHITESPACE"

    const-string v21, "opt_ws :"

    const-string v22, "opt_ws : ws"

    const-string v23, "dtd : DTD_START NAME opt_ws TAG_END"

    const-string v24, "dtd : dtd_only_internal_start dtd_content RBRACKET_END"

    const-string v25, "dtd : dtd_with_external xml_text_decl dtd_content ENTITY_END"

    const-string v26, "dtd : dtd_with_external dtd_content ENTITY_END"

    const-string v27, "dtd : DTD_START_SKIPEXTERNAL NAME ws external_id opt_ws TAG_END"

    const-string v28, "dtd : misc dtd"

    const-string v29, "dtd_with_external : dtd_with_external_start TAG_END"

    const-string v30, "dtd_with_external : dtd_with_external_start LBRACKET dtd_content RBRACKET_END"

    const-string v31, "dtd_with_external_start : DTD_START NAME ws SYSTEM ws STRING opt_ws"

    const-string v32, "dtd_with_external_start : DTD_START NAME ws PUBLIC ws STRING ws STRING opt_ws"

    const-string v33, "dtd_only_internal_start : DTD_START NAME LBRACKET"

    const-string v34, "dtd_only_internal_start : DTD_START_SKIPEXTERNAL NAME LBRACKET"

    const-string v35, "dtd_only_internal_start : DTD_START_SKIPEXTERNAL NAME ws external_id LBRACKET"

    const-string v36, "external_id : SYSTEM ws STRING"

    const-string v37, "external_id : PUBLIC ws STRING ws STRING"

    const-string v38, "dtd_content :"

    const-string v39, "dtd_content : dtd_content dtd_conditional"

    const-string v40, "dtd_content : dtd_content dtd_entity"

    const-string v41, "dtd_content : dtd_content dtd_attlist"

    const-string v42, "dtd_content : dtd_content dtd_notation"

    const-string v43, "dtd_content : dtd_content misc"

    const-string v44, "dtd_content : dtd_content dtd_element"

    const-string v45, "dtd_content : dtd_content INTERNAL_ENTITY_REF dtd_content"

    const-string v46, "dtd_content : dtd_content EXTERNAL_ENTITY_REF dtd_content"

    const-string v47, "dtd_content : dtd_content EXTERNAL_ENTITY_REF xml_text_decl dtd_content"

    const-string v48, "dtd_conditional : CONDITIONAL_START dtd_include dtd_content DOUBLE_RBRACKET_END"

    const-string v49, "dtd_conditional : CONDITIONAL_START dtd_ignore ignored_dtd_content DOUBLE_RBRACKET_END"

    const-string v50, "dtd_include : INCLUDE opt_ws LBRACKET"

    const-string v51, "dtd_include : ws dtd_include"

    const-string v52, "dtd_ignore : IGNORE opt_ws LBRACKET"

    const-string v53, "dtd_ignore : ws dtd_ignore"

    const-string v54, "ignored_dtd_content :"

    const-string v55, "ignored_dtd_content : ignored_dtd_content IGNORED_CONDITIONAL_START ignored_dtd_content DOUBLE_RBRACKET_END"

    const-string v56, "dtd_entity : ENTITY_DECL_START ws NAME ws STRING opt_ws TAG_END"

    const-string v57, "dtd_entity : ENTITY_DECL_START ws NAME ws external_id opt_ws TAG_END"

    const-string v58, "dtd_entity : ENTITY_DECL_START ws NAME ws external_id ws NDATA ws NAME opt_ws TAG_END"

    const-string v59, "dtd_entity : ENTITY_DECL_START ws PERCENT NAME ws STRING opt_ws TAG_END"

    const-string v60, "dtd_entity : ENTITY_DECL_START ws PERCENT NAME ws external_id opt_ws TAG_END"

    const-string v61, "dtd_entity : ENTITY_DECL_START ws PERCENT NAME external_id ws NDATA ws NAME opt_ws TAG_END"

    const-string v62, "dtd_notation : NOTATION_START ws NAME ws external_id opt_ws TAG_END"

    const-string v63, "dtd_notation : NOTATION_START ws NAME ws PUBLIC ws STRING opt_ws TAG_END"

    const-string v64, "dtd_attlist : attlist_start att_def_list opt_ws TAG_END"

    const-string v65, "attlist_start : ATTLIST_START ws NAME"

    const-string v66, "att_def_list :"

    const-string v67, "att_def_list : att_def_list ws att_def"

    const-string v68, "att_def : PREFIXED_NAME ws att_type ws REQUIRED"

    const-string v69, "att_def : UNPREFIXED_NAME ws att_type ws REQUIRED"

    const-string v70, "att_def : PREFIXED_NAME ws att_type ws IMPLIED"

    const-string v71, "att_def : UNPREFIXED_NAME ws att_type ws IMPLIED"

    const-string v72, "att_def : PREFIXED_NAME ws att_type ws FIXED ws STRING"

    const-string v73, "att_def : UNPREFIXED_NAME ws att_type ws FIXED ws STRING"

    const-string v74, "att_def : PREFIXED_NAME ws att_type ws STRING"

    const-string v75, "att_def : UNPREFIXED_NAME ws att_type ws STRING"

    const-string v76, "att_type : CDATA"

    const-string v77, "att_type : ID"

    const-string v78, "att_type : IDREF"

    const-string v79, "att_type : IDREFS"

    const-string v80, "att_type : ENTITY"

    const-string v81, "att_type : ENTITIES"

    const-string v82, "att_type : NMTOKEN"

    const-string v83, "att_type : NMTOKENS"

    const-string v84, "att_type : LPAREN opt_ws word_list opt_ws RPAREN"

    const-string v85, "att_type : NOTATION ws LPAREN opt_ws word_list opt_ws RPAREN"

    const-string v86, "word_list : NAME"

    const-string v87, "word_list : word_list opt_ws PIPE opt_ws NAME"

    const-string v88, "dtd_element : ELEMENT_DECL_START ws NAME ws element_spec opt_ws TAG_END"

    const-string v89, "element_spec : EMPTY"

    const-string v90, "element_spec : ANY"

    const-string v91, "element_spec : element_spec_mixed"

    const-string v92, "element_spec : element_spec_children"

    const-string v93, "element_spec_mixed : LPAREN opt_ws PCDATA opt_ws RPAREN STAR"

    const-string v94, "element_spec_mixed : LPAREN opt_ws PCDATA opt_ws RPAREN"

    const-string v95, "element_spec_mixed : LPAREN opt_ws PCDATA opt_ws PIPE opt_ws word_list opt_ws RPAREN STAR"

    const-string v96, "element_spec_mixed : WHITESPACE element_spec_mixed"

    const-string v97, "element_spec_children : element_choice element_modifier"

    const-string v98, "element_spec_children : element_seq element_modifier"

    const-string v99, "element_spec_children : WHITESPACE element_spec_children"

    const-string v100, "element_cp_pipe_list : element_cp opt_ws PIPE opt_ws element_cp"

    const-string v101, "element_cp_pipe_list : element_cp opt_ws PIPE opt_ws element_cp_pipe_list"

    const-string v102, "element_cp_comma_list : element_cp"

    const-string v103, "element_cp_comma_list : element_cp opt_ws COMMA element_cp_comma_list"

    const-string v104, "element_cp : NAME element_modifier opt_ws"

    const-string v105, "element_cp : element_choice element_modifier opt_ws"

    const-string v106, "element_cp : element_seq element_modifier opt_ws"

    const-string v107, "element_cp : WHITESPACE element_cp"

    const-string v108, "element_choice : LPAREN element_cp_pipe_list opt_ws RPAREN"

    const-string v109, "element_choice : WHITESPACE element_choice"

    const-string v110, "element_seq : LPAREN element_cp_comma_list opt_ws RPAREN"

    const-string v111, "element_seq : WHITESPACE element_seq"

    const-string v112, "element_modifier : QUESTION"

    const-string v113, "element_modifier : STAR"

    const-string v114, "element_modifier : PLUS"

    const-string v115, "element_modifier :"

    const-string v116, "content :"

    const-string v117, "content : content INTERNAL_ENTITY_REF content ENTITY_END"

    const-string v118, "content : content EXTERNAL_ENTITY_REF content ENTITY_END"

    const-string v119, "content : content EXTERNAL_ENTITY_REF xml_text_decl content ENTITY_END"

    const-string v120, "content : content OPEN_TAG content CLOSE_TAG"

    const-string v121, "content : content EMPTY_TAG"

    const-string v122, "content : content PI"

    const-string v123, "content : content COMMENT"

    filled-new-array/range {v3 .. v125}, [Ljava/lang/String;
...
.method private saveAttributeDefinition(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)V
    ...
    iget-object p3, p0, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->modelBuffer:Ljava/lang/StringBuffer;
    ...
    new-instance v0, Lorg/apache/xmlbeans/impl/piccolo/xml/AttributeDefinition;
    ...
    invoke-virtual {p0, v0}, Lorg/apache/xmlbeans/impl/piccolo/xml/ElementDefinition;->addAttribute(Lorg/apache/xmlbeans/impl/piccolo/xml/AttributeDefinition;)V
    :try_end_0
...
.method public yyparse()I
    ...
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->init_stacks()Z
    ...
    invoke-direct {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->yylex()I
    ...
    :cond_5
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->state_pop()I

    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->val_pop()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->reportEndDTD()V
    ...
    :cond_b
    invoke-virtual {v1}, Lorg/apache/xmlbeans/impl/piccolo/xml/Piccolo;->reportWhitespace()V
