...
.method public final onChildDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;FFIZ)V
    ...
    sget v0, LAi/j;->cardGroupRadius:I
    ...
    sget p3, LAi/j;->cardGroupItemDragShadowBackground:I

    invoke-static {p1, p3}, LAi/i;->a(Landroid/content/Context;I)I
    ...
    sget p3, LAi/k;->miuix_color_transparent:I
    ...
    sget p5, LAi/k;->miuix_color_transparent:I
    ...
    sget p5, LAi/j;->cardGroupItemDragShadowBackground:I

    invoke-static {p3, p5}, LAi/i;->a(Landroid/content/Context;I)I
    ...
    invoke-direct {p3, p0, p4, p2}, LAi/g;-><init>(Lmiuix/recyclerview/card/CardTouchHelperCallback;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-direct {p3, p0, p2}, LAi/h;-><init>(Lmiuix/recyclerview/card/CardTouchHelperCallback;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public final onSelectedChanged(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    sget v2, LAi/j;->cardGroupItemDragBackground:I
    ...
    sget v3, LAi/j;->cardGroupRadius:I
    ...
    new-instance p1, LBi/b$a;

    invoke-direct {p1}, Landroid/view/ViewOutlineProvider;-><init>()V

    iput v0, p1, LBi/b$a;->b:I

    iput p0, p1, LBi/b$a;->a:F
    ...
    sget v1, LAi/j;->cardGroupItemDragBackground:I

    invoke-static {p1, v1}, LAi/i;->a(Landroid/content/Context;I)I
