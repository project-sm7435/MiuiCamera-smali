...
.method static constructor <clinit>()V
    ...
    sput-object v0, LAj/x;->m:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    iput-object p1, p0, LAj/x;->a:Ljava/lang/String;

    iput-object p2, p0, LAj/x;->b:Lokhttp3/HttpUrl;

    iput-object p3, p0, LAj/x;->c:Ljava/lang/String;

    new-instance p1, Lokhttp3/Request$Builder;

    invoke-direct {p1}, Lokhttp3/Request$Builder;-><init>()V

    iput-object p1, p0, LAj/x;->e:Lokhttp3/Request$Builder;

    iput-object p5, p0, LAj/x;->g:Lokhttp3/MediaType;

    iput-boolean p6, p0, LAj/x;->h:Z
    ...
    iput-object p1, p0, LAj/x;->f:Lokhttp3/Headers$Builder;
    ...
    iput-object p1, p0, LAj/x;->j:Lokhttp3/FormBody$Builder;
    ...
    iput-object p1, p0, LAj/x;->i:Lokhttp3/MultipartBody$Builder;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LAj/x;->g:Lokhttp3/MediaType;
    :try_end_0
    ...
    :cond_0
    iget-object p0, p0, LAj/x;->f:Lokhttp3/Headers$Builder;
...
.method public final b(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, LAj/x;->c:Ljava/lang/String;

    if-eqz v0, :cond_1

    iget-object v1, p0, LAj/x;->b:Lokhttp3/HttpUrl;

    invoke-virtual {v1, v0}, Lokhttp3/HttpUrl;->newBuilder(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object v0

    iput-object v0, p0, LAj/x;->d:Lokhttp3/HttpUrl$Builder;

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, LAj/x;->c:Ljava/lang/String;
    ...
    iget-object p0, p0, LAj/x;->c:Ljava/lang/String;
    ...
    iget-object p0, p0, LAj/x;->d:Lokhttp3/HttpUrl$Builder;
